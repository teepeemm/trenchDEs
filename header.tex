...
\index{coefficients!undetermined|see{undetermined coefficients}}
\index{constant coefficient equation!homogeneous!higher order|see{higher order constant coefficient homogeneous equations}}
\index{cooling!Newton's law of|see{Newton's law of cooling}}
\index{decay|see{exponential decay}}
\index{error!truncation!global|see{global truncation error}}
\index{error!truncation!local|see{local truncation error}}
\index{exact first order equation|see{first order equation, exact}}
\index{first order equation!applications|see{applications, first order equations}}
\index{first order equation!numerical methods|see{numerical methods}}
\index{gravitation!Newton's law of|see{Newton's, law of gravitation}}
\index{growth|see{exponential growth}}
\index{harmonic motion, simple|see{simple harmonic motion}}
\index{independence!linear|see{linear independence}}
\index{mechanics, elementary|see{elementary mechanics}}
\index{model, mathematical|see{mathematical model}}
\index{motion!elementary|see{elementary mechanics}}
\index{motion!Newton's second law of|see{Newton's second law of motion}}
\index{motion!simple harmonic|see{simple harmonic motion}}
\index{nonhomogeneous linear second order|see{linear second order, nonhomogeneous}}
\index{second order equation!applications|see{applications, second order equation}}
\index{second order equation!linear|see{linear second order equation}}
\index{superposition, principle of|see{principle of superposition}}
\index{temperature|see{Newton's law of cooling}}
\index{truncation error|see{local truncation error, global truncation error}}

\AddToHook{enddocument/afterlastpage}{
 \index{numerical methods|seealso{Euler's, improved Euler's, Heun's, midpoint, Runge-Kutta, semilinear}}
 \index{solution|seealso{Frobenius solutions, nontrivial solution, series solution, trivial solution}}
 \index{spring-mass system!simple harmonic motion|seealso{simple harmonic motion}}
 \index{system|seealso{linear system}}
}

% I was unable to figure out where these index entries belong
...
\title{%
\iftoggle{solutionManual}{Student Solutions Manual For }{}%
