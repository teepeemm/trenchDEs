...
%\usepackage{enumext}
\ProvideDocumentEnvironment{proof}{}{\noindent\emph{Proof.} }{}
\usepackage{../wtrench}
\input{../header}
...
% pageanchor = true]
%{hyperref}
%\newtheorem{theorem}{\scshape\bfseries Theorem}
%\newtheorem{example}{\scshape\bfseries Example}
%\graphicspath{%
...
%\renewcommand{\part}[1]{{\bfseries (#1)}}
%\newcommand{\remark}[1]{\noindent{\scshape Remark}:\ #1}
%\newcommand{\solutionpart}[1]{\vskip10pt\noindent{%\underbar
%\color{blue}\scshape Solution({\bfseries #1})\ }%
%}
%\newcommand{\boxit}[1]{\medskip\noindent\textcolor{red}{#1}
%\vskip-6pt\hskip-\parindent}
%\newenvironment{alist}[1][]{%
% \begin{enumext}[
%  label=\alph*,
%  font=\bfseries,
%  wrap-label*={(##1)},
