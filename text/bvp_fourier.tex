...
\[
f(x)\cos\frac{n\pi x}{L}\quad\mbox{ and }\quad f(x)\sin\frac{n\pi x}{L}
\]
on $[-L,L]$, respectively.
...
\dst\frac{f(x-)+f(x+)}{2}&\mbox{if $-L<x<L$ and $f$ is discontinuous at
$x$  }\\[2\jot]
...
F(x)=
\begin{cases}
\dst\frac{f(x+)+f(x-)}{2}&\mbox{if }-L<x<L,\\
\dst\frac{f(L-)+f(-L+)}{2}&\mbox{if }x=\pm L.
\end{cases}
\]
...
\begin{figure}[tbp]
  ...
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110201}
\caption{}
  \label{figure:11.2.1}
\end{figure}
...
\begin{figure}[H]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110202}
\caption{}
  \label{figure:11.2.2}
\end{figure}
...
u(x)\cos\frac{n\pi x}{L}\,dx=2\int_0^Lu(x)\cos\frac{n\pi x}{L} \,dx,\\
\mbox{\part{d}\quad}
\int_{-L}^L v(x)\sin\frac{n\pi x}{L}\,dx=
2\int_0^L v(x)\sin\frac{n\pi x}{L}\,dx,\\
\mbox{\part{e}\quad} \int_{-L}^L
u(x)\sin\frac{n\pi x}{L}\,dx=0
\mbox{\quad and \quad\part{f}\quad}
\int_{-L}^L v(x)\cos\frac{n\pi x}{L}\,dx=0.
\end{gather*}
\end{theorem}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110203}
...
where
\[
a_0=\frac{1}{L}\int_0^Lf(x) \,dx \mbox{\quad and \quad}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110204}
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110205}}
  \label{figure:11.2.5}
\caption{The Gibbs Phenomenon:
\zcref{example:11.2.7}, $N=10$}
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110206}}
\caption{The Gibbs Phenomenon:
\zcref{example:11.2.7}, $N=20$}
  \label{figure:11.2.6}
\end{minipage}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110207}
\caption{The Gibbs Phenomenon:
\zcref{example:11.2.7}, $N=30$}
  \label{figure:11.2.7}
\end{figure}
...
\left\{\begin{array}{cl}
0,&-1<x<\frac{1}{2},\\[2\jot]
\cos\pi x,&-\frac{1}{2}<x<\frac{1}{2},\\[2\jot]
0,&\phantom{-}\frac{1}{2}<x<1
\end{array}\right.$
...
\left\{\begin{array}{cl}
0,&-1<x<\frac{1}{2},\\[2\jot]
x\cos\pi x,&-\frac{1}{2}<x<\frac{1}{2},\\[2\jot]
0,&\phantom{-}\frac{1}{2}<x<1
\end{array}\right.$
...
\left\{\begin{array}{cl}
0,&-1<x<\frac{1}{2},\\[2\jot]
\sin\pi x,&-\frac{1}{2}<x<\frac{1}{2},\\[2\jot]
0,&\phantom{-}\frac{1}{2}<x<1
\end{array}\right.$
...
\left\{\begin{array}{cl}
0,&-1<x<\frac{1}{2},\\[2\jot]
x\sin\pi x,&-\frac{1}{2}<x<\frac{1}{2},\\[2\jot]
0,&\phantom{-}\frac{1}{2}<x<1
\end{array}\right.$
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110208}}
...
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110209}}
...
\begin{alist}
\item % (a)
Conclude from \zcref{exer:11.2.29}\part{b} that
\[
...
\item % (b)
Conclude from \zcref{exer:11.2.29}\part{d} that
\[
...
\zcref{exer:11.2.6}\part{a} shows that the Fourier cosine
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110301}
  \caption{}
  \label{figure:11.3.1}
\end{figure}
...
\dst\frac{f(x-)+f(x+)}{2}&\mbox{if $0<x<L$ and $f$ is discontinuous at
$x  $}\\[2\jot]
f(L-)&\mbox{if }x=L.
\end{cases}
\]
...
Therefore
\[
C(x)=\dst\frac{L}{2}-\frac{4L}{\pi^2}\sum_{n=1}^\infty\frac{1}{(2n-1)^2}
...
\]
Comparing this definition with
\zcref{exer:11.2.6}\part{b} shows that the Fourier sine
series of $f$ on $[0,L]$ is the Fourier series of
 the  function
\[
f_2(x)=
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110302}
  \caption{}
  \label{figure:11.3.2}
\end{figure}
...
Therefore
\[
S(x)=\dst-\frac{2L}{\pi}\sum_{n=1}^\infty\frac{(-1)^n}{n}
\sin\frac{n\pi x}{L}.
\]
...
\begin{figure}[H]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110303}
  \caption{}
  \label{figure:11.3.3}
\end{figure}
...
\begin{figure}[H]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig110304}
  \caption{}
  \label{figure:11.3.4}
\end{figure}
...
a_0=\frac{1}{L}\int_0^L f(x)\,dx \mbox{\quad and \quad}
...
Therefore
\[
S(x)=\dst\frac{12L^3}{\pi^3}\sum_{n=1}^\infty\frac{1}{n^3}
\sin\frac{n\pi x}{L}.
\]
...
Therefore
\[
C_M(x)=\dst\frac{32L^3}{\pi^3}\sum_{n=1}^\infty\frac{1}{(2n-1)^3}\left[
...
that
\begin{align*}
d_n&=-\dst\frac{48L}{(2n-1)^2\pi^2}\int_0^L(2x-3L)
\sin\frac{(2n-1)\pi x}{2L}\,dx\\
&=\dst\frac{96L^2}{(2n-1)^3\pi^3}\left[(2x-3L)\cos\frac{(2n-1)\pi
x}{2L}\lims0L-2\int_0^L\cos\frac{(2n-1)\pi x}{2L}\,dx\right]\\
&=\dst\frac{96L^2}{(2n-1)^3\pi^3}\left[3L-\frac{4L}{(2n-1)\pi}
...
use \zcref{thmtype:11.3.5}\part{a} to find the  Fourier
...
\item % (a)
Prove \zcref{thmtype:11.3.5}\part{b}.
\item % (b)
In addition to the assumptions of \zcref{thmtype:11.3.5}\part{b},
...
use \zcref{thmtype:11.3.5}\part{b}
or, where applicable,
{Exercise 11.1.\zcref[noname]{exer:11.3.35}\part{b}},
...
\item % (a)
Prove \zcref{thmtype:11.3.5}\part{c}.
\item % (b)
In addition to the assumptions of \zcref{thmtype:11.3.5}\part{c},
suppose
...
use \zcref{thmtype:11.3.5}\part{c}
or, where applicable,
{Exercise 11.1.\zcref[noname]{exer:11.3.42}\part{b}},
...
\item % (a)
Prove \zcref{thmtype:11.3.5}\part{d}.
\item % (b)
In addition to the assumptions of \zcref{thmtype:11.3.5}\part{d},
suppose
...
use \zcref{thmtype:11.3.5}\part{d} or, where applicable,
\zcref{exer:11.3.50}\part{b}, to find the mixed Fourier sine series
of the $f$ on $[0,L]$.}
