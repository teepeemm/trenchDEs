...
$$
\int_{-L}^L
f(x)g(x)\,dx=\frac{1}{2}\left[\int_{-L}^L\cos{(m-n)\pi x\over L}\,dx
...
F(x)=a_0+\sum_{n=1}^\infty\left(a_n\cos\frac{n\pi x}{L}+b_n\sin{n\pi
x\over L}\right)
\end{equation}
of $f$
...
$$
E_N(x)=
\left|F(x)-a_0-\sum_{n=1}^N\left(a_n\cos\frac{n\pi x}{L}+b_n\sin{n\pi
...
x\over2}+b_n\sin\frac{n\pi x}{2}\right)
$$
...
and
$$
F(0)={f(0-)+f(0+)\over2}=\frac{1}{2}\left(0+\frac{1}{2}\right)=\frac{1}{4}.
$$
To summarize,
$$
F(x)=
...
If $n\ge1$, then
\begin{eqnarray*}
a_n&=&\frac{1}{2}\int_{-2}^2f(x)\cos{n\pi
x\over2}\,dx=\frac{1}{2}\left[\int_{-2}^0(-x)\cos\frac{n\pi x}{2}\,dx
+\int_0^2\frac{1}{2}\cos\frac{n\pi x}{2}\,dx\right]\\&=&\frac{2}{n^2\pi^2}(\cos n\pi-1),
\end{eqnarray*}
and
\begin{eqnarray*}
b_n&=&\frac{1}{2}\int_{-2}^2f(x)\sin{n\pi
x\over2}\,dx=\frac{1}{2}\left[\int_{-2}^0(-x)\sin\frac{n\pi x}{2}\,dx
+\int_0^2\frac{1}{2}\sin\frac{n\pi x}{2}\,dx\right]\\
&=&\frac{1}{2n\pi}(1+3\cos n\pi).
\end{eqnarray*}
Therefore
$$
F(x)=\frac{3}{4}+\frac{2}{\pi^2}\sum_{n=1}^\infty\frac{\cos n\pi-1}{n^2}\cos\frac{n\pi x}{2}+\frac{1}{2\pi}\sum_{n=1}^\infty{1+3\cos
n\pi\over n}\sin\frac{n\pi x}{2}.
$$
Figure~\ref{figure:11.2.2} shows how the partial sum
$$
F_m(x)=\frac{3}{4}+\frac{2}{\pi^2}\sum_{n=1}^m\frac{\cos n\pi-1}{n^2}\cos\frac{n\pi x}{2}+\frac{1}{2\pi}\sum_{n=1}^m{1+3\cos
n\pi\over n}\sin\frac{n\pi x}{2}
$$
...
&=&\frac{8}{n^2\pi^2}\left[2\cos n\pi-\frac{2}{n\pi}\sin{n\pi
...
Therefore
$$
F(x)=\frac{4}{3}+\frac{16}{\pi^2}\sum_{n=1}^\infty{(-1)^n\over n^2}
\cos\frac{n\pi x}{2}+\frac{4}{\pi}\sum_{n=1}^\infty
{(-1)^n\over n}\sin\frac{n\pi x}{2}.
$$
...
$$
F_m(x)=\frac{4}{3}+\frac{16}{\pi^2}\sum_{n=1}^m{(-1)^n\over n^2}
...
F(x)=\frac{\pi}{2}+\frac{2}{\pi}\sum_{n=0}{(-1)^n-1\over n^2}\cos nx.
\end{equation}
However, since
$$
(-1)^n-1=
...
Therefore
$$
F(x)=\frac{12L^3}{\pi^3}\sum_{n=1}^\infty{(-1)^n\over n^3}\sin{n\pi
x\over L}.
$$
...
\frac{2}{\pi}\sum_{n=1}^N {(-1)^{n-1}\over2n-1}\cos(2n-1)\pi x
$$
...
\item\label{exer:11.2.1}Prove Theorem~\ref{thmtype:11.1.5}.
...
\item\label{exer:11.2.19}Deduce from  Example~\ref{example:11.2.5} that
$$
...
where
$$
A_n=\frac{2}{L}\int_0^Lf(x)\cos{(2n-1)\pi x\over L}\,dx
\text{\quad and \quad }
B_n=\frac{2}{L}\int_0^Lf(x)\sin{(2n-1)\pi x\over L}\,dx,\quad
n=1,2,3,\dots.
$$
...
where
$$
a_0={\dst\int_0^Lf(x)\,dx\over\dst\int_0^L\,dx}=\frac{1}{L}\int_0^Lf(x)\,dx
$$
and
$$
a_n={\dst\int_0^Lf(x)\cos\frac{n\pi x}{L}\,dx\over\dst\int_0^L
...
where
$$
b_n={\dst\int_0^Lf(x)\sin\frac{n\pi x}{L}\,dx\over\dst\int_0^L
...
Therefore
$$
S(x)=\dst-\frac{2L}{\pi}\sum_{n=1}^\infty{(-1)^n\over n}
\sin\frac{n\pi x}{L}.
$$
...
\cos^2{(2n-1)\pi x\over L}\,dx}=\frac{2}{L}\int_0^Lf(x)\cos{(2n-1)\pi
x\over2L}\,dx.
$$
...
\solution
 The coefficients are
\begin{eqnarray*}
c_n&=&\frac{2}{L}\int_0^L(x-L)\cos{(2n-1)\pi x\over2L}\,dx\\
&=&\frac{4}{(2n-1)\pi}\left[(x-L)\sin{(2n-1)\pi
...
\sin^2{(2n-1)\pi x\over2L}\,dx}=\frac{2}{L}\int_0^Lf(x)\sin{(2n-1)\pi
x\over2L}\,dx.
$$
...
\solution
 The coefficients are
\begin{eqnarray*}
d_n&=&\frac{2}{L}\int_0^Lx\sin{(2n-1)\pi x\over2L}\,dx\\
&=&-\frac{4}{(2n-1)\pi}\left[x\cos{(2n-1)\pi
x\over2L}\lims0L-
\int_0^L
...
&=&\frac{8L}{(2n-1)^2\pi^2}\sin{(2n-1)\pi
x\over2L}\lims0L=(-1)^{n+1}\frac{8L}{(2n-1)^2\pi^2}.
\end{eqnarray*}
Therefore
$$
...
a_n= \frac{2L^2}{n^3\pi^3}\int_0^L f'''(x)\sin{n\pi
x\over L}\,dx,
\quad n\ge1.
\end{equation}
...
b_n=-\frac{2L}{n^2\pi^2}\int_0^L f''(x)\sin{n\pi
x\over L}\,dx.
\end{equation}
...
c_n=-\frac{8L}{(2n-1)^2\pi^2}\int_0^L f''(x)\cos{(2n-1)\pi x\over2L}
\,dx.
\end{equation}
...
d_n=-\frac{8L}{(2n-1)^2\pi^2}\int_0^L f''(x)\sin{(2n-1)\pi x\over2L}
\,dx.
\end{equation}
\end{theorem}
...
$f$ is continuous on
$[0,L]$, Theorem~\ref{thmtype:11.3.1} implies \eqref{eq:11.3.3} with $a_0$,
...
Therefore
$$
C(x)=\frac{L^3}{2}-\frac{48L^3}{\pi^4}\sum_{n=1}^\infty\frac{1}{(2n-1)^4}\cos{(2n-1)\pi x\over L}.
$$
...
\begin{eqnarray*}
b_n&=&-
\frac{12L}{n^2\pi^2}\int_0^L(x-L)\sin\frac{n\pi x}{L}\,dx\\
...
&=&-\frac{32L^2}{(2n-1)^3\pi^3}\left[(9x-4L)\sin{(2n-1)\pi x\over2L}
\lims0L-9\int_0^L\sin{(2n-1)\pi x\over2L}\right]\,dx\\
&=&-\frac{32L^2}{(2n-1)^3\pi^3}
\left[(-1)^{n+1}5L+\frac{18L}{(2n-1)\pi}\cos{(2n-1)\pi x\over2L}
\lims0L\right] \\
...
(-1)^n5+\frac{18}{(2n-1)\pi}\right]\cos{(2n-1)\pi
x\over2L}.
$$
...
&=&\dst\frac{96L^2}{(2n-1)^3\pi^3}\left[(2x-3L)\cos{(2n-1)\pi
...
Show that
$$
b_n=\frac{2L^3}{n^4\pi^4}\int_0^L f^{(4)}(x)\sin{n\pi
x\over L}\,dx,
\quad n\ge1.
$$
\end{alist}
...
$[0,L]$. Show that
$$
c_n=\frac{16L^2}{(2n-1)^3\pi^3}\int_0^L f'''(x)\sin{(2n-1)\pi x\over2L}
\,dx,\quad n\ge1.
$$
\end{alist}
...
$[0,L]$. Show that
$$
d_n=-\frac{16L^2}{(2n-1)^3\pi^3}\int_0^L f'''(x)\cos{(2n-1)\pi x\over2L}
\,dx,\quad n\ge1.
$$
\end{alist}
