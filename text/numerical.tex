...
\[
1+C+\cdots+C^{n-1}=\frac{1-C^n}{1-C}={(1+Rh)^n-1\over Rh}
\]
(since $C=1+Rh$). From this and \eqref{eq:3.1.16},
\begin{equation} \label{eq:3.1.17}
|y(b)-y_n|=|e_n|\le{(1+Rh)^n-1\over R}\frac{Mh}{2}.
\end{equation}
...
$\dst{y'+\frac{1}{x}y={\sin x\over x^2},\quad y(1)=2}$;\;
...
$\dst{y'+\frac{1}{x}y={\sin x\over x^2},\quad y(1)=2}$, \quad
$h=0.2,0.1,0.05$ on $[1,3]$
