...
\zcref{thmtype:13.1.2}\part{e}; that is, we choose
...
\begin{figure}[tbp]
  ...
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig130201}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig130202}
...
\hint{Recall the hint in \zcref{exer:13.2.29}\part{b}.}
