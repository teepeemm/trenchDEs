...
% TODO convert to enumext*
(a) $F(x)=1$, (b) $F(x)=x$, and (c) $F(x)=x^{2}$.
...
{\color{blue}\itshape Sturm}-\href{http://www-history.mcs.st-and.ac.uk/Mathematicians/Liouville.html}
{\color{blue}\itshape Liouville equation}, and the
eigenvalue problem
...
\href{http://www-history.mcs.st-and.ac.uk/Mathematicians/Sturm.html}
{\color{blue}\itshape Sturm-Liouville
problem}.
...
\href{http://www-history.mcs.st-and.ac.uk/Mathematicians/Sturm.html}
{\color{blue}\itshape Sturm-Liouville problem}
