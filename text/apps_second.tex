...
\item A \indexterm{damping force}\index{force!damping} $F_d=-cy'$ that resists the motion with
...
my''+cy'+ky=F.
\end{equation}
We call this the \indexterm{equation of motion}\index{motion!equation of}.
...
\emph{\color{blue}circuit is closed}\index{closed circuit}\index{RLC cicuit!closed}.
