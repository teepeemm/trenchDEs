...
\indexterm{transient component} of the solution $y$.
...
\index{circuit, RLC|see{RLC circuit}}
...
$t\to\infty$, we say that $I_c=Q'_c$ is the \indexterm{transient current}\index{current!transient}
