...
\index{applications!of linear second order equations}
...
\index{applications!of linear second order equations!spring-mass systems}
...
in
\emph{\color{blue}equilibrium}\index{equilibrium!spring-mass system}\index{spring-mass system!equilibrium}
...
of the object from its equilibrium position (\zcref{figure:6.1.1})\index{damping!spring-mass system with},
...
length. The
\emph{\color{blue}natural length}\index{natural length of spring}\index{spring, natural length}
of the spring is its length with
...
L$, where $k$ is a positive number called the \indexterm{spring constant}\index{constant!spring}.
...
\item A
\emph{\color{blue}damping force}\index{damping!force}\index{force!damping}
$F_d=-cy'$ that resists the motion with
...
damping force. We say that the motion is
\emph{\color{blue}undamped}\index{undamped motion}\index{motion!undamped}\index{spring-mass system!undamped}
if $c=0$, or
\emph{\color{blue}damped}\index{damped motion}\index{motion!damped}\index{spring-mass system!damped}
if $c>0$.
...
say that the motion is \emph{\color{blue}free}\index{free motion}\index{motion!free} if $F\equiv0$, or \emph{\color{blue}forced}\index{forced motion}\index{motion!forced}
if $F\not\equiv0$.
...
equilibrium position (\zcref{figure:6.1.3}\index{spring, natural length}). Since the sum of the forces acting on the object
...
my''+cy'+ky=F.
\end{equation}
We call this the \emph{\color{blue}equation of motion}\index{equation!of motion}\index{motion!equation of}.
...
\caption{(a) Natural length of spring\index{spring, natural length}, (b) Spring stretched by mass}
  \label{figure:6.1.3}
\end{figure}
...
\index{spring-mass system!simple harmonic motion}
\index{spring-mass system!undamped}
\index{damping!spring-mass system!undamped}
...
can be interpreted as polar
coordinates\index{polar coordinates!amplitude-phase form}
of the point with rectangular
...
is  \indexterm{simple harmonic motion}. We see from either of these
...
$R$ is the
\emph{\color{blue}amplitude}\index{amplitude of oscillation}\index{simple harmonic motion!amplitude of oscillation}\index{oscillation!amplitude}
of the oscillation. The angle $\phi$ in
\eqref{eq:6.1.10} is the \indexterm{phase angle}\index{simple harmonic motion!phase angle}. It's measured
in
radians. \zcref[S]{eq:6.1.10} is the \indexterm{amplitude-phase
form}\index{simple harmonic motion!amplitude-phase form} of the displacement. If $t$ is in seconds then $\omega_0$ is
in radians per second (rad/s);   it's  the
\emph{\color{blue}frequency}\index{frequency!motion}\index{motion!frequency}\index{frequency!simple harmonic motion}\index{simple harmonic motion!frequency}
of the motion. It is also called the
\indexterm{natural frequency}\index{simple harmonic motion!natural frequency}
of the spring-mass system without damping.
...
\index{damping!undamped spring-mass system!forced oscillation}
\index{forced motion!oscillation!undamped}
\index{spring-mass system!undamped!forced oscillation}
...
frequency is called \indexterm{resonance}. More complicated mechanical
...
\index{damping!spring-mass system!free vibrations}
\index{elementary mechanics!spring-mass system!damped}
\index{spring-mass system!damped!free vibration}
...
\index{damping!spring-mass system!underdamped}
\index{spring-mass system!damping!underdamped}

We say the motion is \emph{\color{blue}underdamped}\index{underdamped motion}\index{motion!underdamped} if $c<\sqrt{4mk}$. In this
...
\index{damping!spring-mass system!overdamped}
\index{spring-mass system!damping!overdamped}

We say the motion is \emph{\color{blue}overdamped}\index{overdamped motion}\index{motion!overdamped} if $c>\sqrt{4mk}$. In this
...
\index{damping!spring-mass system!critically damped}
\index{spring-mass system!damping!critically damped}

We say the motion is \emph{\color{blue}critically damped}\index{critically damped motion}\index{motion!critically damped} if $c=\sqrt{4mk}$. In
...
\index{damping!spring-mass system!forced vibrations}
\index{vibrations!forced with damping}
\index{forced motion!vibrations}
\index{spring-mass system!damped!forced vibrations}
...
\section{The RLC Circuit}\label{sec:rlc}
\index{circuit!RLC}\index{RLC circuit}
\index{applications!of linear second order equations!RLC circuit}

In this section we consider the \indexterm{RLC circuit}, shown
...
switch is closed (solid line) we say that the
\emph{\color{blue}circuit is closed}\index{closed circuit}\index{RLC circuit!closed}.
Differences in electrical potential in a closed circuit
cause current\index{current} to flow in the circuit. The battery or generator in
...
the same at the two terminals. We call $E$ the \indexterm{impressed
voltage}\index{voltage!impressed}.
...
Differences in potential occur at the resistor\index{resistor}, induction coil\index{inductor}, and
capacitor\index{capacitor} in \zcref{figure:6.3.1}. Note that the two sides of each
of these components are also identified as positive and negative. The
\indexterm{voltage drop} across each component is defined to be the
...
can obtain
results concerning solutions of \eqref{eq:6.3.6} by simply changing
notation, according to \zcref{table:6.3.1}.


\boxit{Free Oscillations}
\index{free oscillation}
\index{oscillation!free}
\index{oscillation!RLC circuit!free}
\index{free motion!oscillation!RLC circuit}
\index{RLC circuit!free oscillation}

We say that an RLC circuit is in \indexterm{free oscillation}\index{RLC circuit!free oscillation} if $E(t)=0$
...
\item
The oscillation is \emph{\color{blue}underdamped}\index{underdamped oscillation}\index{oscillation!underdamped} if $R<\sqrt{4L/C}$. In this
...
\]
which is analogous to  the simple harmonic motion\index{simple harmonic motion}
of an undamped
spring-mass system in free vibration\index{free motion!vibration}.
...
\item
The oscillation is \emph{\color{blue}overdamped}\index{overdamped oscillation}\index{oscillation!overdamped} if $R>\sqrt{4L/C}$. In this case,
...
\item
The oscillation is \emph{\color{blue}critically damped}\index{critically damped oscillation}\index{oscillation!critically damped} if $R=\sqrt{4L/C}$. In
...
\index{forced oscillation!damped}
\index{oscillation!forced, damped}
\index{oscillation!RLC circuit!forced, damped}
\index{damping!RLC circuit in forced oscillation}
\index{forced motion!oscillation!damped}
\index{RLC circuit!forced oscillation with damping}
...
\emph{\color{blue}steady state}\index{charge!steady state}\index{steady state charge}
charge on the capacitor of the RLC circuit. Since
...
\index{applications!of linear second order equations!motion under a central force}
\index{force!motion under central}

We'll now study the motion of a object moving under the influence
of a \indexterm{central force}; that is, a force whose magnitude at any
...
this curve the \indexterm{orbit}.
...
\]\index{central force!in terms of polar coordinates}\index{polar coordinates!central force}
as
\[
...
\index{applications!of linear second order equations!motion under inverse square law force}
\index{force!motion under inverse square law}
