...
\[
\phi=\cos^{-1}\left(-\sqrt{\frac{5}{7}}\right)\approx\qty{2.58}{\radian}.
\]
...
$y(0)=1.5$ \unit{\feet} and $y'(0)=\qty{-3}{\feet\per\second}$.
\end{example}
...
Let the damping constant in Example 1 be $c=\qty{40}{\pound\second\per\foot}$. Find the
