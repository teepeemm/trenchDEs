...
\cos\phi={\frac{3}{2}\over\frac{3}{8}\sqrt{17}}={4\over\sqrt{17}}
\end{equation}
and
\begin{equation}\label{eq:6.1.12}
\sin\phi={-\frac{3}{8}\over\frac{3}{8}\sqrt{17}}=-{1\over\sqrt{17}}.
\end{equation}
...
The  phase angle  is determined by
\[
\cos\phi={c_1\over R}=-\sqrt{\frac{5}{7}}\mbox{\quad and \quad}\sin\phi=
{c_2\over R}=\sqrt{\frac{2}{7}}.
\]
...
y=e^{-t}\bigg(\frac{3}{2}\cos3\sqrt7t-{1\over2\sqrt7}
\sin3\sqrt7t\bigg).
\end{equation}
 The amplitude of the function in parentheses is
\[
 R=\sqrt{\bigg(\frac{3}{2}\bigg)^2+\bigg({1\over2\sqrt7}\bigg)^2}
=\sqrt{\frac{9}{4}+{1\over4\cdot7}}
...
values of $r$  are
\begin{eqnarray*}
r_{\min}&=&{\rho\over1+e}\quad\mbox{(the \emph{\color{blue}perihelion
