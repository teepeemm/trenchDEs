...
\cos\phi={\frac{3}{2}\over\frac{3}{8}\sqrt{17}}=\frac{4}{\sqrt{17}}
\end{equation}
and
\begin{equation}\label{eq:6.1.12}
\sin\phi={-\frac{3}{8}\over\frac{3}{8}\sqrt{17}}=-\frac{1}{\sqrt{17}}.
\end{equation}
...
since
\[
{u'\over\theta'}=\frac{du}{dt}\left/\frac{d\theta}{dt}\right.=
\frac{du}{d\theta}.
\]
...
\[
A=\frac{1}{2}\int_{t_1}^{t_2} h\,dt={h(t_2-t_1)\over2},
\]
