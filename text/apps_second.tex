...
\[
\cos\phi=\frac{c_1}{\sqrt{c_1^2+c_2^2}}\quad\text{and}\quad \sin\phi=
...
\item\label{exer:6.1.6}A 10 kg mass stretches a spring \qty{70}{\centi\meter} in equilibrium. Suppose a \qty{2}{\kilo\gram} mass is
...
A \qty{4}{\pound} weight stretches a spring 1 ft in equilibrium. An external
...
and a dashpot provides a damping force of $c$ \unit{\pound} for each ft/sec of
velocity.
\begin{alist}
\item % (a)
...
$y(0)=1.5$ ft and $y'(0)=\qty{-3}{\feet\per\second}$.
\end{example}
...
\item\label{exer:6.2.1}A \qty{64}{\pound} object stretches a spring 4 ft in equilibrium. It is attached
...
A \qty{16}{\pound} weight is attached to a spring with natural length 5 ft. With
...
\item\label{exer:6.2.4}A \qty{96}{\pound} weight stretches a spring 3.2 ft in equilibrium. It is
...
\item\label{exer:6.2.6}An \qty{8}{\pound} weight stretches a spring .32 ft. The weight is initially
...
damping force of \qty{1.5}{\pound} for each ft/sec of velocity.

\item\label{exer:6.2.7}A \qty{32}{\pound} weight stretches a spring 2 ft in equilibrium. It is attached
...
\item\label{exer:6.2.8}A mass of 20 gm stretches a  spring \qty{5}{\centi\meter}.  The spring
is attached to a dashpot with damping constant \qty{400}{\dyne\seconc\per\centi\meter}.  Determine
...
motion with \qty{6}{\pound} of force for each ft/sec of velocity.

\item\label{exer:6.2.10}A \qty{32}{\pound} weight stretches a spring 1 ft in equilibrium. The weight is
initially displaced 6 inches above equilibrium and given a downward
...
A \qty{2}{\pound} weight stretches a spring .32 ft. The weight is initially
displaced 4 inches below equilibrium and given an upward velocity of 5
ft/sec. The medium provides damping with constant $c=1/8$ \unit{\pound\second\per\foot}.
...
\item\label{exer:6.2.14}A \qty{32}{\pound} weight stretches a spring 1 ft in equilibrium. It is attached
...
\item\label{exer:6.2.15}A mass of one kg stretches a spring \qty{49}{\centi\meter} in equilibrium. A dashpot
...
dashpot supplies \qty{24}{\pound} of damping for each ft/sec of velocity.
