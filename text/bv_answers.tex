...
-4\sum_{n=1}^\infty\frac{(-1)^n}{n}\sin nx$; $F(x)=
\begin{cases}
...
(-1)^n\frac{4n^2+1}{(4n^2-1)^2}\cos2n\pi x+\dst{\frac{1}{4\pi}\sum_{n=1}^\infty
(-1)^n\frac{2n+1}{n(n+1)}\cos(2n+1)\pi x}$; $F(x)=
\begin{cases}
0,&-1\le x<\frac{1}{2},\\
...
+\frac{8}{\pi^3}\sum_{n=0}^\infty\frac{1}{(2n+1)^3}\sin(2n+1)\pi x$; $F(x)=
\begin{cases}
\frac{1}{2},&\phantom{-}x=-1,\\
x^2,&-1< x<0,\\
...
\frac{n\pi x}{a}\,dx$
$u(x,y)=\dst\frac{72}{\pi^3}\sum_{n=1}^\infty
...
$\dst\alpha_n=\frac{2}{a}\int_0^a f(x)\cos
\frac{n\pi x}{a}\,dx,\quad n\ge1$
$\dst u(x,y)=\frac{8(1-y)}{15}-\frac{48}{\pi^4}\sum_{n=1}^\infty\frac{1}{n^4}\frac{\sinh n\pi(1-y)}{\sinh n\pi}\cos n\pi x$
...
$u(x,y)=\dst\frac{32}{\pi^3}\sum_{n=1}^\infty\left[
...
\frac{n\pi x}{a}\,dx$
$u(x,y)=\dst-12\sum_{n=1}^\infty(-1)^n\frac{\cosh n(y-2)}{n^3\cosh2n}
\sin nx$
...
$\dst\alpha_n=\frac{2}{a}\int_0^a f(x)\cos
\frac{n\pi x}{a}\,dx,\quad n\ge1$
$\dst u(x,y)=\frac{\pi^4}{30}-3\sum_{n=1}^\infty\frac{1}{n^4}\frac{\cosh2ny}{\cos2n}\cos 2nx$
...
$u(x,y)=\dst\frac{4}{\pi}\sum_{n=1}^\infty(-1)^{n+1}
...
\frac{n\pi x}{a}\,dx,\quad n\ge1$
$u(x,y)=\frac{\pi^3}{2}-\frac{48}{\pi}\sum_{n=1}^\infty\frac{1}{(2n-1)^4}e^{-(2n-1)y}\cos(2n-1)x$
...
$\alpha_n=\dst\frac{2}{a}\int_0^a
f(x)\cos\frac{(2n-1)\pi x}{2a}\,dx$
$u(x,y)=\dst\frac{5488}{\pi^3}\sum_{n=1}^\infty\frac{1}{(2n-1)^3}\left[
...
$\alpha_n=\dst\frac{2}{a}\int_0^a
f(x)\sin\frac{(2n-1)\pi x}{2a}\,dx$
$u(x,y)=-\dst\frac{2000}{\pi^3}\sum_{n=1}^\infty
\frac{1}{(2n-1)^3}
...
\dst\cos\frac
{n\pi\theta}{\gamma}$
$\alpha_0=\dst\frac{1}{\gamma}\int_0^\gamma
f(\theta)\,d\theta$,\quad
...
{(2n-1)\pi\theta}{2\gamma}$,
$\alpha_n=\dst\frac{2}{\gamma}\int_0^\gamma
g(\theta)\sin\frac{(2n-1)\pi\theta}{2\gamma}\,d\theta$,
 $n=1$, $2$, $3$,\dots
...
$y=\dst{\frac{\sin(x-a)}{\sin(b-a)}\int_{x}^{b}F(t)\sin(t-b)\,dt
+\frac{\sin(x-b)}{\sin(b-a)}\int_{a}^{x}F(t)\sin(t-a)\,dt}$
\part{b}\;    $\dst{\int_{a}^{b}F(t)\sin(t-a)\,dt=0}$
...
F(t)\cos(t-a)\,dt}+c_{1}\cos(x-a)$  with $c_{1}$ arbitrary
...
is necessary for existence of a solution. In this case,
$y=\dst{\frac{\cos(n+1/2)x}{n+1/2}\int_{x}^{\pi}F(t)\sin(n+1/2)t\,dt}+\dst{\frac{\sin(n+1/2)x}{n+/2}\int_{0}^{x}F(t)\cos(n+1/2)t\,dt
+c_{1}\cos(n+1/2)x}$
with $c_{1}$ arbitrary.
...
nt\,dt=0}$ is necessary for existence of a solution. In this case,
...
solution. Then $y=\dst{\int_{x}^{b}tF(t)\,dt+x\int_{a}^{x}F(t)\,dt+c_{1}}$
with $c_{1}$ arbitrary.
...
$y_{n}=e^{-x}(n\pi\cos n\pi x+\sin n\pi x)$  ($n=$ positive integer)

\smallskip

\answer{13.2.11} \part{a} $\lambda=0$ is an eigenvalue   $y_{0}=2-x$\;
\part{b} none\;    \part{c} $5.0476821$, $14.9198790$, $29.7249673$,
...
\answer{13.2.14} \part{a} $\lambda=0$ isn't  an eigenvalue\;   \part{b} 
$-0.1945921$
