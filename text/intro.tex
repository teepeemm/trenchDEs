...
\boxit{Interacting Species: Competition}\index{competition between species}\index{species!competition between}
...
\indexterm{ordinary differential equation} if it involves an unknown
function of only one variable, or a \indexterm{partial differential
