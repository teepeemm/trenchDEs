...
\item $\dst\frac{d^2y}{dx^2}+2\frac{dy}{dx}\ \frac{d^3y}{dx^3}+x=0$
\item $y''-3y'+2y=x^7$
\item $y'-y^7=0$
\item $y''y-(y')^2=2$
\end{alist}
...
\includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig010302}
...
\begin{minipage}[t]{0.49\linewidth}
\tagstructbegin{tag=Sect}%
\includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig010303}
...
\begin{minipage}[t]{0.49\linewidth}
\tagstructbegin{tag=Sect}
\includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig010306}
\captionof{figure}{A direction field and integral curves for
...
\begin{minipage}[t]{0.49\linewidth}
\tagstructbegin{tag=Sect}
\includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig010307}
\captionof{figure}{}
\label{figure:1.3.7}
\tagstructend
\end{minipage}
