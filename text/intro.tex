...
\medskip\noindent
\zcref[S,CAP]{sec:apps_leading_DEs} presents
examples of applications that lead to differential equations.

\medskip\noindent
\zcref[S,CAP]{sec:basic_concepts} introduces basic concepts and
definitions concerning differential equations.

\medskip\noindent
\zcref[S,CAP]{sec:dir_fields} presents a geometric method for dealing with
...
\exercisetext{In Exercises~\ref{exer:1.3.12}--\ref{exer:1.3.22} construct a
direction
