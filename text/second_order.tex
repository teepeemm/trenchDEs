...
\medskip\noindent
\zcref[S,CAP,font=\scshape]{sec:reduction_order} deals with \emph{\color{blue}reduction of order}, a
...
\eqref{eq:5.1.1} is \emph{\color{blue}homogeneous} if $f\equiv0$ or {\color{blue}\itshape
...
\item\label{exer:5.1.1}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:5.1.2}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:5.1.3}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:5.1.4}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:5.1.42}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:5.1.43}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:5.1.44}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\emph{\color{blue}reduction of order} that we'll study in \zcref{sec:reduction_order}.
...
\begin{exerciselist}
\item(1)\label{exer:5.2.1}$y''+5y'-6y=0$
\item(1)\label{exer:5.2.2}$y''-4y'+5y=0$
\item(1)\label{exer:5.2.3}$y''+8y'+7y=0$
\item(1)\label{exer:5.2.4}$y''-4y'+4y=0$
\item(1)\label{exer:5.2.5}$y''+2y'+10y=0$
\item(1)\label{exer:5.2.6}$y''+6y'+10y=0$
\item(1)\label{exer:5.2.7}$y''-8y'+16y=0$
\item(1)\label{exer:5.2.8}$y''+y'=0$
\item(1)\label{exer:5.2.9}$y''-2y'+3y=0$
\item(1)\label{exer:5.2.10}$y''+6y'+13y=0 $
\item(1)\label{exer:5.2.11}$4y''+4y'+10y=0$
\item(1)\label{exer:5.2.12}$10y''-3y'-y=0$

\exercisetext{In \zcref[range]{exer:5.2.13,exer:5.2.17} solve
the initial value problem.}
...
\item\label{exer:5.2.22}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\exercisetext{In \zcref[range]{exer:5.3.8,exer:5.3.13} find a
particular solution by the method used in \zcref{example:5.3.3}.}

\item(1)\label{exer:5.3.8}$x^2y''+7xy'+8y=\dfrac{6}{x}$
\item(1)\label{exer:5.3.9}$x^2y''-7xy'+7y=13x^{1/2}$
\item(1)\label{exer:5.3.10}$x^2y''-xy'+y=2x^3$
\item(1)\label{exer:5.3.11}$x^2y''+5xy'+4y=\dfrac{1}{x^3}$
\item(1)\label{exer:5.3.12}$x^2y''+xy'+y=10x^{1/3}$
\item(1)\label{exer:5.3.13}$x^2y''-3xy'+13y=2x^4$
...
\item(1)\label{exer:5.3.16}$y''+5y'-6y=6e^{3x}$
\item(1)\label{exer:5.3.17}$y''-4y'+5y=e^{2x}$
...
\item(1)\label{exer:5.3.20}$y''+2y'+10y=e^{x/2}$
\item(1)\label{exer:5.3.21}$y''+6y'+10y=e^{-3x}$
...
\item(1)\label{exer:5.4.1}$y''-3y'+2y=e^{3x}(1+x)$
\item(1)\label{exer:5.4.2}$y''-6y'+5y=e^{-3x}(35-8x)$
\item(1)\label{exer:5.4.3}$y''-2y'-3y=e^x(-8+3x)$
\item(1)\label{exer:5.4.4}$y''+2y'+y=e^{2x}(-7-15x+9x^2)$
\item(1)\label{exer:5.4.5}$y''+4y=e^{-x}(7-4x+5x^2)$
\item(1)\label{exer:5.4.6}$y''-y'-2y=e^x(9+2x-4x^2)$
\item(1)\label{exer:5.4.7}$y''-4y'-5y=-6xe^{-x}$
\item(1)\label{exer:5.4.8}$y''-3y'+2y=e^x(3-4x)$
\item(1)\label{exer:5.4.9}$y''+y'-12y=e^{3x}(-6+7x)$
\item(1)\label{exer:5.4.10}$2y''-3y'-2y=e^{2x}(-6+10x)$
\item(1)\label{exer:5.4.11}$y''+2y'+y=e^{-x}(2+3x)$ 
\item(1)\label{exer:5.4.12}$y''-2y'+y=e^x(1-6x)$

\item\label{exer:5.4.13}$y''-4y'+4y=e^{2x}(1-3x+6x^2)$

\item\label{exer:5.4.14}$9y''+6y'+y=e^{-x/3}(2-4x+4x^2)$

\exercisetext{In \zcref[range]{exer:5.4.15,exer:5.4.19} find the general
solution.}

\item(1)\label{exer:5.4.15}$y''-3y'+2y=e^{3x}(1+x)$ 
\item(1)\label{exer:5.4.16}$y''-6y'+8y=e^x(11-6x)$
\item(1)\label{exer:5.4.17}$ y''+6y'+9y=e^{2x}(3-5x)$ 
\item(1)\label{exer:5.4.18}$y''+2y'-3y=-16xe^x$

\item\label{exer:5.4.19}$y''-2y'+y=e^x(2-12x)$

\exercisetext{In \zcref[range]{exer:5.4.20,exer:5.4.23} solve the
...
\item\label{exer:5.4.30}\begin{alist}[above=-\baselineskip]
 \item % (a)
...
\item\label{exer:5.5.36}\begin{alist}[above=-\baselineskip]
\item % (a)
Verify that if
\[
y_p=A(x)\cos\omega x+B(x)\sin\omega x
...
% TODO this is too long for one page
...
% TODO (2) columns for the last one
\end{alist}
...
\item(1)\label{exer:5.7.1}$y''+9y=\tan 3x$
\item(1)\label{exer:5.7.2}$y''+4y=\sin 2x\sec^2 2x$
\item(1)\label{exer:5.7.3}$y''-3y'+2y=\dfrac{4}{1+e^{-x}}$
\item(1)\label{exer:5.7.4}$y''-2y'+2y=3e^x \sec x$
\item(1)\label{exer:5.7.5}$y''-2y'+y=14x^{3/2}e^x$
\item(1)\label{exer:5.7.6}$y''-y=\dfrac{4e^{-x}}{1-e^{-2x}}$

\exercisetext{In \zcref[range]{exer:5.7.7,exer:5.7.29} use variation
