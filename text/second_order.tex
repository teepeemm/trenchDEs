...
\item $\{x+1,  x^2+2\}$
\item $\{ x^{1/2},  x^{-1/3}\}$
\item $\{\dst \frac{\sin x}{x},  \frac{\cos x}{x}\}$
...
\quad y'_2(x_0)=1.
\]
Then use  Exercise~\ref{exer:5.1.37}(c) to write
...
\begin{figure}[tbp]
  \centering
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig050201}
\color{blue}
...
\begin{figure}[H]
  \centering
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig050202}
\color{blue}
\vspace*{-10pt}
  \caption{$y=e^{-3x}(3+8x)$}
  \label{figure:5.2.2}
...
Figure~\ref{figure:5.2.3}  is a graph of this function. \bbox
  ...
  \centering
\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig050203}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig050301}
\color{blue}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig050302}
\color{blue}
...
Exercise~\ref{exer:5.4.30}.) Therefore \eqref{eq:5.4.13} does not have a
...
\begin{figure}[tbp]
  \centering
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig050701}
\color{blue}
