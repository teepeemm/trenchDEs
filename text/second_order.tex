...
\emph{\color{blue}nonhomogeneous}\index{nonhomogeneous differential equation}\index{differential equation!nonhomogeneous}\index{linear second order equation!nonhomogeneous} if $f\not\equiv0$. Since these definitions are like
the corresponding definitions in \zcref{sec:linar_first_order} for the linear
...
In \zcref{sec:linar_first_order} we considered the homogeneous equation
...
the \indexterm{trivial solution}\index{differential equation!trivial solution}\index{trivial solution!homogeneous linear second order equation}. Any other solution is \emph{\color{blue}nontrivial}\index{nontrivial solution!homogeneous linear second order equation}\index{differential equation!nontrivial solution}.
...
used in \zcref{sec:linar_first_order} to solve the nonhomogeneous
...
\]
This is
\personHref{Euler}{Euler's identity}.
\item % (b)
Starting from
\[
...
\index{nonhomogeneous equation!linear}
\index{linear equation!nonhomogeneous}
...
y''+p(x)y'+q(x)y=0
\end{equation}
on $(a,b)$. We call \eqref{eq:5.3.2} the \indexterm{complementary equation}\index{linear second order equation!complementary equation}
for \eqref{eq:5.3.1}.
...
$y_p$ a
\emph{\color{blue}particular solution}\index{particular solution!nonhomogeneous equation!linear second order}\index{linear second order equation!nonhomogeneous!particular solution}
...
is
$y=y_p+c_1y_1+c_2y_2$, where $y_p$ is a particular solution\index{particular solution!nonhomogeneous equation!linear second order} of
...
for finding a particular solution\index{particular solution!nonhomogeneous equation!linear second order} of
