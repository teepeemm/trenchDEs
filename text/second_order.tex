...
\eqref{eq:5.1.1} is \emph{\color{blue}homogeneous} if $f\equiv0$ or
\emph{\color{blue}nonhomogeneous} if $f\not\equiv0$. Since these definitions are like
...
\personHref{Legendre}{Legendre's equation}.)
...
\personHref{Bessel}{Bessel's equation}.)
...
\]
is  the
\personHref{Riccati}{generalized Riccati equation}.
