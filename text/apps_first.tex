...
\[
T=25+375 e^{-{t\over 4} \ln \frac{15}{7}}
\]
...
\[
T = -20+80 e^{-{t\over 2}\ln \frac{8}{7}},
\]
 and the condition $T(\tau)=72$  implies that
\[
72 =-20+80 e^{-{\tau\over 2} \ln \frac{8}{7}};
\]
 hence,
\[
e^{-{\tau\over 2} \ln \frac{8}{7}} =\frac{92}{80} =
\frac{23}{20}.
\]
...
\color{blue}
  \caption{$T = -20+80 e^{-{t\over 2}\ln \frac{8}{7}}$}
  \label{figure:4.2.2}
\end{figure}
...
time $t$.  Then
\[
K(t) = \frac{1}{4}-{2000\over(t+100)^2}
\]
...
\color{blue}
  \caption{$K(t) = \dst{\frac{1}{4}-{2000\over(t+100)^2}}$}
  \label{figure:4.2.6}
\end{figure}
...
=\frac{1}{14}\left[{1\over v-7}
-{1\over v+7}\right].
\end{equation}
 Substituting (\ref{eq:4.3.12})  into (\ref{eq:4.3.11}) yields
\[
\frac{1}{14}\left[{1\over v-7}-{1\over v+7}\right]v'=\frac{1}{5},
\]
 so
\[
\left[{1\over v-7}-{1\over v+7}\right]v'=\frac{14}{5}.
\]
...
\[
-T+\frac{5}{7} \tan^{-1}{v_0\over7}=0.
\]
Therefore
\[
T=\frac{5}{7} \tan^{-1}{v_0\over7}.
\]
