...
\[
\tau = -{2 \ln \frac{23}{20}\over \ln \frac{8}{7}} \approx-2.09\
\mbox{min}.
\]
...
are of the form
\[
Q=\frac{u}{t+100},\mbox{\quad where \quad}{u'\over t+100}=1,\mbox{\quad
so \quad} u'=t+100.
\]
Hence,
...
Since
\[
\int{\sqrt k\,dy\over\sqrt{\rho-ky^2}}=\sin^{-1}\left(\sqrt\frac{k}{\rho
...
Therefor
\[
{y'\over y}=-\frac{1}{x^2-x}=-\frac{1}{x(x-1)}=\frac{1}{x}-\frac{1}{x-1},
\]
so
\[
\ln|y|=\ln|x|-\ln|x-1|+k=
...
\[
u'x+u={2x(ux)\over x^2-(ux)^2}=\frac{2u}{1-u^2},
\]
so
\[
u'x=\frac{2u}{1-u^2}-u={u(u^2+1)\over1-u^2},
\]
Separating variables yields
\[
