...
Error} \\
& {(Example~\ref{example:4.1.6}, \$)} & {(Exercise~\ref{exer:4.1.21}, \$)} & {$Q-P$} & {$(Q-P)/P$} \\\midrule
...
\item\label{exer:4.1.23}Assume that the homebuyer of Exercise \ref{exer:4.1.22} elects to repay the
