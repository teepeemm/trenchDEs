...
\item\label{exer:4.1.21}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:4.3.19}\begin{alist}[above=-\baselineskip]
\item %(a)
...
\begin{exerciselist}
\item(1)\label{exer:4.4.1}\CGex $y''+y^3=0$
\item(1)\label{exer:4.4.2}\CGex $y''+y^2=0$
\item(1)\label{exer:4.4.3}\CGex$ y''+y|y|=0$ 
\item(1)\label{exer:4.4.4}\CGex $y''+ye^{-y}=0$

\exercisetext{
In \zcref[range]{exer:4.4.5,exer:4.4.8} find the equations of the
trajectories of the given undamped equation. Identify the equilibrium
solutions,
...
\item(1)\label{exer:4.4.5}\CGex $y''-y^3+4y=0$ 
\item(1)\label{exer:4.4.6}\CGex $y''+y^3-4y=0$
\item(1)\label{exer:4.4.7}\CGex $y''+y(y^2-1)(y^2-4)=0$
\item(1)\label{exer:4.4.8}\CGex $y''+y(y-2)(y-1)(y+2)=0$

\exercisetext{In \zcref[range]{exer:4.4.9,exer:4.4.12}
...
\item(1)\label{exer:4.4.9}\Lex $y''+y^2-a=0$
\item(1)\label{exer:4.4.10}\Lex $y''+y^3-ay=0$
\item(1)\label{exer:4.4.11}\Lex $y''-y^3+ay=0$
\item(1)\label{exer:4.4.12}\Lex $y''+y-ay^3=0$

\exercisetext{In \zcref[range]{exer:4.4.13,exer:4.4.18}
...
\item(1)\label{exer:4.4.13}\Lex $y''+cy'+y^3=0$
\item(1)\label{exer:4.4.14}\Lex $y''+cy'-y=0$
\item(1)\label{exer:4.4.15}\Lex $y''+cy'+y^3=0$
\item(1)\label{exer:4.4.16}\Lex $y''+cy'+y^2=0$
\item(1)\label{exer:4.4.17}\Lex $y''+cy'+y|y|=0$
\item(1)\label{exer:4.4.18}\Lex $y''+y(y-1)+cy=0$
...
% TODO escape enumext's minipage
\exercisetext{%
\begin{figure}
  \centering
...
\item(1)\label{exer:4.5.1}$y(x^2+y^2)=c$
\item(1)\label{exer:4.5.2}$e^{xy}=cy$
\item(1)\label{exer:4.5.3}$\ln |xy|=c(x^2+y^2)$
\item(1)\label{exer:4.5.4}$y=x^{1/2}+cx$
\item(1)\label{exer:4.5.5}$y=e^{x^2}+ce^{-x^2}$
\item(1)\label{exer:4.5.6}$y=x^3+\dfrac{c}{x}$
\item(1)\label{exer:4.5.7}$y=\sin x+ce^x$
\item(1)\label{exer:4.5.8}$y=e^x+c(1+x^2)$
...
\item\label{exer:4.5.15}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:4.5.16}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\exercisetext{In \zcref[range]{exer:4.5.25,exer:4.5.29} find the
orthogonal trajectories of the given family of curves.}

\item(1)\label{exer:4.5.25}$x^2+2y^2=c^2$
\item(1)\label{exer:4.5.26}$x^2+4xy+y^2=c$
\item(1)\label{exer:4.5.27}$y=ce^{2x}$
\item(1)\label{exer:4.5.28}$xye^{x^2}=c$
