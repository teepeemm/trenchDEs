...
\boxit{Newton's Law of Cooling}\index{Newton's!law of cooling}\index{cooling!Newton's law of}
...
\emph{\color{blue}trajectories}\index{trajectory of equation} of \eqref{eq:4.4.1}, and we'll call
...
law of motion.\index{autonomous second order equation!Newton's second law of motion}
...
law of motion\index{Newton's!second law of motion} leads to \eqref{eq:4.4.5}.
...
$c$ is called the \indexterm{damping constant}\index{constant!damping}. In situations where
