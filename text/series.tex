...
\[
\lim_{n\to\infty}\left|a_{n+1}\over a_n\right|=\lim_{n\to\infty}
{n!\over (n+1)!}=\lim_{n\to\infty}\frac{1}{n+1}=0.
\]
Hence, $R=\infty$.
...
\[
\lim_{n\to\infty}\left|a_{n+1}\over a_n\right|=\lim_{n\to\infty}
{2^{n+1}(n+1)^2\over2^nn^2}=2\lim_{n\to\infty}\left(1+\frac{1}{n}\right)^2=2.
\]
Hence, $R=1/2$.
...
From  \eqref{eq:7.1.6},
\[
f'(x)=\sum_{n=0}^\infty(-1)^n\frac{d}{dx}\left[x^{2n+1}\over(2n+1)!\right]=
