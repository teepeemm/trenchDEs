...
\personHref{Maclaurin}{Maclaurin series of} $f$.
...
\personHref{Chebyshev}{Chebyshev's equation},
\[
(1-x^2)y''-xy'+\alpha^2 y=0,
\]
and
\personHref{Hermite}{Hermite's equation},
\[
y''-2xy'+2\alpha y=0.
\]
Since
...
An
\personHref{Euler}{Euler equation} is an equation that can be written in the
form
...
\shortintertext{and}
xy''+(1-x)y'+\lambda y&=0,
\quad\text{(\personHref{Laguerre}{Laguerre's equation})},
\end{align*}
...
\]
is
\personHref{Bessel}{Bessel's equation of order zero}. (See
