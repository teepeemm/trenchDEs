...
{\bf (a)} $\dst{\sum_{n=0}^\infty\frac{(-1)^n}{2^nn}(x-1)^n}$&
{\bf (b)} $\dst{\sum_{n=0}^\infty 2^nn(x-2)^n}$\\
{\bf (c)} $\dst{\sum_{n=0}^\infty\frac{n!}{9^n}x^n}$&
{\bf (d)} $\dst{\sum_{n=0}^\infty\frac{n(n+1)}{16^n}(x-2)^n}$\\
{\bf (e)} $\dst{\sum_{n=0}^\infty (-1)^n\frac{7^n}{n!}x^n}$&
{\bf (f)} $\dst{\sum_{n=0}^\infty \frac{3^n}{4^{n+1}(n+1)^2}(x+7)^n}$
\end{tabular}
...
(-1)^m\frac{m(2m+1)}{2^m}(x+2)^{2m}}$ \\
{\bf (c)} $\dst{\sum_{m=0}^\infty\frac{m!}{(2m)!}(x-1)^{2m}}$&
{\bf (d)} $\dst{\sum_{m=0}^\infty (-1)^m\frac{m!}{9^m}(x+8)^{2m}}$\\
{\bf (e)} $\dst{\sum_{m=0}^\infty(-1)^m\frac{(2m-1)}{3^m}x^{2m+1}}$&
...
\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
{\bf (a)} $\dst{\sum_{m=0}^\infty\frac{(-1)^m}{(27)^m}(x-3)^{3m+2}}$&
{\bf (b)} $\dst{\sum_{m=0}^\infty\frac{x^{7m+6}}{m}}$ \\
{\bf (c)} $\dst{\sum_{m=0}^\infty\frac{9^m(m+1)}{(m+2)}(x-3)^{4m+2}}$&
{\bf (d)} $\dst{\sum_{m=0}^\infty(-1)^m\frac{2^m}{m!}x^{4m+3}}$\\
{\bf (e)} $\dst{\sum_{m=0}^\infty\frac{m!}{(26)^m}(x+1)^{4m+3}}$&
{\bf (f)} $\dst{\sum_{m=0}^\infty\frac{(-1)^m}{8^mm(m+1)}(x-1)^{3m+1}}$
\end{tabular}
...
\item\label{exer:7.1.11}$\vspace*{-5pt}(2+x)y''+xy'+3y$
%&
\item\label{exer:7.1.12}\vspace*{10pt}$(1+3x^2)y''+3x^2y'-2y$
%\end{tabular}
