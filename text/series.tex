...
From  \eqref{eq:7.1.6},
\[
f'(x)=\sum_{n=0}^\infty(-1)^n\frac{d}{dx}\left[\fracx^{2n+1}}{(2n+1)!}\right]=
...
\[
\lim_{m\to\infty}\left|\fracb_{m+1}}{b_m}\right|=L,
\]
...
\begin{array}{ccl}
a_n(r)&=&\dst\frac{\prod_{j=1}^n{(j+r+2)(2j+2r-1)}{(j+r+1)(j+r+6)}}\\[10pt]
