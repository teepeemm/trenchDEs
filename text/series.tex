...
\\[5pt] a_7&=&-4\,\frac{3}{7}a_5=-4\,\frac{3}{7}\left(
...
\eqref{eq:7.2.30}:
\begin{eqnarray*}
a_2&=&-4\,\frac{1}{1}2=-8,\\[2\jot]
a_4&=&-4\,\frac{2}{3}(-8)=\frac{64}{3},\\[2\jot]
a_6&=&-4\,\frac{3}{5}\left(\frac{64}{3}\right)=-\frac{256}{5}.
\end{eqnarray*}
Starting with $a_1=y'(0)=-3$, we compute $a_3,a_5$ and $a_7$ from
\eqref{eq:7.2.31}:
\begin{eqnarray*}
a_3&=&-\frac{3}{1}(-3)=9,\\[2\jot]
a_5&=&-\frac{5}{2}9=-\frac{45}{2},\\[2\jot]
...
%&
\item\label{exer:7.2.6}$\dst{(1+x^2)y''+2xy'+\frac{1}{4}y=0}$
%\end{tabular}
...
\frac{p(3j)}{3j+2}\right]\frac{x^{3m}}{3^m m!}}\\[2\jot]
...
\begin{eqnarray*}
\frac{d^2Y}{dt^2}&=&\frac{d\phantom{t}}{dt}\left(\frac{dY}{dt}\right)=\frac{d\phantom{t}}{dt}\left(x\frac{dy}{dx}\right)\\[2\jot]
&=&\frac{dx}{dt}\frac{dy}{dx}+x\frac{d^2y}{dx^2}\frac{dx}{dt}\\[2\jot]
...
\begin{array}{ccl}
a_0(r)&=&1,\\
a_1(r)&=&-\dst\frac{p_1(r)}{p_0(r+1)},\\[2\jot]
...
=-\dst\frac{r+2}{r+3},\\[2\jot]
a_n(r)&=&-\dst\frac{p_1(n+r-1)a_{n-1}+p_2(n+r-2)a_{n-2}}{p_0(n+r)}\\[2\jot]
&=&-\dst\frac{(n+r+1)(2n+2r+3)a_{n-1}(r)
+(n+r-1)(2n+2r+3)a_{n-2}(r)}{(n+r+2)(2n+2r+3)}\\[2\jot]
...
+\frac{7}{135}x^4+\frac{76}{1155}x^5+\cdots\right),\\[2\jot]
...
\begin{array}{ccl}
a_0(r)&=&1,\\
a_n(r)&=&-\dst\frac{p_1(n+r-1)}{p_0(n+r)}a_{n-1}(r)\\[2\jot]
...
\begin{array}{ccl}
a_0(r)&=&1,\\
a_{2m}(r)&=&-\dst\frac{p_2(2m+r-2)}{p_0(2m+r)}a_{2m-2}(r)\\[2\jot]
...
\begin{array}{ccl}
a_0(r)&=&1,\\
a_1(r)&=&-\dst\frac{p_1(r)}{p_0(r+1)},\\[10pt]
a_n(r)&=&-\dst\frac{p_1(n+r-1)a_{n-1}(r)+p_2(n+r-2)a_{n-2}(r)}{p_0(n+r)},\quad n\ge2.
\end{array}
\]
Then the Frobenius series
...
r}(x,r)&=&\dst{\frac{\partial}{\partial r}(x^r)\sum_{n=0}^\infty
...
a_0(r)&=&1,\\
a_1(r)&=&-\dst\frac{p_1(r)}{p_0(r+1)}
=-\dst\frac{(r-1)(2r+1)}{(r-1)^2}
=\dst\frac{2r+1}{r-1},\\[10pt]
a_n(r)&=&-\dst\frac{p_1(n+r-1)a_{n-1}(r)+p_2(n+r-2)a_{n-2}(r)}{p_0(n+r)}\\[10pt]
&=&\dst\frac{(n+r-2)\left[(2n+2r-1)a_{n-1}(r)
-(n+r-3)a_{n-2}(r)\right]}{(n+r-2)^2}\\[10pt]
...
\begin{array}{ccl}
a'_1(r)&=&-\dst\frac{3}{(r-1)^2},\\[10pt]
a'_n(r)&=&\dst{\frac{2n+2r-1}{n+r-2}a'_{n-1}(r)-\frac{n+r-3}{n+r-2}a'_{n-2}(r)}\\[10pt]
&&\dst{-\frac{3}{(n+r-2)^2}a_{n-1}(r)-\frac{1}{(n+r-2)^2}a_{n-2}(r)},\quad
n\ge2.
\end{array}
\end{equation}
...
\begin{array}{ccl}
a_0(r)&=&1,\\
a_n(r)&=&-\dst\frac{p_1(n+r-1)}{p_0(n+r)}a_{n-1}(r),\\[10pt]
...
(-1)^n\prod_{j=1}^n\dst\frac{2j+1}{4j},\\[10pt]
...
\begin{array}{ccl}
a_0(r)&=&1,\\
a_{2m}(r)&=&-\dst\frac{p_2(2m+r-2)}{p_0(2m+r)}a_{2m-2}(r)\\[10pt]
...
x^n\\[10pt]&&-\frac{1}{k!(k-1)!}\left(\frac{\gamma_1}{\alpha_0}\right)^k\left(y_1\ln x-
...
x^{2m}\\[10pt]&&-\frac{2}{4^kk!(k-1)!}\left(\frac{\gamma_2}{\alpha_0}\right)^k\left(y_1\ln x-
