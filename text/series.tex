...
exercise (\zcref{exer:7.5.52}).% \bbox
\end{proof}
...
\left(\sum_{j=1}^m\frac{1}{j(2j+1)}\right)x^{2m}. \bbox
\]
...
\left(\sum_{j=1}^n\frac{1}{j(2j+5)}\right)x^n. \bbox
\end{align*}
...
to
\[
y_2=x^{-6}\left(1-\frac{33}{4}x+\frac{99}{4}x^2-\frac{231}{8}x^3\right).\bbox
\]
