...
-\frac{5}{3}\left(1\cdot3\over1\cdot2\right)a_0
...
\]
 Therefore
\[
a_{n+2}=-2{(n+2)^2\over(n+2)(n+1)}a_n=-2\frac{n+2}{n+1}a_n,\quad n\ge0.
\]
Writing this equation separately for $n=2m$  and $n=2m+1$ yields
\begin{eqnarray}
a_{2m+2}&=&-2{(2m+2)\over2m+1}a_{2m}=-4\frac{m+1}{2m+1}a_{2m},\quad m\ge
0\label{eq:7.2.30}\\
\noalign{\hspace*{-15pt}\mbox{and}}\nonumber\\
...
a_6&=&-4\,\frac{3}{5}\left(64\over3\right)=-\frac{256}{5}.
\end{eqnarray*}
