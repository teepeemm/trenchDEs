...
\item(1)\label{exer:7.2.6}$\dst{(1+x^2)y''+2xy'+\frac{1}{4}y=0}$
...
\begin{aligned}
a_0(r)&=1,\\
a_1(r)&=-\dst\frac{p_1(r)}{p_0(r+1)},\\
a_n(r)&=-\dst\frac{p_1(n+r-1)a_{n-1}(r)+p_2(n+r-2)a_{n-2}(r)}{p_0(n+r)},\quad n\ge2.
\end{aligned}
\end{equation}
...
a_0(r)&=1,\\
a_1(r)&=-\dst\frac{p_1(r)}{p_0(r+1)}
=-\dst\frac{(2r+5)(r+2)}{(2r+5)(r+3)}
=-\dst\frac{r+2}{r+3},\\
a_n(r)&=-\dst\frac{p_1(n+r-1)a_{n-1}+p_2(n+r-2)a_{n-2}}{p_0(n+r)}\\
&=-\dst\frac{(n+r+1)(2n+2r+3)a_{n-1}(r)
...
a_0(-3/2)&=1,\\
a_1(-3/2)&=-1/3,\\
a_n(-3/2)&=-\dst\frac{(2n-1)a_{n-1}(-3/2)+
...
a_0(-2)&=1,\\
a_1(-2)&=0,\\
a_n(-2)&=-\dst\frac{(n-1)a_{n-1}(-2)+(n-3)a_{n-2}(-2)}{n},\quad n\ge2.
\end{aligned}
\end{equation}
...
\begin{aligned}
a_0(r)&=1,\\
a_n(r)&=-\dst\frac{p_1(n+r-1)}{p_0(n+r)}a_{n-1}(r),\quad n\ge1.
\end{aligned}
\end{equation}
...
\begin{aligned}
a_0(r)&=1,\\
a_n(r)&=-\dst\frac{p_1(n+r-1)}{p_0(n+r)}a_{n-1}(r)\\
&=-\dst\frac{(n+r+1)^2}{(3n+3r-1)(n+r+1)}a_{n-1}(r)\\
...
a_0(r)&=1,\\
a_1(r)&=0,\\
a_n(r)&=-\dst\frac{p_2(n+r-2)}{p_0(n+r)}a_{n-2}(r),\quad n\ge2.
\end{align*}
...
\begin{aligned}
a_0(r)&=1,\\
a_{2m}(r)&=-\dst\frac{p_2(2m+r-2)}{p_0(2m+r)}a_{2m-2}(r),\quad m\ge1.
\end{aligned}
\end{equation}
...
\begin{aligned}
a_0(r)&=1,\\
a_{2m}(r)&=-\dst\frac{p_2(2m+r-2)}{p_0(2m+r)}a_{2m-2}(r)\\
...
\begin{align*}
a_0(1/2)&=1,\\
a_{2m}(1/2)&=\dst\frac{(4m-1)(4m+1)}{8m(4m-3)}a_{2m-2}(1/2),\quad
m\ge1,
\end{align*}
so
\[
...
\begin{aligned}
a_0(r)&=1,\\
a_{qm}(r)&=-\dst\frac{p_q\left(q(m-1)+r\right)}{p_0(qm+r)}a_{q(m-1)}(r),\quad m\ge1,
\end{aligned}
\]
then
\[
...
\begin{aligned}
a_0(r)&=1,\\
a_1(r)&=-\dst\frac{p_1(r)}{p_0(r+1)}=-\dst\frac{(r-1)(2r+1)}{(r-1)^2}
=\dst\frac{2r+1}{r-1},\\
a_n(r)&=-\dst\frac{p_1(n+r-1)a_{n-1}(r)+p_2(n+r-2)a_{n-2}(r)}{p_0(n+r)}\\
&=\dst\frac{(n+r-2)\left[(2n+2r-1)a_{n-1}(r)
-(n+r-3)a_{n-2}(r)\right]}{(n+r-2)^2}\\
&=\dst{\frac{(2n+2r-1)}{(n+r-2)}a_{n-1}(r)-
\frac{(n+r-3)}{(n+r-2)}a_{n-2}(r)},n\ge2.
\end{aligned}
\end{equation}
Differentiating yields
\begin{equation} \label{eq:7.6.12}
\begin{aligned}
a'_1(r)&=-\dst\frac{3}{(r-1)^2},\\
a'_n(r)
&=\dst{\frac{2n+2r-1}{n+r-2}a'_{n-1}(r)-\frac{n+r-3}{n+r-2}a'_{n-2}(r)}\\
...
a_0(2)&=1,\\
a_1(2)&=5,\\
a_n(2)&=\dst{\frac{(2n+3)}{n}
a_{n-1}(2)-\frac{(n-1)}{n}a_{n-2}(2)},\quad n\ge2
\end{aligned}
\end{equation}
and
...
\begin{aligned}
a_1'(2)&=-3,\\
a'_n(2)&=\dst{\frac{2n+3}{n}a'_{n-1}(2)-\frac{n-1}{n}a'_{n-2}(2)
-\frac{3}{n^2}a_{n-1}(2)-\frac{1}{n^2}a_{n-2}(2)},\quad n\ge2.
\end{aligned}
\end{equation}
...
a_0(r)&=1,\\
a_n(r)&=-\dst\frac{p_1(n+r-1)}{p_0(n+r)}a_{n-1}(r),\\
&=-\dst\frac{(n+r)(2n+2r-1)}{(2n+2r-1)^2}a_{n-1}(r),\\
&=-\dst\frac{n+r}{2n+2r-1}a_{n-1}(r),\quad n\ge0.
\end{align*}
We leave it to you to show that
...
\begin{aligned}
a_n(1/2)&=(-1)^n\dst\prod_{j=1}^n\dst\frac{j+1/2}{2j}=
(-1)^n\prod_{j=1}^n\dst\frac{2j+1}{4j},\\
...
a_0(r)&=1,\\
a_{2m}(r)&=-\dst\frac{p_2(2m+r-2)}{p_0(2m+r)}a_{2m-2}(r)\\
&=\dst\frac{(2m+r-1)(2m+r)}{2(2m+r-1)^2}a_{2m-2}(r)\\
...
\begin{aligned}
a_0(r_2)&=1,\\
a_n(r_2)&=-\dst\frac{p_1(n+r_2-1)}{p_0(n+r_2)}a_{n-1}(r_2),\quad
1\le n\le k-1,
\end{aligned}
\end{equation}
and
...
a_0(r)&=1,\\
a_n(r)&=-\dst\frac{p_1(n+r-1)}{p_0(n+r)}a_{n-1}(r)\\
&=-\dst\frac{(n+r)(2n+2r+1)}{(2n+2r+1)(2n+2r-5)}a_{n-1}(r),\\
...
\begin{align*}
a_0(-6)&=1,\\
a_n(-6)&=\dst\frac{(n-4)(2n-13)}{n(n-5)}a_{n-1}(-6),\,n=1,2,3,4.
\end{align*}
The last formula yields
\[
...
\begin{align*}
a_0(r_2)&=1,\\
a_{2m}(r_2)&=-\dst\frac{p_2(2m+r_2-2)}{p_0(2m+r_2)}a_{2m-2}(r_2),\quad
1\le m\le k-1
\end{align*}
and
...
a_0(r)&=1,\\
a_{2m}(r)&=-\dst\frac{p_2(2m+r-2)}{p_0(2m+r)}a_{2m-2}(r)\\
&=-\dst\frac{(2m+r)(2m+r+5)}{(2m+r-3)(2m+r+5)}a_{2m-2}(r)\\
...
a_0(r)&=1,\\
a_{2m}(r)&=-\dst\frac{p_2(2m+r-2)}{p_0(2m+r)}a_{2m-2}(r)\\
&=\dst\frac{(2m+r)(4m+2r+3)}{(2m+r)(2m+r+6)}a_{2m-2}(r)\\
