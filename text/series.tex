...
called a
\indexterm{power series}\index{series!power} in $x-x_0$. We say that the power series
\eqref{eq:7.1.1} \emph{\color{blue}converges}\index{convergent power series} for a given $x$ if the limit
\[
\lim_{N\to\infty}
...
\emph{\color{blue}radius of convergence of power series}\index{convergence!of power series!radius of}\index{power series!radius of convergence}
...
series is the Taylor series\index{Taylor series}\index{series!Taylor} of $f$ about $x_0$.
...
\boxit{Taylor Polynomials}\index{Taylor polynomial}\index{polynomial!Taylor}
...
factors. Then we say that $x_0$ is an \indexterm{ordinary point}\index{Bessel's equation!ordinary point of} of
\eqref{eq:7.2.1} if $P_0(x_0)\ne0$, or a \indexterm{singular point}\index{Bessel's equation!singular point of} if
...
ordinary points. For Bessel's equation\index{Bessel's equation},
\[
x^2y''+xy'+(x^2-\nu^2)y=0,
\]
...
P_0(x)y''+P_1(x)y'+P_2(x)y=0
\]
is said to be \emph{\color{blue}oscillatory}\index{oscillatory solution} on an
interval $(a,b)$ if it has infinitely many zeros on $(a,b)$.
Otherwise $y$ is said to be
\emph{\color{blue}nonoscillatory}\index{nonoscillatory solution} on $(a,b)$.
