...
\item\label{exer:7.1.1}For each power series use Theorem~\ref{thmtype:7.1.3} to find the radius
...
\item\label{exer:7.1.3}For each power series, use the result of Exercise~\ref{exer:7.1.2} to find
...
\item\label{exer:7.1.5}For each power series use the result of Exercise~\ref{exer:7.1.4} to find
the radius of convergence $R$. If $R>0$, find the open interval of
convergence.
...
\item\label{exer:7.2.28}Use Theorem~\ref{thmtype:7.2.2} to show that the power series in
...
\item\label{exer:7.2.29}Use Exercise~\ref{exer:7.2.28}  to
...
\item\label{exer:7.3.31}Use the results of Exercise~\ref{exer:7.3.30} to find the general solution
...
\item\label{exer:7.4.22}In Example~\ref{example:7.4.2} we saw  that $x_0=1$ and $x_0=-1$
...
\noindent
\emph{In Exercises~\ref{exer:7.5.1}--\ref{exer:7.5.10} find a fundamental
set
...
\item\label{exer:7.6.53}Under the assumptions of Theorem~\ref{thmtype:7.6.2}, suppose
the power series
\[
...
\item\label{exer:7.6.57}Suppose the assumptions of Exercise~7.5.~\hspace*{-3pt}\ref{exer:7.5.53}
hold, except that
\[
p_0(r)=\alpha_0(r-r_1)^2.
\]
...
\begin{proof}
Theorem~\ref{thmtype:7.5.3} implies that $Ly_1=0$.
...
\item\label{exer:7.7.44}Under the assumptions of Theorem~\ref{thmtype:7.7.1}, show that $C=0$
 if and only if $p_1(r_2+\ell)=0$ for some
integer $\ell$ in $\{0,1,\dots,k-1\}$.


\item\label{exer:7.7.45}Under the assumptions of Theorem~\ref{thmtype:7.7.2}, show that $C=0$
...
\item\label{exer:7.7.48}Let $L$ be as in Exercises~7.5.~\hspace*{-3pt}\ref{exer:7.5.57} and
