...
\answer{2.2.19} $\dst{y=\frac{-1+\sqrt{4x^2-15}}{2};   \quad\left({\sqrt{15}\over2}, \infty\right)}$
...
\answer{7.6.44}
$\dst{y_1={1\over x}}$;\;   $\dst{y_2=y_1\ln x-6+6x-\frac{8}{3}x^2}$
...
x+x^3\left(4-7x+\frac{11}{3}x^2-6\sum_{n=3}^\infty{1\over
...
\answer{7.7.5}
$\dst{y_1=x^{1/2}\sum_{n=0}^\infty\left(-\frac{3}{4}\right)^n{\prod_{j=1}^n(2j+1)
\over n!}x^n}$;\;

\quad\;  \;
$\dst{y_2=x^{-1/2}-\frac{3}{4}\left(y_1\ln
x-x^{1/2}\sum_{n=1}^\infty\left(-\frac{3}{4}\right)^n{\prod_{j=1}^n(2j+1)\over
...
+\frac{1}{576}x^4\right)-\frac{1}{2880}\left(y_1\ln x-{120\over x^2}
...
-\frac{1}{120}\left(y_1\ln x+x^3\sum_{n=1}^\infty{(-1)^n6!\over n(n+6)!}
x^n\right)}$
...
j+5}\right)x^n}$;\;   \, $y_2=\dst{x^{-2}\left(1+\frac{1}{4}x\right)}$
...
y_1\ln x+\frac{7}{12}x^4-x^2\sum_{m=2}^\infty{\left(3\over2\right)^m
...
-\frac{3}{5}\cos 3t-{2\over 15}\sin 3t}$\;
\part{b} $\dst{-{4\over 15}\cos t+{1\over 15}\sin t
+{4\over 15}\cos 4t-\frac{1}{60}\sin 4t}$\;

\quad\;
\part{c} $\dst{\frac{5}{3}\cos t+\sin t-\frac{5}{3}
\cos 2t-\frac{1}{2}\sin 2t}$\;
\part{d} $\dst{-\frac{1}{3}\cos{t\over2}+\frac{2}{3}
\sin{t\over2}+\frac{1}{3}\cos t-\frac{1}{3}\sin t}$\;

\quad\;
\part{e}
$\dst{{1\over 15}\cos{t\over4}-{8\over 15}\sin{t\over4} -{1\over
15}\cos 4t+\frac{1}{30}\sin4t}$\;
\part{f}
$\dst{\frac{2}{5}\cos{t\over3}-\frac{3}{5}\sin{t\over3}
-\frac{2}{5}\cos{t\over2}+\frac{2}{5}\sin{t\over2}}$
...
\quad\;
 \part{c} $\dst{e^{-2t}\left(\frac{1}{8}\cos t+{1\over
4}\sin t\right)-e^{2t}\left(\frac{1}{8}\cos 3t-{1\over 12}\sin
3t\right)}$\;
...
2t}$\;
\part{f} $\dst{\frac{1}{9}e^{2t}-\frac{1}{9}e^{-t}\cos 3t+{5\over
9}e^{-t}\sin 3t}$

\answer{8.2.8}\;
 \part{a} $\dst{-{3\over 10}\sin t+\frac{2}{5}\cos t-
\frac{3}{4}e^t+\frac{7}{20}e^{3t}}$\;
\part{b} $\dst{-\frac{3}{5}e^{-t}\sin t+\frac{1}{5}
e^{-t}\cos t-\frac{1}{2}e^{-t}+{3\over 10}e^{t}}$\;

\quad\;
\part{c} $\dst{-{1\over 10}e^t\sin t-{7\over 10}e^t
\cos t+\frac{1}{5} e^{-t}+\frac{1}{2}e^{2t}}$\;
\part{d} $\dst{-\frac{1}{2}e^t+{7\over 10}e^{-t}-{1\over
5}\cos 2t+\frac{3}{5}\sin 2t}$
