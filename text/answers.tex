...
\frac{1}{8} u\left( t-{3\pi\over2}\right)\left(\sin t-\cos t+ \sin
3t-\frac{1}{3}\cos 3t\right)}$

\answer{8.5.9}
  $y=\dst{ {t\over4}-\frac{1}{8}\sin2t
+\frac{1}{8}u\left(t-{\pi\over2}\right)
...
\answer{8.5.19}
$y=\dst{{t^4\over12}+1-\frac{1}{12}u(t-1)(t^4+2t^3-10t+7)+
...
\answer{9.1.5}
\part{b}
$\dst{ y_1=-\frac{1}{2}x^3+x^2+{1\over2x},
\quad y_2=\frac{1}{3}x^2-{1\over3x},\quad y_3=\frac{1}{4} x^3-\frac{1}{3}x^2+{1\over12x}}$
