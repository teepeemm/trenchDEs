...
%  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120101}
...
Therefore
$$
u(x,t)=\dst\frac{12L^3}{\pi^3}\sum_{n=1}^\infty\frac{1}{n^3}
...
$$
\alpha_n=\frac{2}{L}\int_0^Lf(x)\sin{(2n-1)\pi x\over2L}\,dx.
$$
\end{definition}
...
$f$ on $[0,L]$ is
$$
S_M(x)=-\frac{8L}{\pi^2}\sum_{n=1}^\infty{(-1)^n\over(2n-1)^2}
\sin{(2n-1)\pi x\over2L}.
$$
Therefore
$$
u(x,t)=-\frac{8L}{\pi^2}\sum_{n=1}^\infty{(-1)^n\over(2n-1)^2}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120102}
  \caption{}
  \label{figure:12.1.2}
\end{figure}
...
$$
\alpha_n=\frac{2}{L}\int_0^Lf(x)\cos{(2n-1)\pi x\over2L}\,dx.
$$
\end{definition}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120201}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120202}
...
$$
T_n=\alpha_n\cos\frac{n\pi at}{L}+\frac{\beta_nL}{n\pi a}\sin{n\pi
at\over L},
$$
...
=\frac{1}{2}\left[\sin{n\pi(x+at)\over
L}+\sin{n\pi(x-at)\over L}\right]
\end{equation}
and
\begin{equation} \label{eq:12.2.11}
\begin{array}{rcl}
\dst \sin\frac{n\pi at}{L}\sin\frac{n\pi x}{L}
&=&-\dst\frac{1}{2}\left[\cos{n\pi(x+at)\over
...
\begin{array}{rcl}
\dst\sum_{n=1}^\infty\alpha_n \cos\frac{n\pi at}{L}\sin\frac{n\pi x}{L}&=&
\dst\frac{1}{2}\sum_{n=1}^\infty\alpha_n\left(\sin{n\pi(x+at)\over
L}
+\sin{n\pi(x-at)\over L}\right)\\
&=&\dst\frac{1}{2}[S_f(x+at)+S_f(x-at)].
\end{array}
\end{equation}
...
$$
\begin{array}{rcl}
\dst\sum_{n=1}^\infty\frac{\beta_nL}{n\pi a}
...
&=&
\dst\frac{1}{2a}\int_{x-at}^{x+at}S_g(\tau)\,d\tau.
\end{array}
$$
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.55}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120203}}
...
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.55}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120204}}
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.55}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120205}}
...
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.55}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120206}}
...
$$
S_f(x)=\frac{96L^4}{\pi^5}\sum_{n=1}^\infty\frac{1}{(2n-1)^5}\sin{(2n-1)\pi
x\over L}.
$$
From Exercise~11.3.~\hspace*{-3pt}\ref{exer:11.3.36},
$$
S_g(x)=\frac{8L^2}{\pi^3}\sum_{n=1}^\infty\frac{1}{(2n-1)^3}\sin{(2n-1)\pi
x\over L}.
$$
...
\begin{array}{rcl}
u(x,t)&=&
\dst\frac{96L^4}{\pi^5}\sum_{n=1}^\infty\frac{1}{(2n-1)^5}
\cos{(2n-1)\pi a t\over L}\sin{(2n-1)\pi x\over L}\\&&+
\dst\frac{8L^3}{a\pi^4}\sum_{n=1}^\infty\frac{1}{(2n-1)^4}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120207}
...
$f$ on $[0,L]$ is
$$
S_f(x)=\dst\frac{4L}{\pi^2}\sum_{n=1}^\infty{(-1)^{n+1}\over(2n-1)^2}
...
u(x,t)=\dst\frac{4L}{\pi^2}\sum_{n=1}^\infty{(-1)^{n+1}\over(2n-1)^2}
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120208}}
...
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120209}}
...
S_f(x-at)=
\left\{\begin{array}{cl}
x-at,&0\le x\le \frac{L}{2}+at,\\[2\jot]
...
u(x,t)=
\left\{\begin{array}{cl}
x,&0\le x\le\frac{L}{2}-at,\\[2\jot]
\frac{L}{2}-at,&\frac{L}{2}-at\le x\le\frac{L}{2}+at,\\[2\jot]
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120210}}
...
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120211}}
...
u(x,\tau)=
\left\{\begin{array}{cl}
x,&0\le x\le\frac{L}{2}-a\tau,\\[2\jot]
\frac{L}{2}-a\tau,&\frac{L}{2}-a\tau\le x\le\frac{L}{2}+a\tau,\\[2\jot]
...
$m$ such that either
$$
\mbox{\bf(i)}\quad t=\frac{mL}{a}+\tau\mbox{\quad or \quad}
...
t\over2L}+\frac{2L\beta_n}{(2n-1)\pi a}\sin{(2n-1)\pi
at\over2L}\right)
\cos{(2n-1)\pi
x\over2L},
$$
...
\alpha_n=\frac{2}{L}\int_0^Lf(x)\cos{(2n-1)\pi x\over2L}\,dx
\mbox{\quad and \quad}
\beta_n=\frac{2}{L}\int_0^Lg(x)\cos{(2n-1)\pi x\over2L}\,dx.
$$
...
\item\label{exer:12.2.33}Use the result of Exercise~\ref{exer:12.2.32} to show that the formal
...
\alpha_n=\frac{2}{L}\int_0^Lf(x)\sin{(2n-1)\pi x\over2L}\,dx
\mbox{\quad and \quad}
\beta_n=\frac{2}{L}\int_0^Lg(x)\sin{(2n-1)\pi x\over2L}\,dx.
$$
...
\item\label{exer:12.2.48}Use the result of Exercise~\ref{exer:12.2.47} to show that the formal
solution of the initial-boundary value problem in
...
\item\label{exer:12.2.61}Use the result of Exercise~\ref{exer:12.2.60} to show that the formal
solution of the initial-boundary value problem in
...
shown in Figure~\ref{figure:12.3.1}.
   ...
   \begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120301}
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.5}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120302}}
...
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.5}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120303}}
...
$(x,y)$ if and only if $$ \frac{X''}{X}=-\frac{Y''}{Y}=k $$ for all
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120304}
...
$$
S(x)=\frac{12a^3}{\pi^3}\sum_{n=1}^\infty\frac{1}{n^3}\sin{n\pi
x\over a}.
$$
Therefore
\begin{equation} \label{eq:12.3.10}
u(x,y)=\frac{12a^3}{\pi^3}\sum_{n=1}^\infty{\sinh n\pi(b-y)/a\over
n^3\sinh n\pi b/a}
\sin\frac{n\pi x}{a}.
\end{equation}
...
the form
$$
u_m(x,y)=\frac{12a^3}{\pi^3}\sum_{n=1}^m{\sinh n\pi(b-y)/a\over
n^3\sinh n\pi b/a}
\sin\frac{n\pi x}{a}.
$$
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120305}}
  \caption{}
  \label{figure:12.3.5}
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120306}}
  \caption{}
  \label{figure:12.3.6}
\end{minipage}
\end{figure}
...
\begin{figure}[H]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120307}
...
$$
v_n(x,y)=X_n(x)Y_n(y)=
{a\sinh n\pi y/a\over n\pi\cosh n\pi b/a}\cos\frac{n\pi x}{a},
$$
so
$$
...
$$
C(x)=\dst\frac{a}{2}-\frac{4a}{\pi^2}\sum_{n=1}^\infty\frac{1}{(2n-1)^2}
\cos{(2n-1)\pi x\over a}.
$$
Therefore
\begin{equation} \label{eq:12.3.15}
u(x,y)=\dst\frac{ay}{2}-\frac{4a^2}{\pi^3}\sum_{n=1}^\infty
...
\color{blue}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120308}}
  \caption{}
  \label{figure:12.3.8}
\end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
   \scalebox{.65}{
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120309}}
  \caption{}
  \label{figure:12.3.9}
\end{minipage}
\end{figure}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120310}
...
that is,
$$
\alpha_n=\frac{2}{b}\int_0^bg(y)\sin{(2n-1)\pi y\over2b}\,dy.
$$
...
$$
S_M(y)
=\dst\frac{96b^3}{\pi^3}\sum_{n=1}^\infty
\frac{1}{(2n-1)^3}\left[3+(-1)^n\frac{4}{(2n-1)\pi}\right]\sin{(2n-1)\pi
y\over2b}.
$$
Therefore
$$
...
\left[3+(-1)^n\frac{4}{(2n-1)\pi}\right]\sin{(2n-1)\pi
y\over2b}.
$$
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120311}
...
so
$$
\frac{\partial v_n}{\partial x}(a,y)=\cos{(2n-1)\pi y\over2b}.
$$
Therefore
...
that is,
$$
\alpha_n=\frac{2}{b}\int_0^bg(y)\cos{(2n-1)\pi y\over2b}\,dy.
$$
...
Therefore
$$
u(x,y)=-\frac{16b^2}{\pi^3}\sum_{n=1}^\infty{
...
\end{equation}
   ...
   \begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120312}
...
\begin{figure}[H]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120401}
...
\end{example}
 ...
 \begin{figure}[H]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120402}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig120403}
