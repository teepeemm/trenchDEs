...
{\color{blue}\itshape d'Alembert's solution} of \eqref{eq:12.2.1}. Although
...
\noindent
{\itshape In \zcref[range]{exer:12.2.1,exer:12.2.15} solve the
...
{\color{blue}\itshape Laplace's equation}.  This equation also arises
...
{\color{blue}\itshape Dirichlet condition},
 and the problem is called a
\href{http://www-history.mcs.st-and.ac.uk/Mathematicians/Dirichlet.html}
{\color{blue}\itshape Dirichlet problem}.
 Or, we may
 require the normal
...
{\color{blue}\itshape Neumann condition},
and the problem is called a
\href{http://www-history.mcs.st-and.ac.uk/Mathematicians/Neumann_Carl.html}
 {\color{blue}\itshape Neumann problem}.
