...
\solution From  \zcref{example:11.3.6}, the Fourier
sine series of
$f$ on $[0,L]$ is
\[
...
e^{-n^2\pi^2a^2t/L^2}\sin\frac{n\pi x}{L}.
\bbox
\]
...
\solution From  \zcref{example:11.3.1}, the Fourier
cosine series of
$f$ on $[0,L]$ is
\[
...
\solution From  \zcref{example:11.3.4}, the mixed
...
\solution From  \zcref{example:11.3.3}, the mixed
...
\solution  From \zcref{example:11.3.6},
\[
...
\solution From \zcref{example:11.3.1},
\[
...
\solution  From \zcref{example:11.3.8},
\[
S_M(y)
...
\solution  From \zcref{example:11.3.3},
\[
...
\solution Proceeding as in the solution of \zcref{example:12.3.1},
...
\solution From  \zcref{example:11.2.6},
\[
