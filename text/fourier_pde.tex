...
\caption{The odd extension of a function that satisfies \eqref{eq:12.2.13}}
  \label{figure:12.2.4}
\tagstructend
\end{minipage}
\end{figure}
...
\caption{The even extension of a function that satisfies \eqref{eq:12.2.14}}
  \label{figure:12.2.6}
\tagstructend
\end{minipage}
\end{figure}
...
\caption{The odd periodic extension of \eqref{eq:12.2.21}}
  \label{figure:12.2.8}
\tagstructend
\end{minipage}\hfill
  \begin{minipage}[t]{0.48\linewidth}
...
\caption{The part of the graph from \zcref{figure:12.2.9} on $[0,L]$}
