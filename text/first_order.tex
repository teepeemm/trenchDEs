...
differential equation in this form is called \indexterm{separation of
variables}\index{variables, separation of}. In \zcref{sec:linar_first_order} we used separation of variables
...
\index{separable equation!transformation of nonlinear equation into}
...
\zcref{sec:linar_first_order}, where we said that a linear equation of the form
\[
y'+p(x)y=0
\]
...
\personHref{Riccati}{generalized Riccati equation}\index{generalized Riccati equation}\index{Riccati equation!generalized}\index{Ricatti, Jacopo Francesco} is of the form
\[
...
\index{exact first order equation}
...
\eqref{eq:2.5.8}) is the  \indexterm{exact differential} of $F$.
...
\index{exact first order equation!procedures for solving}
