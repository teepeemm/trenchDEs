...
\item\label{exer:2.1.44}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\emph{\color{blue}separable} if it can be written as
...
\item\label{exer:2.3.15}\begin{alist}[above=-\baselineskip]
\item %(a)
...
\item\label{exer:2.3.20}\begin{alist}[above=-\baselineskip]
\item %(a)
...
A \personHref{Bernoulli_Jacob}{Bernoulli equation} is an equation  of
the form
...
\personHref{Riccati}{Riccati equation} is of the form
\[
...
\item\label{exer:2.6.1}\begin{alist}[above=-\baselineskip]
\item % (a)
...
\item\label{exer:2.6.2}\begin{alist}[above=-\baselineskip]
\item % (a)
