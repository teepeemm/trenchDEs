...
\begin{figure}
  ...
  width=5.4in,height=3.66in,keepaspectratio]{fig020101}
\color{blue}
...
\end{alistSolution}
  ...
  width=5.4in,height=3.66in,keepaspectratio]{fig020102}
\color{blue}
...
\begin{figure}
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020103}
\color{blue}
...
\begin{figure}
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020201}
\color{blue}
...
\begin{figure}
  ...
  width=5.4in,height=3.66in,keepaspectratio]{fig020202}
\color{blue}
...
\begin{figure}
  ...
  width=5.4in,height=3.66in,keepaspectratio]{fig020203}
\color{blue}
...
\begin{figure}
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020204}
\color{blue}
\caption{
...
\begin{figure}
  ...
  trim=0 50 0 60,clip,width=5.67in,height=3.66in,keepaspectratio]{fig020301}
\color{blue}
...
Since
\[
f(x,y)  = \frac{x^2-y^2 }{1+x^2+y^2}\mbox{\quad and \quad}
...
Here
\[
f(x,y)  =  \frac{x^2-y^2 }{x^2+y^2}\mbox{\quad and \quad}
...
%  width=5.67in,height=3.66in,keepaspectratio]{fig020302}
...
\begin{figure}
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020401}
\color{blue}
...
\begin{figure}
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020501}
\color{blue}
\caption{A direction field and  integral curves for
$(4x^3y^3+3x^2)\,dx+(3x^4y^2+6y^2)\,dy=0$}
  \label{figure:2.5.1}
...
Now let
\[
p(x)=\frac{P'(x)}{P(x)} \mbox{\quad and \quad} q(y)=\frac{Q'(y)}{Q(y)},
\]
...
\begin{figure}
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020602}
\color{blue}
\caption{A direction field and integral curves for
$2xy^3e^y\,dx+(3x^2y^2+x^2y^3+1)e^y\,dy=0$}
  \label{figure:2.6.2}
...
\]
 Therefore
 \[ \frac{M_y-N_x}{M}=\frac{-x+3y}{3xy+6y^2} \mbox{\quad and \quad} \frac{N_x-M_y}{N}=\frac{x-3y}{2x^2+9xy},
 \]
...
\begin{figure}
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020603}
\color{blue}
\caption{A direction field and integral curves for
$(3xy+6y^2)\,dx+(2x^2+9xy)\,dy=0$}
  \label{figure:2.6.3}
...
\begin{figure}
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020604}
\color{blue}
