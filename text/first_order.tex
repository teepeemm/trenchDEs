...
\index{linear first order equations}
...
is called \indexterm{separation of variables}. We did this in
...
\index{linear nonhomogeneous first order equation}
\index{nonhomogeneous linear first order equation}
...
\index{integral form!solutions of differential equations in}
\index{solutions of differential equations in integral form}
...
\emph{\color{blue}implicit solution of the initial value problem}
