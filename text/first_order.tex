...
\medskip\noindent
\zcref[S,CAP,font=\scshape]{sec:linear_first_order} deals with linear
equations, the simplest kind
...
by a function known called \indexterm{integrating factor}.

\newpage


\section{Linear First Order Equations}\label{sec:linear_first_order}
\index{linear equation!first order}
\index{first order equation!linear}

A first order differential equation is said to be \emph{\color{blue}linear}\index{linear!differential equation}\index{differential equation!linear} if it
can be written as
\begin{equation}\label{eq:2.1.1}
y'+p(x)y=f(x).
\end{equation}
A first order differential equation that can't be written like this is
\emph{\color{blue}nonlinear}\index{nonlinear!differential equation}\index{differential equation!nonlinear}\index{first order equation!nonlinear}.
We say that \eqref{eq:2.1.1} is 
\emph{\color{blue}homogeneous}\index{homogeneous!differential equation}\index{differential equation!homogeneous}\index{first order equation!linear!homogeneous}\index{linear equation!first order!homogeneous}
if $f\equiv0$;     otherwise it's
\emph{\color{blue}nonhomogeneous}\index{nonhomogeneous!differential equation}\index{differential equation!nonhomogeneous}\index{first order equation!linear!nonhomogeneous}\index{linear equation!first order!nonhomogeneous}\index{nonhomogeneous!linear!first order}.
Since $y\equiv0$ is obviously a solution of the homogeneous equation
\[
y'+p(x)y=0,
\]
we call it the \indexterm{trivial solution}\index{trivial solution!of homogeneous linear first order equation}. Any  other solution
is \emph{\color{blue}nontrivial}\index{nontrivial solution}\index{nontrivial solution!of homogeneous linear first order equation}.
...
\index{linear first order equation!general solution}
\index{first order equation!linear!general solution}
\index{general solution!first order linear equation}
...
We call $c$ a
\emph{\color{blue}parameter}\index{parameter!one-parameter family} and say that \eqref{eq:2.1.3} defines a
\indexterm{one-parameter family of functions}.
...
is the \indexterm{general solution} of~\eqref{eq:2.1.2}.
...
\end{itemize}
We'll call $y=y(x,c)$ the \indexterm{general solution} of
\eqref{eq:2.1.4}.
...
\index{linear!first order equation!homogeneous}
\index{homogeneous!linear first order equation}
\index{homogeneous!linear first order equation!general solution}
\index{general solution!homogeneous linear first order equation}
...
\index{linear first order equation!homogeneous!general solution}
...
\[
c=\begin{cases}
\phantom{-}e^k&\text{if $y>0$ on $(a,b)$},\\
-e^k&\text{if $y<0$ on $(a,b)$}.
\end{cases}\qedhere
\]
\end{proof}

\begin{remark*}
Rewriting a first order differential equation so that one
side depends only on $y$ and $y'$ and the other depends only on $x$
is called
\indexterm{separation of variables}\index{homogeneous linear first order equation!separation of variables}\index{linear first order equation!homogeneous!separation of variables}\index{variables, separation of}.
We did this in
...
\index{linear equation!first order!nonhomogeneous}
\index{linear first order equation!nonhomogeneous!general solution}
\index{linear first order equation!nonhomogeneous!variation of parameters}
\index{nonhomogeneous equation!linear!first order}
\index{nonhomogeneous equation!linear first order!general solution}
\index{nonhomogeneous equation!linear first order!variation of parameters}
\index{first order equation!linear nonhomogeneous}
...
y'+p(x)y=0
\]
the \indexterm{complementary equation}.
...
equation is a special case of a method called \indexterm{variation of
parameters}\index{variation of parameters!linear first order equation}, which you'll encounter several times in this book.
...
We need a nontrivial solution $y_1$ of
...
\[
1=\frac{\pi^2}{8}+c\quad\text{or}\quad c=1-\frac{\pi^2}{8}.
\]
 Thus,
\[
...
\begin{figure}
\centering
\includegraphics[alt={An increasing curve beginning near negative infinity as x approaches 0, crossing the x axis near (0.7,0), and finishing near positive infinity as x approaches π.},
...
\begin{remark*}
It wasn't necessary to do the computations
...
We summarize the method  of variation of parameters for solving\index{linear first order equation!nonhomogeneous!variation of parameters}
...
\index{integral form!solutions of differential equations}
\index{solutions of differential equations!integral form}
\index{linear first order equation!nonhomogeneous!solution in integral form}
\index{nonhomogeneous equation!linear first order!solution in integral form}
...
\[
y=e^{x^2}\left(c+\int^x_0 e^{-t^2} dt\right),\quad\text{since}\quad
\int_0^0e^{-t^2}\,dt=0.
\]
...
\zcref{ch:numerical} directly to the initial value problem
\eqref{eq:2.1.28}.
...
\index{existence theorem}\index{uniqueness theorem}
...
\begin{alist}
\item % (a)
The general solution of the nonhomogeneous equation\index{nonhomogeneous equation!linear first order!general solution}
...
\end{exerciselist}
%
\textsl{In \zcref[range]{exer:2.1.12,exer:2.1.15} find
...
\item\label{exer:2.1.13}\CGex $y'+\left(\dfrac{1}{x}-1\right)y=-\dfrac{2}{x}$
\item\label{exer:2.1.14}\CGex $y'+2xy=xe^{-x^2}$
\item\label{exer:2.1.15}\CGex $y'+\dfrac{2x}{1+x^2}y=\dfrac{e^{-x}}{1+x^2}$
\end{exerciselistTwoColumn}
%
\textsl{In \zcref[range]{exer:2.1.16,exer:2.1.24} find
the general solution.}

\begin{exerciselistTwoColumn}
\item\label{exer:2.1.16}$y'+\dfrac{1}{x}y=\dfrac{7}{x^2}+3$
\item\label{exer:2.1.17}$y'+\dfrac{4}{x-1}y
= \dfrac{1}{(x-1)^5}+\dfrac{\sin x}{(x-1)^4}$
\item\label{exer:2.1.18}$xy'+(1+2x^2)y=x^3e^{-x^2}$
\item\label{exer:2.1.19}$xy'+2y=\dfrac{2}{x^2}+1$
\item\label{exer:2.1.20}$y'+(\tan x)y=\cos x$
\item\label{exer:2.1.21}$(1+x)y'+2y=\dfrac{\sin x}{ 1 + x}$
\item\label{exer:2.1.22}$(x-2)(x-1)y'-(4x-3)y=(x-2)^3$
\item\label{exer:2.1.23}$y'+(2\sin x\cos x) y=e^{-\sin^2x}$
\item\label{exer:2.1.24}$x^2y'+3xy=e^x$
\end{exerciselistTwoColumn}
%
\textsl{In \zcref[range]{exer:2.1.25,exer:2.1.29} solve the
...
methods discussed in \zcref{ch:numerical}.)}
...
\item\label{exer:2.1.44}\begin{alist}
\item % (a)
...
\]
(This is the \indexterm{principle of superposition}\index{superposition!principle of}.)
...
\begin{align*}
f_0&=f,\\
f_j&=f_{j-1}'+pf_{j-1},\quad 1\le j\le m.
\end{align*}
Show that
\[
...
\index{first order equation!separable}
\index{separable equation!first order}

A first order differential equation  is
\emph{\color{blue}separable}\index{separable equation} if it can be written as
...
\indexterm{separation of variables}\index{variables, separation of}.
In \zcref{sec:linear_first_order} we used separation of variables
...
Therefore
\[
y=\tan\left(\frac{x^2}{2}+c\right).\qedhere
\]
\end{solution}
...
Integrating yields
\[
\frac{y^2}{2}=-\frac{x^2}{2}+c,\quad\text{or, equivalently,}\quad x^2+y^2=2c.
\]
...
is
\[
y=- \sqrt{5-x^2}, \quad -\sqrt{5} < x < \sqrt{5}.\qedhere
\]
\end{alistSolution}
...
\index{implicit solution}\index{separable equation}
\index{implicit solution!separable equation}
\index{initial value problem!implicit solution}
\index{separable equation!implicit solution}
\index{first order equation!separable!implicit solution}
...
advanced calculus called as the \indexterm{implicit function theorem}.
...
\indexterm{implicit solution} of $h(y)y'=g(x)$. Curves defined by
\eqref{eq:2.2.11} are integral curves of $h(y)y'=g(x)$. If $c$ satisfies
\eqref{eq:2.2.10}, we'll say that \eqref{eq:2.2.11} is an
\emph{\color{blue}implicit solution of the initial value problem}\index{implicit solution!of initial value problem}
\eqref{eq:2.2.12}. However, keep
...
\index{separable equation}\index{constant solution}
\index{separable equation!constant solution}
\index{first order equation!separable!constant solution}
...
\index{nonlinear equation!first order}
\index{first order equation!nonlinear}
...
\begin{exerciselistTwoColumn}
\item\label{exer:2.2.1}$y'=\dfrac{3x^2+2x+1}{y-2}$
\item\label{exer:2.2.2}$(\sin x)(\sin y)+(\cos y)y'=0$
\item\label{exer:2.2.3}$xy'+y^2+y=0$
\item\label{exer:2.2.4}$y' \ln |y|+x^2y= 0$
\item(2)\label{exer:2.2.5}$(3y^3+3y \cos y+1)y'+\dfrac{(2x+1)y}{1+x^2}=0$
\item(2)\label{exer:2.2.6}$x^2yy'=(y^2-1)^{3/2}$
\end{exerciselistTwoColumn}
%
\textsl{In \zcref[range]{exer:2.2.7,exer:2.2.10} find all
...
\item\label{exer:2.2.19}$y'=\dfrac{2x}{1+2y},\quad y(2)=0$
\item\label{exer:2.2.20}$y'=2y-y^2,\quad y(0)=1$
...
three cases,  $q_0=a^2/4b$ is called a \indexterm{bifurcation value}
...
\end{exerciselist}
%
\textsl{Solve the equations in
\zcref[range]{exer:2.2.35,exer:2.2.38} using variation of
parameters followed by separation of variables.}

\begin{exerciselistTwoColumn}
\item\label{exer:2.2.35}$y'+y=\dfrac{2xe^{-x}}{1+ye^x}$
\item\label{exer:2.2.36}$xy'-2y=\dfrac{x^6}{y+x^2}$
\item\label{exer:2.2.37}$y'-y=\dfrac{(x+1)e^{4x}}{(y+e^x)^2}$
\item\label{exer:2.2.38}$y'-2y=\dfrac{xe^{2x}}{1-ye^{-2x}}$
\end{exerciselistTwoColumn}
...
\index{existence and uniqueness of solutions of nonlinear first order equations}
\index{solutions of nonlinear first order equations!existence and uniqueness}
...
Some terminology:
 an \emph{\color{blue}open rectangle $R$}\index{open rectangle}
...
nonlinear differential equations\index{first order equation!nonlinear}.
We omit the proof, which is beyond the scope of this book.

\begin{theorem}\label{thmtype:2.3.1}
\index{existence theorem}\index{uniqueness theorem}
\index{first order equation!existence and uniqueness of solutions}
\index{nonlinear equation!first order}
\index{nonlinear equation!first order!existence and uniqueness of solutions}
\index{uniqueness of solutions of nonlinear first order equation}
\begin{alist}
\item %(a)
 If  $f$ is continuous
on an open rectangle\index{open rectangle}\index{rectangle, open}
\[
R:  \{ a < x < b, c < y < d \}
\]
...
\end{equation}
 has at least one solution  on some open subinterval\index{open subinterval}\index{subinterval, open}
...
\begin{itemize}
\item (a) is an \indexterm{existence theorem}. It guarantees that a
...
\item (b) is a \indexterm{uniqueness theorem}. It guarantees that
...
\includegraphics[alt={A curve beginning near (-2,6), decreasing to horizontally cross the x axis at x=1, bottoming out at (0,-1), and finishing in a mirror image near (2,6).  A second curve goes from (-2,0) to (-1,0) and from (1,0) to (2,0).},
...
\hfill
\begin{minipage}[t]{0.48\linewidth}
\tagstructbegin{tag=Sect}\includegraphics[alt={A curve beginning near (-2,6), decreasing to bottom out at (0,1), and finishing in a mirror image near (2,6).},
...
\begin{exerciselistTwoColumn}
\item\label{exer:2.3.1}$y'=\dfrac{x^2+y^2}{\sin x}$
\item\label{exer:2.3.2}$y'=\dfrac{e^x+y }{x^2+y^2}$
\item\label{exer:2.3.3}$y'= \tan xy$
\item\label{exer:2.3.4}$y'=\dfrac{x^2+y^2}{\ln xy}$
\item\label{exer:2.3.5}$y'=(x^2+y^2)y^{1/3}$
\item\label{exer:2.3.6}\ $y'=2xy$
\item\label{exer:2.3.7}$y'=\ln(1+x^2+y^2)$
\item\label{exer:2.3.8}$y'=\dfrac{2x+3y}{x-4y}$
\item\label{exer:2.3.9}$y'=(x^2+y^2)^{1/2}$
\item\label{exer:2.3.10}$y'=x(y^2-1)^{2/3}$
...
from it to those that follow from \zcref{thmtype:2.1.2}.

\item\label{exer:2.3.15}\begin{alist}
\item %(a)
...
\item\label{exer:2.3.20}\begin{alist}
\item %(a)
...
\section[running={Transformation of Nonlinear Equations}]{Transformation of Nonlinear Equations into Separable Equations}
\label{sec:transform_separable}
\index{transformation of nonlinear equation!into separable equation}
\index{nonlinear equation!transformation into separable equation}
\index{separable equation!transformation from nonlinear equation}
\index{first order equation!transformation into separable equation}
\index{first order equation!separable}

In \zcref{sec:linear_first_order} we found that the solutions of a linear
...
equation. We'll say in this case  that we \emph{\color{blue}transformed}
the given equation into a separable equation.


\boxit{Bernoulli Equations}

A \personHref{Bernoulli_Jacob}{Bernoulli equation}\index{Bernoulli's equation|(} is an equation  of
the form
...
transform \eqref{eq:2.4.2} into a separable
equation\index{separable equation!transformation from Bernoulli's equation}\index{transformation to separable equation!Bernoulli's equation}
...
\[
u'y_1(x)=f(x)\left(y_1(x)\right)^ru^r\quad\text{or}\quad
...
\[
u'e^x=xu^2e^{2x}\quad\text{or, equivalently,}\quad
u'=xu^2e^x.
\]
...
\end{solution}\index{Bernoulli's equation|)}
...
Separable Equations}
\index{separable first order equation!transformation of nonlinear equation!into other equation}
...
\index{homogeneous!nonlinear equation}
\index{homogeneous!nonlinear equation!defined}
\index{homogeneous!nonlinear equation!transformation to separable equation}
\index{transformation to separable equation!homogeneous!nonlinear equation}
\index{nonlinear!homogeneous equation}
...
is said to be
\emph{\color{blue}homogeneous}\index{homogeneous!differential equation}\index{differential equation!homogeneous}\index{separable equation!transformation from homogeneous equation}
if  $x$ and $y$ occur in $f$ in such a way that  $f(x,y)$ depends only
...
Before turning to examples, we point out something that you may have
already noticed: the definition of
\emph{\color{blue}homogeneous equation}\index{homogeneous!equation}\index{homogeneous!differential equation}
given here isn't  the same as the definition given in
\zcref{sec:linear_first_order}, where we said that a linear equation of the
form
\[
y'+p(x)y=0
\]
is homogeneous. We make no apology for this inconsistency, since we
didn't create it. Historically, \indexterm{homogeneous} has been
...
% this said nonhomogeneous ?
solutions of homogeneous equations only on open intervals that do
...
\item\label{exer:2.4.2}$7xy'-2y=-\dfrac{x^2 }{y^6}$
\item\label{exer:2.4.3}$x^2y'+2y=2e^{1/x}y^{1/2}$
\item\label{exer:2.4.4}$(1+x^2)y'+2xy=\frac{1}{(1+x^2)y}$
\end{exerciselistTwoColumn}
%
\textsl{In \zcref[range]{exer:2.4.5,exer:2.4.6} find all
solutions. Also, plot a direction field and some integral curves on
the indicated rectangular region.}
...
P'=aP(1-\alpha P)
\]
from Verhulst's model\index{Verhulst model} for population growth can be written in
Bernoulli form as
\[
P'-aP=-a\alpha P^2.
\]
...
\end{exerciselist}
%
\textsl{In \zcref[range]{exer:2.4.15,exer:2.4.18} solve
the equation explicitly.}

\begin{exerciselistTwoColumn}
\item\label{exer:2.4.15}$y'=\dfrac{y+x}{x}$
\item\label{exer:2.4.16}$y'=\dfrac{y^2+2xy }{x^2}$
\item\label{exer:2.4.17}$xy^3y'=y^4+x^4$
\item\label{exer:2.4.18}$y'=\dfrac{y}{x}+\sec\dfrac{y}{x}$
\end{exerciselistTwoColumn}

\textsl{In \zcref[range]{exer:2.4.19,exer:2.4.21} solve the
equation explicitly.
...
\end{exerciselist}
%
\textsl{In \zcref[range]{exer:2.4.28,exer:2.4.34} solve the
given homogeneous equation implicitly.}

\begin{exerciselistTwoColumn}
\item\label{exer:2.4.28}$y'=\dfrac{x+y }{x-y}$
\item\label{exer:2.4.29}$(y'x-y)(\ln |y|-\ln |x|)=x$
\item\label{exer:2.4.30}$y'=\dfrac{y^3+2xy^2+x^2y+x^3}{x(y+x)^2}$ 
\item\label{exer:2.4.31}$y'=\dfrac{x+2y }{2x+y}$
\item\label{exer:2.4.32}$y'=\dfrac{y }{y-2x}$
\item\label{exer:2.4.33}$y'=\dfrac{xy^2+2y^3}{x^3+x^2y+xy^2}$
...
\end{exerciselist}
%
\textsl{In \zcref[range]{exer:2.4.41,exer:2.4.43} use a
method suggested by \zcref{exer:2.4.40} to solve the
given equation implicitly.}

\begin{exerciselistTwoColumn}
\item\label{exer:2.4.41}$y'=\dfrac{-6x+y-3 }{2x-y-1}$
\item\label{exer:2.4.42}$y'=\dfrac{2x+y+1 }{x+2y-4}$
\item\label{exer:2.4.43}$y'=\dfrac{-x+3y-14 }{x+y-2}$
\end{exerciselistTwoColumn}
%
\textsl{In \zcref[range]{exer:2.4.44,exer:2.4.51} find
...
explicitly.}\index{transformation to separable equation!other equations}

\begin{exerciselistTwoColumn}
\item\label{exer:2.4.44}$3xy^2y'=y^3+x$
\item\label{exer:2.4.45}$xyy'=3x^6+6y^2$
\item\label{exer:2.4.46}$x^3y'=2(y^2+x^2y-x^4)$
\item\label{exer:2.4.47}$y'=y^2e^{-x}+4y+2e^x$
\item\label{exer:2.4.48}$y'=\dfrac{y^2+y\tan x+\tan^2 x}{\sin^2x}$ 
...
\item\label{exer:2.4.55}A
\personHref{Riccati}{generalized Riccati equation}\index{generalized Riccati equation}\index{Riccati equation!generalized}\index{Riccati, Jacopo Francesco} is of the form
\[
y'=P(x)+Q(x)y+R(x)y^2.\tag{A}
\]
(If $R\equiv-1$, (A) is a Riccati equation.)
Let $y_1$ be a known solution and $y$ an arbitrary
...
\index{first order equation!exact}
...
implicit, form we'll say that $F(x,y)=c$ is an
\indexterm{implicit solution}\index{first order equation!exact!implicit solution}\index{implicit solution!exact first order equation}
of \eqref{eq:2.5.1} if every differentiable function $y=y(x)$ that satisfies
...
M(x,y)\,dx+N(x,y)\,dy=0
\end{equation}
 is  \emph{\color{blue}exact}\index{exact!differential equation}\index{differential equation!exact} on an an open rectangle  $R$ if there's
...
\eqref{eq:2.5.8}) is the  \emph{\color{blue}exact differential}\index{exact!differential} of $F$.
...
\begin{theorem}[The Exactness Condition]\label{thmtype:2.5.2}\index{exactness condition}
Suppose  $M$ and
...
\begin{enumext}[label=\arabic*,wrap-label={(Method #1)},labelwidth=5em,list-indent=0pt]
\item To find $F$, we integrate \eqref{eq:2.5.14} with
...
\item Instead of first integrating
\eqref{eq:2.5.14}
...
example. You should summarize the procedure used in Method~2.

\begin{remark*}[Procedure For Solving An Exact Equation]
\index{first order equation!exact!procedures for solving}
...
$R$. (A function with these properties is said to be \emph{\color{blue}harmonic}\index{harmonic function};
...
said to be a \indexterm{harmonic conjugate} of $F$.)
...
A function $\mu=\mu(x,y)$ is  an \indexterm{integrating factor} for
\eqref{eq:2.6.1}  if
...
\item\label{exer:2.6.1}\begin{alist}
\item % (a)
...
\item\label{exer:2.6.2}\begin{alist}
\item % (a)
...
\end{exerciselist}
%
\textsl{In \zcref[range]{exer:2.6.3,exer:2.6.16} find an
integrating factor;
...
\item(2)\label{exer:2.6.7}$(xy+x+2y+1)\,dx+(x+1)\,dy=0$
\item(2)\label{exer:2.6.8}$(27xy^2+8y^3)\,dx+(18x^2y+12xy^2)\,dy=0$
\item(2)\label{exer:2.6.9}$(6xy^2+2y)\,dx+(12x^2y+6x+3)\,dy=0$
\item(2)\label{exer:2.6.10}$y^2\,dx+\left(xy^2+3xy+\dfrac{1}{y}\right)\,dy=0$
\item(2)\label{exer:2.6.11}$(12x^3y+24x^2y^2)\,dx+(9x^4+32x^3y+4y)\,dy=0$
\item(2)\label{exer:2.6.12}$(x^2y+4xy+2y)\,dx+(x^2+x)\,dy=0$
\item(2)\label{exer:2.6.13}$-y\,dx+(x^4-x)\,dy=0$
\item(2)\label{exer:2.6.14}$\cos x\cos y\,dx
+(\sin x\cos y-\sin x\sin y+y)\,dy=0$
\item(2)\label{exer:2.6.15}$(2xy+y^2)\,dx+(2xy+x^2-2x^2y^2-2xy^3)\,dy=0$
\item(2)\label{exer:2.6.16}$y\sin y\,dx+x(\sin y-y\cos y)\,dy=0$
\end{exerciselistTwoColumn}
%
\textsl{In \zcref[range]{exer:2.6.17,exer:2.6.23} find an
integrating
...
to solve some of the exercises in \zcref{sec:linear_first_order}.
\begin{alist}
\item % (a)
Rewrite (A) as
\[
