...
\[
\ln\left|{y-1\over y+1}\right|=-\frac{x^2}{2}+k;
\]
 hence,
\[
...
and
\[
y'={y^2+xy-x^2\over x^2}=\left(y\over x\right)^2+\frac{y}{x}
-1
\]
...
Solve the initial value problem
\[
y'+\frac{2}{x}y={3x^2y^2+6xy+2\over x^2(2xy+3)},\quad y(2)=2.
\]

\item\label{exer:2.4.53}
Solve the initial value problem
\[
y'+\frac{3}{x}y={3x^4y^2+10x^2y+6\over x^3(2x^2y+5)},\quad y(1)=1.
\]
...
\[
{M_y-N_x\over N}=-\frac{2xy^3}{3x^2y^2+x^2y^2+1}
\]
...
\[
{N_x-M_y\over M}=\frac{2xy^3}{2xy^3}=1
\]
