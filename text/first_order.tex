...
% TODO 12--15 in two columns
\item\label{exer:2.1.12}\CGex $y'+3y=1$
%&
\item\label{exer:2.1.13}\vspace*{6pt} \CGex $\dst{y'+\left(\frac{1}{x}-
1\right)y=-\frac{2}{x}}$
%\end{tabular}
...
$\dst{y'+\frac{2x}{1+x^2}y=\frac{e^{-x}}{1+x^2}}$
%\end{tabular}
...
%\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
% TODO 16--24 in two columns (22 spans)
\item\label{exer:2.1.16}$\dst{y'+\frac{1}{x}y=\frac{7}{x^2}+3}$
%&
\item\label{exer:2.1.17}\vspace*{8pt} $\dst{y'+\frac{4}{x-1}y
...
\frac{2}{x}\right) =\frac{1}{x^2}}$
\end{tabular}

\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
{\bf (c)} $\dst{\frac{xy'}{y} + 2\ln y=4x^2}$
& {\bf (d)} $\dst{\frac{y'}{(1+y)^2} -
\frac{1}{x(1+y)}=-\frac{3}{x^2}}$
\end{tabular}
...
% \begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
% TODO 19--20 in tow columns
\item\label{exer:2.2.19}$\dst{y'=\frac{2x}{1+2y},
\quad y(2)=0}$ %& 
\item \vspace*{5.5pt}\label{exer:2.2.20} $y'=2y-y^2,
\quad y(0)=1$
% \end{tabular}
...
%\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
% TODO 1--12 two columns
\item\label{exer:2.3.1}$\dst {y'=\frac{x^2+y^2}{\sin x}}$
% &  
\item\label{exer:2.3.2}\vspace*{10pt} $\dst
...
%&
\item\label{exer:2.3.4}$\dst {y'=\frac{x^2+y^2}{\ln xy}}$
% \end{tabular}
...
%\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
%\vspace*{10pt} 
\item\label{exer:2.3.7}$\dst
{y'=\ln(1+x^2+y^2)}$
%& \vspace*{4pt}
\item\label{exer:2.3.8}$\dst {y'=\frac{2x+3y}{x-4y}}$ 
%\end{tabular}
...
% TODO 15--18 two columns
%\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
 \item\label{exer:2.4.15}$y'=\dst\frac{y+x}{x}$
%& \vspace*{5pt}
...
%\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
\item\label{exer:2.4.30}$y'=\dst\frac{y^3+2xy^2+x^2y+x^3}{x(y+x)^2}$ 
%&
...
%&
\item\label{exer:2.4.33}$y'=\dst\frac{xy^2+2y^3}{x^3+x^2y+xy^2}$
%\end{tabular}
...
%\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
\item\label{exer:2.4.48}$y'=\dst\frac{y^2+y\tan x+\tan^2 x}{\sin^2x}$ 
%&
