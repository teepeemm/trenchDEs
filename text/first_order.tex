...
We call $c$ a
\emph{\color{blue}parameter} and say that \eqref{eq:2.1.3} defines a \emph{\color{blue}one-parameter family} of functions. For each real number $c$, the
...
\begin{figure}[tbp]
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig020101}
\color{blue}
...
The interval of validity of this solution is  $(0,\infty)$.
  ...
  \centering
  \includegraphics[%bb=-78 148 689 643,
  width=5.67in,height=3.66in,keepaspectratio]{fig020102}
\color{blue}
...
\begin{align}
y'+(\cot x)y
&=\dst\frac{u'}{\sin x}-\dst\frac{u\cos x}{\sin^2x}+\dst\frac{u\cot x}{\sin
x}\notag\\
&=\dst\frac{u'}{\sin x}-\dst\frac{u\cos x}{\sin^2x}+\dst\frac{u\cos
x}{\sin^2 x}\\\label{eq:2.1.24}
&=\dst\frac{u'}{\sin x}.\notag
\end{align}
...
\begin{proof}
\part{a} To show that \eqref{eq:2.1.32} is the general solution of
...
\emph{In Exercises~\ref{exer:2.1.1}--\ref{exer:2.1.5} find
...
\item\label{exer:2.1.8}$\dst{xy'+(1+ x\cot x)y=0,\quad y\left(\frac{\pi}{2}
\right)=2}$

\item\label{exer:2.1.9}$\dst{y'-\left(\frac{2x}{1+x^2}\right)y=0,\quad y(0)=2}$

\item\label{exer:2.1.10}$\dst{y'+\frac{k}{x}y=0,\quad y(1)=3 \quad\mbox{($k$=
constant)}}$
...
\item(1)\label{exer:2.1.13}\CGex $\dst{y'+\left(\frac{1}{x}-1\right)y=-\frac{2}{x}}$
\item(1)\label{exer:2.1.14}\CGex $y'+2xy=xe^{-x^2}$
\item(1)\label{exer:2.1.15}\CGex $\dst{y'+\frac{2x}{1+x^2}y=\frac{e^{-x}}{1+x^2}}$

\exercisetext{In Exercises~\ref{exer:2.1.16} --\ref{exer:2.1.24} find
the general solution.}


\item(1)\label{exer:2.1.16}$\dst{y'+\frac{1}{x}y=\frac{7}{x^2}+3}$
\item(1)\label{exer:2.1.17}\vspace*{8pt} $\dst{y'+\frac{4}{x-1}y
= \frac{1}{(x-1)^5}+\frac{\sin x}{(x-1)^4}}$
\item(1)\label{exer:2.1.18}$xy'+(1+2x^2)y=x^3e^{-x^2}$
\item(1)\label{exer:2.1.19}\vspace*{-8pt} $\dst{xy'+2y=\frac{2}{x^2}+1}$
\item(1)\label{exer:2.1.20}$y'+(\tan x)y=\cos x$
\item(1)\label{exer:2.1.21}\vspace*{-5pt} $\dst{(1+x)y'+2y=\frac{\sin x}{ 1 + x}}$
...
$\dst{(1+x^2)y'+4xy=\frac{2}{1+x^2},\quad y(0)=1}$

\item\label{exer:2.1.27}\CGex
$\dst{xy'+3y=\frac{2}{x(1+x^2)},\quad y(-1)=0}$
...
$\dst{y'+\frac{1}{x}y=\frac{2}{x^2}+1,\quad y(-1)=0}$
...
\item\label{exer:2.1.30}$\dst{(x-1)y'+3y=\frac{1}{(x-1)^3} +
...
\item\label{exer:2.1.34}$\dst{(x-1)y'+3y=\frac{1+(x-1)\sec^2x}{(x-1)^3},\quad y(0)=-1}$
...
\item $\dst{e^{y^2}\left(2yy'+\frac{2}{x}\right) =\frac{1}{x^2}}$
\item $\dst{\frac{xy'}{y} + 2\ln y=4x^2}$
\item $\dst{\frac{y'}{(1+y)^2} -\frac{1}{x(1+y)}=-\frac{3}{x^2}}$
\end{alist}
...
\begin{exerciselist}
\item(1)\label{exer:2.2.1}$\dst{y'=\frac{3x^2+2x+1}{y-2}}$
\item(1)\label{exer:2.2.2}\vspace*{18pt} $(\sin x)(\sin y)+(\cos y)y'=0$
\item(1)\label{exer:2.2.3}$xy'+y^2+y=0$
\item(1)\label{exer:2.2.4}$y' \ln |y|+x^2y= 0$

\item\label{exer:2.2.5}$\dst{(3y^3+3y \cos y+1)y'+\frac{(2x+1)y}{1+x^2}=0}$
...
\item\label{exer:2.2.11}$\dst{y'=\frac{x^2+3x+2}{y-2}, \quad y(1)=4}$
...
\item(1)\label{exer:2.2.19}$\dst{y'=\frac{2x}{1+2y},\quad y(2)=0}$
...
\item\label{exer:2.2.26}Solve $\dst{y'=\frac{\cos x}{\sin y},\quad y (\pi)=\frac{\pi}{2}}$
...
\item(1)\label{exer:2.2.35}$\dst{y'+y=\frac{2xe^{-x}}{1+ye^x}}$
\item(1)\label{exer:2.2.36}\vspace*{7pt}  $\dst{xy'-2y=\frac{x^6}{y+x^2}}$
\item(1)\label{exer:2.2.37}$\dst{y'-y}=\frac{(x+1)e^{4x}}{(y+e^x)^2}$
\item(1)\label{exer:2.2.38}$y'-2y=\dst\frac{xe^{2x}}{1-ye^{-2x}}$
...
% TODO horizontal
\item $xy'+y=h(x)p(xy)$
\item $\dst{xy'-y=h(x) p\left(\frac{y}{x}\right)}$
\item $y'+y=h(x) p(e^xy)$
\item $xy'+ry=h(x) p(x^ry)$
\item $\dst{y'+\frac{v'(x)}{v(x)}y= h(x)p\left(v(x)y\right)}$
\end{alist}
\end{exerciselist}
...
\begin{itemize}
\item \part{a} is an \emph{\color{blue}existence theorem}. It guarantees that a
...
\item \part{b} is a \emph{\color{blue}uniqueness theorem}. It guarantees that
...
f_y(x,y)  =  \dst -\frac{4x^2y }{(x^2+y^2)^2}
\]
...
Here
\[
f(x,y)  =  \frac{x+y}{x-y}\mbox{\quad and \quad}
...
\includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig020303}
...
\tagstructbegin{tag=Sect}\includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig020304}
...
\item(1)\label{exer:2.3.1}$\dst {y'=\frac{x^2+y^2}{\sin x}}$
\item(1)\label{exer:2.3.2}$\dst{y'=\frac{e^x+y }{x^2+y^2}}$
\item(1)\label{exer:2.3.3}$y'= \tan xy$
\item(1)\label{exer:2.3.4}$\dst {y'=\frac{x^2+y^2}{\ln xy}}$
\item(1)\label{exer:2.3.5}$y'=(x^2+y^2)y^{1/3}$
\item(1)\label{exer:2.3.6}\ $y'=2xy$
\item(1)\label{exer:2.3.7}$\dst{y'=\ln(1+x^2+y^2)}$
\item(1)\label{exer:2.3.8}$\dst {y'=\frac{2x+3y}{x-4y}}$ 
\item(1)\label{exer:2.3.9}$\dst{y'=(x^2+y^2)^{1/2}}$
\item(1)\label{exer:2.3.10}$y'=x(y^2-1)^{2/3}$
\item(1)\label{exer:2.3.11}$y'=(x^2+y^2)^2$
\item(1)\label{exer:2.3.12}$y'=(x+y)^{1/2}$


\item\label{exer:2.3.13}$\dst {y'=\frac{\tan y }{x-1}}$

\item\label{exer:2.3.14}Apply Theorem~\ref{thmtype:2.3.1} to the initial value problem
\[
...
y'(\overline{x}) = \lim_\frac{x \to }{line{x}}\frac{y(x)-y(\overline{x})
}{x-\overline{x}} \] to verify that $y$ satisfies the differential
...
\item\label{exer:2.3.16}Use the ideas developed in Exercise~\ref{exer:2.3.15} to find
infinitely
...
\begin{minipage}[t]{0.49\linewidth}
\tagstructbegin{tag=Sect}
\includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig020403}
...
\begin{minipage}[t]{0.49\linewidth}
\tagstructbegin{tag=Sect}
\includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig020404}
...
y=\left\{\begin{array}{ll} \dst\frac{x(1+c_1x^2)}{1-c_1x^2},&a<x<0,\\
[2\jot]\dst\frac{x(1+c_2x^2)}{1-c_2x^2},&0\le x<b,
 \end{array}\right.
\end{equation}
is a solution of \eqref{eq:2.4.9} on $(a,b)$, where
\[
a=\left\{\begin{array}{cl}-\dst\frac{1}{\sqrt{c_1}}&\mbox{ if }c_1>0,\\
-\infty&\mbox{ if }c_1\le 0,
\end{array}\right. \mbox{\quad and \quad}
b=\left\{\begin{array}{cl}\dst\frac{1}{\sqrt{c_2}}&\mbox{ if }c_2>0,\\
...
y=\left\{\begin{array}{ll} \dst\frac{x(1+cx^2)}{1-cx^2},&a<x\le0,\\[2\jot]
\dst\frac{x(1+x^2/3)}{1-x^2/3},&0\le x<\sqrt3,
\end{array}\right.
\end{equation}
...
\item(1)\label{exer:2.4.2}$\dst {7xy'-2y=-\frac{x^2 }{y^6}}$
\item(1)\label{exer:2.4.3}$x^2y'+2y=2e^{1/x}y^{1/2}$
\item(1)\label{exer:2.4.4}\vspace*{-5pt}$\dst {(1+x^2)y'+2xy
=\frac{1}{(1+x^2)y}}$
...
$\dst {y'-\frac{1+x}{3x}y=y^4};   \quad \{-2\le x\le2,-2\le y \le2\}$
...
\item(1)\label{exer:2.4.15}$y'=\dst\frac{y+x}{x}$
\item(1)\label{exer:2.4.16}$y'=\dst\frac{y^2+2xy }{x^2}$
\item(1)\label{exer:2.4.17}$xy^3y'=y^4+x^4$
\item(1)\label{exer:2.4.18}$y'=\dst\frac{y}{x}+\sec\frac{y}{x}$
...
$y'=\dst\frac{2y^2+x^2e^{-(y/x)^2}}{2xy};
...
\item\label{exer:2.4.22}$y'=\dst\frac{xy+y^2}{x^2},
\quad y(-1)=2$
...
\item(1)\label{exer:2.4.28}$y'=\dst\frac{x+y }{x-y}$
\item(1)\label{exer:2.4.29}\vspace*{13pt} $(y'x-y)(\ln |y|-\ln |x|)=x$
\item(1)\label{exer:2.4.30}$y'=\dst\frac{y^3+2xy^2+x^2y+x^3}{x(y+x)^2}$ 
\item(1)\label{exer:2.4.31}$y'=\dst\frac{x+2y }{2x+y}$
\item(1)\label{exer:2.4.32}$y'=\dst\frac{y }{y-2x}$
\item(1)\label{exer:2.4.33}$y'=\dst\frac{xy^2+2y^3}{x^3+x^2y+xy^2}$

\item\label{exer:2.4.34}$y'=\dst\frac{x^3+x^2y+3y^3 }{x^3+3xy^2}$
...
\item(1)\label{exer:2.4.41}$y'=\dst\frac{-6x+y-3 }{2x-y-1}$
\item(1)\label{exer:2.4.42}\vspace*{10pt} $y'=\dst\frac{2x+y+1 }{x+2y-4}$
...
\item(1)\label{exer:2.4.48}$y'=\dst\frac{y^2+y\tan x+\tan^2 x}{\sin^2x}$ 
...
\begin{center}\stepcounter{table}%\label{table:2.5.1}\vspace*{6pt}
\tagpdfsetup{table/header-rows={1}}
\begin{tabular}{ccc} \toprule
Equation \eqref{eq:2.5.1}&Equation \eqref{eq:2.5.2}&Equation \eqref{eq:2.5.3}
\\\midrule
$3x^2y^2\,dx+2x^3y\,dy =0$ &$3x^2y^2+2x^3y\,\dst\frac{dy}{dx} =0$  &$3x^2y^2\,\dst\frac{dx}{dy}+2x^3y=0$
\\
$(x^2+y^2)\,dx +2xy\,dy=0$ &
$(x^2+y^2)+2xy\,\dst\frac{dy}{dx}=0$&
$(x^2+y^2)\,\dst\frac{dx}{dy} +2xy=0$
\\
$3y\sin x\,dx-2xy\cos x\,dy =0$
&$3y\sin x-2xy\cos x\,\dst\frac{dy}{dx} =0$
& $3y\sin x\,\dst\frac{dx}{dy}-2xy\cos x  =0$
\\\bottomrule
\end{tabular}
\end{center}
...
\begin{example}\label{example:2.5.3}\rmfamily
Solve
...
\item(1)\label{exer:2.5.5}$(x+y)^2\,dx+(x+y)^2\,dy=0$%&
\item(1)\label{exer:2.5.6}$(4x+7y)\,dx+(3x+4y)\,dy=0$
...
\item\label{exer:2.5.11}$\dst{\left(\frac{1}{x}+2x\right)\,dx+
\left(\frac{1}{y}+2y\right)\,dy=0}$

\item\label{exer:2.5.12}$(y\sin xy+xy^2\cos xy)\,dx+(x\sin xy+xy^2\cos xy)\,dy=0$

\item\label{exer:2.5.13}$\dst{\frac{x\,dx}{(x^2+y^2)^{3/2}}+\frac{y\,dy}{(x^2+y^2)^{3/2}}=0}$
...
\item\label{exer:2.5.36}Under the assumptions of Exercise~\ref{exer:2.5.35}, show that
\[
F(x,y)=\int^y_{y_0}N(x_0,s)\,ds+\int^x_{x_0}M(t,y)\,dt.
\]

\item\label{exer:2.5.37}Use the method suggested by Exercise~\ref{exer:2.5.35}, with
...
\eqref{eq:2.6.24} implies that
 \[ p(x)=\frac{1}{x}\mbox{\quad and \quad}
q(y)=\frac{1}{y}.
\]
Since
...
\item\label{exer:2.6.10}$y^2\,dx+\dst{\left(xy^2+3xy+\frac{1}{y}\right)\,dy=0}$
...
\item\label{exer:2.6.30}According to Theorem~\ref{thmtype:2.1.2}, the general solution of the
