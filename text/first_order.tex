...
{y'=\ln(1+x^2+y^2)}$
%& \vspace*{4pt}
\item\label{exer:2.3.8} $\dst {y'={2x+3y
\over x-4y}}$ 
%\end{tabular}
...
y'(\overline{x}) = \lim_\frac{x \to }{line{x}} {y(x)-y(\overline{x})
...
For example,
\[
y'={y+xe^{-y/x}\over x}=\frac{y}{x}+e^{-y/x}
\]
and
\[
y'=\frac{y^2+xy-x^2}{x^2}=\left(y\over x\right)^2+\frac{y}{x}
-1
\]
...
Solve the initial value problem
\[
y'-\frac{3}{x}y={2x^4(4x^3-3y)\over3x^5+3x^3+2y},\quad y(1)=1.
\]
