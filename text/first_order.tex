...
$\dst{y'+\left(\frac{1+x}{x}\right)y=0,\quad y(1)=1}$

\item\label{exer:2.1.7}
$\dst{xy'+\left(1+\frac{1}{\ln x}\right)y=0,\quad y(e)=1}$

\item\label{exer:2.1.8}
$\dst{xy'+(1+ x\cot x)y=0,\quad y\left(\frac{\pi}{2}
\right)=2}$

\item\label{exer:2.1.9}
$\dst{y'-\left(\frac{2x}{1+x^2}\right)y=0,\quad y(0)=2}$

\item\label{exer:2.1.10}
$\dst{y'+\frac{k}{x}y=0,\quad y(1)=3 \quad\mbox{($k$=
constant)}}$
...
$\dst{(x-1)y'+3y=\frac{1+(x-1)\sec^2x}{(x-1)^3},\quad y(0)=-1}$

\item\label{exer:2.1.35}
$\dst{(x+2)y'+4y=\frac{1+2x^2}{x(x+2)^3},\quad y(-1)=2}$
...
%& \vspace*{5pt}
\item\label{exer:2.4.16}
$y'=\dst\frac{y^2+2xy }{x^2}$
%\end{tabular}
...
$y'=\dst\frac{y^2-3xy-5x^2 }{x^2}, \quad y(1)=-1$
...
$\dst{\frac{x\,dx}{(x^2+y^2)^{3/2}}+\frac{y\,dy}{(x^2+y^2)^{3/2}}=0}$
