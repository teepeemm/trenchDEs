...
\begin{figure}[H]
  ...
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig100101}
  \caption{}
  \label{figure:10.1.1}
\end{figure}
...
\solution
As in \zcref{sec:cooling_mixing}, let \emph{\color{blue}rate in} and \emph{\color{blue}rate
...
}=\frac{1}{300}Q_2\times3\\[2\jot]=\frac{1}{100}Q_2 \mbox{ lb/min}.
\]
Therefore
...
}=\frac{1}{100}Q_1\times2\\[2\jot]=\frac{1}{50}Q_1 \mbox{ lb/min}.
\]
Therefore
...
\end{equation}
   ...
   \begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig100102}
  \caption{}
  \label{figure:10.1.2}
\end{figure}
...
{\bf F}=\frac{K}{\|{\bf X}\|^2}\left(-\frac{{\bf X}
}{\|{\bf X}\|}\right)=-K\frac{x\,{\bf
i}+y\,{\bf j}+z\,{\bf k}}{\mbox{}\left(x^2+y^2+z^2\right)^{3/2}},
\end{equation}
where $K$ is a constant.  To determine $K$,  we observe that the magnitude
of ${\bf F}$  is
\[
\|{\bf F}\|=K\frac{\|{\bf X}\|}{\|{\bf X}\|^3}=\frac{K}{\|{\bf X}\|^2}
=\frac{K}{(x^2+y^2+z^2)}.
\]
...
\[
{\bf F}=-mgR^2\frac{x\,{\bf i}+y\,{\bf j}+z\,{\bf
k}}{\mbox{}\left(x^2+y^2+z^2\right)^{3/2}}.
\]
...
-mgR^2\frac{x\,{\bf i}+y\,{\bf j}+z\,{\bf
k}}{\left(x^2+y^2+z^2\right)^{3/2}}.
\]
...
\item\label{exer:10.1.4}Let ${\bf X}=x\,{\bf i}+y\,{\bf j}+z\,{\bf k}$ be the position vector
...
\[
{\bf y}=\col yn,\quad
A(t)=\matfunc ann,\quad\text{and}\quad {\bf f}(t)=\colfunc fn.
\]
...
\quad
${\bf y}=c_1\threecol{-1}01e^{-2t}+c_2\threecol0{-1}1e^{-2t}
+c_3\threecol111e^{4t}$
...
\quad
${\bf y}=c_1\threecol{-1}01e^{-3t}+c_2\threecol0{-1}1e^{-3t}
+c_3\threecol111e^{3t}$
...
\quad
${\bf y}=c_1\threecol101e^{2t}+c_2\threecol1{-1}1e^{3t}
+c_3\threecol1{-3}7e^{-t}$
\end{alist}
...
\quad
${\bf y}=c_1\begin{bmatrix}2\cos t\\3\cos t-\sin t\end{bmatrix}
...
\quad
${\bf y}=c_1\twocol{-1}1e^{2t}+c_2\begin{bmatrix}1+t\\-t\end{bmatrix}e^{2t}+\twocol13e^t$
...
\quad
${\bf y}=c_1\twocol21e^{-3t}+c_2\twocol{-2}1e^t
...
\[
{\bf y}_1=\twocol{y_{11}}{y_{21}}\quad\text{and}\quad {\bf
...
\item\label{exer:10.2.13}Suppose ${\bf y}$ is a solution of the $n\times n$ system  ${\bf
...
y}$ on $(a,b)$, then so is any linear combination of
 ${\bf y}_1$, ${\bf y}_2$, \dots, ${\bf y}_n$ (\zcref{exer:10.3.1}). We say that
...
{\bf y}_2=\begin{bmatrix}0\\e^{3t}\\1\end{bmatrix},
\quad\text{and}\quad
{\bf y}_3=\begin{bmatrix}e^{2t}\\e^{3t}\\0\end{bmatrix}
\]
...
{\bf y}_n=\begin{bmatrix} y_{1n}\\y_{2n}\\ \vdots\\ y_{nn}\end{bmatrix}.
\]
If
\[
{\bf y}=c_1{\bf y}_1+c_2{\bf y}_2+\cdots+c_n{\bf y}_n
...
y}_n\}$. It can be shown (\zcref{exer:10.3.2,exer:10.3.3})
...
({\bf a})-({\bf e}) of \zcref{thmtype:10.3.2} are true for the
...
\[
{\bf y}_1=\twocol{-e^{2t}}{2e^{2t}} \quad\text{and}\quad 
...
\item Since $W(t)\ne0$,
\zcref{thmtype:10.3.3} implies that $\{{\bf y}_1,{\bf y}_2\}$ is
...
\[
{\bf y}=-\begin{bmatrix}-e^{2t} \\ 2e^{2t}\end{bmatrix}
...
\begin{exerciselist}
\item\label{exer:10.3.1}Prove: If ${\bf y}_1$, ${\bf y}_2$, \dots, ${\bf y}_n$ are solutions of
...
\[
{\bf y}_1=\twocol{y_{11}}{y_{21}}\quad\text{and}\quad 
...
\[
A=\twobytwo2442, \quad {\bf y}_1
=\begin{bmatrix}e^{6t} \\e^{6t}\end{bmatrix}, \quad
{\bf y}_2=\begin{bmatrix}e^{-2t} \\-e^{-2t}\end{bmatrix}, \quad
{\bf k}=\begin{bmatrix}-3\\ 9\end{bmatrix}.
\]
\begin{alist}
\item % (a)
...
{\bf y}_1=\begin{bmatrix}e^{-4t} \\ e^{-4t}\end{bmatrix}, \quad
{\bf y}_2=\begin{bmatrix}-2e^{3t}\\ 5e^{3t}\end{bmatrix}, \quad
{\bf k}=\begin{bmatrix}10 \\-4\end{bmatrix}.
\]

\item\label{exer:10.3.9}Repeat \zcref{exer:10.3.7}  with
\[
 A=\twobytwo{-4} {-10} 3 7, \quad
{\bf y}_1=\begin{bmatrix}-5e^{2t} \\ 3e^{2t}\end{bmatrix}, \quad
{\bf y}_2=\begin{bmatrix} 2e^t \\-e^t\end{bmatrix}, \quad
...
{\bf y}_1=\begin{bmatrix} e^{3t} \\e^{3t}\end{bmatrix}, \quad
{\bf y}_2=\begin{bmatrix}e^t \\-e^t\end{bmatrix}, \quad
{\bf k}=\begin{bmatrix} 2 \\ 8\end{bmatrix}.
\]
...
{\bf y}_2=\begin{bmatrix} e^{3t} \\-e^{3t} \\e^{3t}\end{bmatrix}, \quad
{\bf y}_3=\begin{bmatrix} e^{-t} \\-3e^{-t} \\7e^{-t}\end{bmatrix}, \quad
{\bf k}=\begin{bmatrix}2 \\-7 \\ 20\end{bmatrix}.
\end{align*}
...
{\bf y}_1&=&\begin{bmatrix}-e^{-2t} \\ 0 \\ e^{-2t}\end{bmatrix}, \quad
{\bf y}_2=\begin{bmatrix}-e^{-2t} \\ e^{-2t} \\0\end{bmatrix}, \quad
...
\begin{align*}
 A&=\threebythree {-1} 2 3 0 1 6 0 0 {-2}, \\
{\bf y}_1&=\begin{bmatrix} e^t \\ e^t \\ 0\end{bmatrix},\quad
{\bf y}_2=\begin{bmatrix} e^{-t} \\ 0 \\ 0\end{bmatrix},\quad
{\bf y}_3=\begin{bmatrix} e^{-2t} \\-2e^{-2t}\\ e^{-2t}\end{bmatrix}, \quad
{\bf k}=\begin{bmatrix} 5 \\ 5 \\-1\end{bmatrix}.
\end{align*}
...
{\bf e}_2=\begin{bmatrix} 0\\1\\\vdots\\0\end{bmatrix},\quad\cdots\quad
...
\item % (b)
 Conclude from (a) and \zcref{exer:10.3.15}  that ${\bf y}'=
...
{\bf y}'=\twobytwo2442
{\bf y},\quad{\bf y}(0)=\begin{bmatrix}5 \\-1\end{bmatrix}.
\end{equation}
\end{alist}
\end{example}
...
{\bf y}=c_1{\bf y}_1+c_2{\bf y}_2=c_1\begin{bmatrix}1\\1\end{bmatrix}e^{6t}
...
{\bf y}'=\begin{bmatrix}3&-1&-1\\-2&3&2\\4&-1&-2\end{bmatrix}{\bf y}.
\end{equation}

\item  % (b)
 Solve the initial value problem
\begin{equation}\label{eq:10.4.13}
{\bf y}'=\begin{bmatrix}3&-1&-1\\-2&3&2\\4&-1&-2\end{bmatrix}{\bf y},\quad
{\bf y}(0)=\begin{bmatrix}2\\-1\\8\end{bmatrix}.
\end{equation}
\end{alist}
\end{example}
...
{\bf y}'=\begin{bmatrix}-3&2&2\\2&-3&2\\2&2&-3\end{bmatrix}{\bf y}.
\end{equation}
\end{example}
...
y}=\twocol{y_1}{y_2}$ is a non-constant solution of \eqref{eq:10.4.18},
...
In this case,
\[
\lim_{t\to\infty}\|{\bf y}(t)\|=\infty \quad\text{and}\quad 
\lim_{t\to\infty}\left\|{\bf y}(t)-c_2{\bf x}_2e^{\lambda_2
...
\begin{exerciselist}
\item(1)\label{exer:10.4.1}${\bf y}'=
\begin{bmatrix} 1&2\\2&1\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.2}${\bf y}'=
\dfrac{1}{4}\begin{bmatrix}-5&3 \\3&-5\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.3}${\bf y}'=
\dfrac{1}{5}\begin{bmatrix}-4&3\\-2&-11\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.4}${\bf y}'=
\begin{bmatrix}-1&-4\\-1&-1\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.5}${\bf y}'=
\begin{bmatrix}2&-4\\-1&-1\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.6}${\bf y}'=
\begin{bmatrix}4&-3\\2&-1\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.7}${\bf y}'=
\begin{bmatrix}-6&-3\\1&-2\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.8}${\bf y}'=
\begin{bmatrix}1&-1&-2\\1&-2&-3\\-4&1&-1\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.9}${\bf y}'=
\begin{bmatrix}-6&-4&-8\\-4&0&-4\\-8&-4&-6\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.10}${\bf y}'=
\begin{bmatrix}3&5&8\\1&-1&-2\\-1&-1&-1\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.11}${\bf y}'=
\begin{bmatrix}1&-1&2\\12&-4& 10\\-6&1&-7\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.12}${\bf y}'=
\begin{bmatrix}4&-1&-4\\4&-3&-2\\1&-1&-1\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.13}${\bf y}'=
\begin{bmatrix}-2&2&-6\\2&6&2\\-2&-2&2\end{bmatrix}{\bf y}$
\item(1)\label{exer:10.4.14}${\bf y}'=
\begin{bmatrix}3&2&-2\\-2&7&-2\\-10&10&-5\end{bmatrix}{\bf y}$

\item\label{exer:10.4.15}${\bf y}'=
\begin{bmatrix}3&1&-1\\3&5&1\\-6&2&4\end{bmatrix}{\bf y}$

\exercisetext{In \zcref[range]{exer:10.4.16,exer:10.4.27}
solve the initial value problem.}

\item\label{exer:10.4.16}${\bf y}'=\twobytwo{-7}4{-6}7{\bf y},\quad{\bf
y}(0)=\twocol2{-4}$

\item\label{exer:10.4.17}${\bf y}'=\frac{1}{6}\twobytwo72{-2}2{\bf y},\quad{\bf
y}(0)=\twocol0{-3}$

\item\label{exer:10.4.18}${\bf y}'=\twobytwo{21}{-12}{24}{-15}{\bf y},\quad{\bf
y}(0)=\twocol53$

\item\label{exer:10.4.19}${\bf y}'=\twobytwo{-7}4{-6}7{\bf y},\quad{\bf
y}(0)=\twocol{-1}7$

\item\label{exer:10.4.20}${\bf y}'=\dfrac{1}{6}\threebythree1204{-1}0003{\bf y},\quad{\bf
y}(0)=\threecol471$

\item\label{exer:10.4.21}${\bf y}'=\dfrac{1}{3}\threebythree2{-2}3{-4}43210{\bf
y},\quad{\bf y}(0)=\threecol115$

\item\label{exer:10.4.22}${\bf y}'=\threebythree6{-3}{-8}21{-2}3{-3}{-5}{\bf
y},\quad{\bf y}(0)=\threecol0{-1}{-1}$

\item\label{exer:10.4.23}${\bf y}'=\dfrac{1}{3}\threebythree24{-7}15{-5}{-4}4{-1}{\bf
y},\quad{\bf y}(0)=\threecol413$

\item\label{exer:10.4.24}${\bf y}'=\threebythree301{11}{-2}7103{\bf y},\quad
{\bf y}(0)=\threecol276$

\item\label{exer:10.4.25}${\bf y}'=\threebythree{-2}{-5}{-1}{-4}{-1}145{3}{\bf y},\quad
{\bf y}(0)=\threecol8{-10}{-4}$

\item\label{exer:10.4.26}${\bf y}'=\threebythree3{-1}04{-2}04{-4}2{\bf y},\quad
{\bf y}(0)=\threecol7{10}2$

\item\label{exer:10.4.27}${\bf y}'=
\begin{bmatrix}-2&2&6\\2&6&2\\-2&-2&2\end{bmatrix}{\bf y},\quad
{\bf y}(0)=\threecol6{-10}7$
...
\item(1)\label{exer:10.4.29}\CGex ${\bf y}'=\twobytwo111{-1}{\bf y}$
\item(1)\label{exer:10.4.30}\CGex ${\bf y}'=\twobytwo{-4}3{-2}{-11}{\bf
y}$
\item(1)\label{exer:10.4.31}\CGex ${\bf y}'=\twobytwo9{-3}{-1}{11}{\bf
y}$
\item(1)\label{exer:10.4.32}\CGex ${\bf y}'=\twobytwo{-1}{-10}{-5}4{\bf y}$
\item(1)\label{exer:10.4.33}\CGex ${\bf y}'=\twobytwo5{-4}1{10}{\bf y}$
\item(1)\label{exer:10.4.34}\CGex ${\bf y}'=\twobytwo{-7}13{-5}{\bf y}$
...
\item(1)\label{exer:10.4.36}\CGex ${\bf y}'=\twobytwo{-1}11{-1}{\bf y}$
\item(1)\label{exer:10.4.37}\CGex ${\bf y}'=\twobytwo{-1}{-3}26{\bf y}$
\item(1)\label{exer:10.4.38}\CGex ${\bf y}'=\twobytwo1{-3}{-1}3{\bf y}$
\item(1)\label{exer:10.4.39}\CGex ${\bf y}'=\twobytwo1{-2}{-1}2{\bf y}$
\item(1)\label{exer:10.4.40}\CGex ${\bf y}'=\twobytwo{-4}{-4}11{\bf y}$
\item(1)\label{exer:10.4.41}\CGex ${\bf y}'=\twobytwo3{-1}{-3}1{\bf y}$
...
${\bf y}_1=\twocol52e^t$ are solutions of \eqref{eq:10.5.1};
however,
...
y}_2=\twocol52te^t$, which doesn't work, since
\[
...
\begin{align*}
{\bf y}_2'-A{\bf y}_2
&=\lambda_1{\bf u}e^{\lambda_1t}+{\bf x} e^{\lambda_1t}
+\lambda_1{\bf x} te^{\lambda_1t}-A{\bf u}e^{\lambda_1t}
-A{\bf x} te^{\lambda_1t}\\
&=(\lambda_1{\bf u}+{\bf x} -A{\bf u})e^{\lambda_1t}
+(\lambda_1{\bf x} -A{\bf x} )te^{\lambda_1t}.
\end{align*}
...
Thus,
\[
{\bf y}_2=\twocol10\frac{e^t}{2}+\twocol52te^t.
\]
...
\[
{\bf
y}=c_1\twocol52e^t+c_2\left(\twocol10\frac{e^t}{2}+\twocol52te^t\right).\bbox
\]
...
solution ${\bf y}_2$ (\zcref{exer:10.5.33}).
...
multiples of ${\bf x}_2$, we must now use \zcref{thmtype:10.5.1} to
...
yields the solution
\[
{\bf y}_3=\threecol201\frac{e^{-t}}{2}+\threecol{-1}10te^{-t}
\]
of  \eqref{eq:10.5.7}.
...
{\bf y}_2&={\bf u}e^{\lambda_1t}+{\bf x} te^{\lambda_1t},\quad\mbox{and}\\
{\bf y}_3&={\bf v}e^{\lambda_1t}+{\bf u}te^{\lambda_1t}
+{\bf x} \frac{t^2e^{\lambda_1t}}{2}
\end{align*}
are linearly independent solutions of  ${\bf y}'=A{\bf y}$.
\end{theorem}
...
\eqref{eq:10.5.10}. \zcref[S]{thmtype:10.5.1} implies that ${\bf y}_1$ and
...
and
\[
{\bf y}_2=\threecol{-1}10\frac{e^{2t}}{2}+\threecol101te^{2t}
\]
is a solution of  \eqref{eq:10.5.11}.
...
\[
{\bf y}_3={\bf
v}e^{2t}+\threecol{-1}10\frac{te^{2t}}{2}+\threecol101\frac{t^2e^{2t}}{2}
\]
...
{\bf y}_3&={\bf u}e^{\lambda_1t}+{\bf x}_3te^{\lambda_1t}
\end{aligned}
\label{eq:10.5.14},
\]
are linearly independent solutions of  ${\bf y}'=A{\bf y}.$
...
${\bf y}_3$ are linearly independent by \zcref{thmtype:10.5.3},
...
the direction of ${\bf x}$ (as in \zcref{figure:10.5.2,figure:10.5.5}), or to the left of the observer (as in
...
\item(1)\label{exer:10.5.1}${\bf y}'=\twobytwo34{-1}7{\bf y}$
\item(1)\label{exer:10.5.2}${\bf y}'=\twobytwo0{-1}1{-2}{\bf y}$
\item(1)\label{exer:10.5.3}${\bf y}'=\twobytwo{-7}4{-1}{-11}{\bf y}$
\item(1)\label{exer:10.5.4}${\bf y}'=\twobytwo31{-1}1{\bf y}$
\item(1)\label{exer:10.5.5}${\bf y}'=\twobytwo4{12}{-3}{-8}{\bf y}$
\item(1)\label{exer:10.5.6}${\bf y'}=\twobytwo{-10}9{-4}2{\bf y}$
\item(1)\label{exer:10.5.7}${\bf y'}=\twobytwo{-13}{16}{-9}{11}{\bf y}$
\item(1)\label{exer:10.5.8}${\bf y'}=\threebythree021{-4}61042{\bf y}$
\item(1)\label{exer:10.5.9}${\bf y}' =\dfrac{1}{3}\threebythree11{-3}{-4}{-4}3{-2}10{\bf y}$
\item(1)\label{exer:10.5.10}${\bf y}'=\threebythree{-1}1{-1}{-2}02{-1}3{-1}{\bf y}$
\item(1)\label{exer:10.5.11}${\bf y}'=\threebythree4{-2}{-2}{-2}3{-1}2{-1}3{\bf y}$
\item(1)\label{exer:10.5.12}${\bf y}'=
\threebythree6{-5}32{-1}3211{\bf y}$

\exercisetext{In \zcref[range]{exer:10.5.13,exer:10.5.23}
solve the initial value problem.}

\item\label{exer:10.5.13}${\bf
y}'=\twobytwo{-11}8{-2}{-3}{\bf y} ,\quad{\bf y}(0)=\twocol62$

\item\label{exer:10.5.14}${\bf
y}'=\twobytwo{15}{-9}{16}{-9}{\bf y} ,\quad{\bf y}(0)=\twocol58$

\item\label{exer:10.5.15}${\bf y}'=\twobytwo{-3}{-4}1{-7}{\bf
y},\quad{\bf y}(0)=\twocol23$

\item\label{exer:10.5.16}${\bf
y}'=\twobytwo{-7}{24}{-6}{17}{\bf y} ,\quad{\bf y}(0)=\twocol31$

\item\label{exer:10.5.17}${\bf y}'=\twobytwo{-7}3{-3}{-1}{\bf
y} ,\quad{\bf y}(0)=\twocol02$

\item\label{exer:10.5.18}${\bf y}'
=\threebythree{-1}101{-1}{-2}{-1}{-1}{-1}{\bf y},\quad
{\bf y}(0)=\threecol65{-7}$

\item\label{exer:10.5.19}${\bf y}'
=\threebythree{-2}21{-2}21{-3}32{\bf y},\quad
{\bf y}(0)=\threecol{-6}{-2}0$

\item\label{exer:10.5.20}${\bf y}'
=\threebythree{-7}{-4}4{-1}01{-9}{-5}6{\bf y},\quad\bf
{\bf y}(0)=\threecol{-6}9{-1}$

\item\label{exer:10.5.21}${\bf y}'
=\threebythree{-1}{-4}{-1}361{-3}{-2}3\bf y,\quad\bf
y(0)=\threecol{-2}13$

\item\label{exer:10.5.22}${\bf y}'
=\threebythree4{-8}{-4}{-3}{-1}{-3}1{-1}9{\bf y},\quad
{\bf y}(0)=\threecol{-4}1{-3}$

\item\label{exer:10.5.23}${\bf y}'=
...
\item(1)\label{exer:10.5.24}${\bf y}'=\threebythree5{-1}1{-1}9{-3}{-2}24{\bf y}$
\item(1)\label{exer:10.5.25}${\bf y}'=\threebythree1{10}{-12}2232{-1}6{\bf y}$
\item(1)\label{exer:10.5.26}${\bf y}'=\threebythree{-6}{-4}{-4}2{-1}1231{\bf y}$
\item(1)\label{exer:10.5.27}${\bf y}'=\threebythree02{-2}{-1}5{-3}111{\bf y}$
\item(1)\label{exer:10.5.28}${\bf y}'=\threebythree{-2}{-12}{10}2{-24}{11}2{-24}8{\bf y}$
\item(1)\label{exer:10.5.29}${\bf y}'=\threebythree{-1}{-12}81{-9}41{-6}1{\bf y}$
\item(1)\label{exer:10.5.30}${\bf y}'=\threebythree{-4}0{-1}{-1}{-3}{-1}10{-2}{\bf y}$
\item(1)\label{exer:10.5.31}${\bf y}'=\threebythree{-3}{-3}445{-8}23{-5}\bf y$
...
\begin{align*}
{\bf y}_1 &={\bf x} e^{\lambda_1t},\\
{\bf y}_2&={\bf u}e^{\lambda_1t}+{\bf x} te^{\lambda_1t},\mbox{ and }\\
{\bf y}_3&={\bf v}e^{\lambda_1t}+{\bf u}te^{\lambda_1t}
+{\bf x} \frac{t^2e^{\lambda_1t}}{2}.
\end{align*}
...
\item(1)\label{exer:10.5.36}\CGex\, ${\bf y}'=\twobytwo{-3}{-1}41{\bf y}$
\item(1)\label{exer:10.5.37}\CGex\,  ${\bf y}'=\twobytwo2{-1}10{\bf y}$
\item(1)\label{exer:10.5.38}\CGex\, ${\bf y}'=\twobytwo{-1}{-3}35{\bf y}$
\item(1)\label{exer:10.5.39}\CGex\,  ${\bf y}'=\twobytwo{-5}3{-3}1{\bf y}$
\item(1)\label{exer:10.5.40}\CGex\,  ${\bf y}'=\twobytwo{-2}{-3}34{\bf y}$
\item(1)\label{exer:10.5.41}\CGex\,  ${\bf y}'=\twobytwo{-4}{-3}32{\bf y}$
\item(1)\label{exer:10.5.42}\CGex\,  ${\bf y}'=\twobytwo0{-1}1{-2}{\bf y}$
\item(1)\label{exer:10.5.43}\CGex\,  ${\bf y}'=\twobytwo01{-1}2{\bf y}$
\item(1)\label{exer:10.5.44}\CGex\,  ${\bf y}'=\twobytwo{-2}1{-1}0{\bf y}$
\item(1)\label{exer:10.5.45}\CGex\, ${\bf y}'=\twobytwo0{-4}1{-4}{\bf y}$
...
\]
 are
\[
{\bf y}_1=e^t\begin{bmatrix}3\cos4t-4\sin4t\\5\cos4t\end{bmatrix}
\quad\mbox{ and }\quad
{\bf y}_2=e^t\begin{bmatrix}3\sin4t+4\cos4t\\5\sin4t\end{bmatrix},
\]
...
\]
 are
\[
{\bf y}_1=e^t\begin{bmatrix}\sin3t+5\cos3t\\2\cos3t\end{bmatrix}
\quad\mbox{ and }\quad
{\bf y}_2=e^t\begin{bmatrix}-\cos3t+5\sin3t\\2\sin3t\end{bmatrix},
 \]
which are  linearly independent solutions of  \eqref{eq:10.6.7}.
The general solution of \eqref{eq:10.6.7} is
\[
{\bf y}=c_1e^t\begin{bmatrix}\sin3t+5\cos3t\\2\cos3t\end{bmatrix}+
...
\quad\mbox{ and }\quad
{\bf y}_3=\begin{bmatrix}\cos t\\\cos t-\sin t\\\sin t\end{bmatrix},
 \]
...
are
\[
{\bf y}_2=e^{2t}\begin{bmatrix}-\sin2t\\\sin2t\\\cos2t\end{bmatrix}
\quad\mbox{ and }\quad
{\bf y}_2=e^{2t}\begin{bmatrix}\cos2t\\-\cos2t\\\sin2t\end{bmatrix},
\]
...
{\bf u}_1={\bf u}-k{\bf v} \quad\text{and}\quad 
{\bf v}_1={\bf v}+k{\bf u},
\end{equation}
so
\[
...
\begin{example}\label{example:10.6.5} \rm  In \zcref{example:10.6.1}
we found the eigenvector
\[
{\bf x}=\ctwocol{3+4i}5=\twocol35+i\twocol40
\]
for the matrix of the system \eqref{eq:10.6.6}. Here ${\bf u}=\twocol35$
...
\[
{\bf u}_1={\bf u}-2{\bf v}=\twocol{-5}{\phantom{-}5}\quad\text{and}\quad 
...
in \eqref{eq:10.6.11} yields
\[
{\bf u}_1={\bf u}+\frac{{\bf v}}{2}=\twocol{5}5\quad\text{and}\quad 
{\bf v}_1={\bf v}-\frac{{\bf u}}{2}=\frac{1}{2}\twocol{-5}{\phantom{-}5},
\]
...
where
\begin{align*}
z_1(t)&=\|{\bf u}\|(c_1\cos\beta t+c_2\sin\beta t)\\
z_2(t)&=\|{\bf v}\|(-c_1\sin\beta t+c_2\cos\beta t).
\end{align*}
Therefore
\[ \frac{(z_1(t))^2}{\|{\bf
u}\|^2}+\frac{(z_2(t))^2}{\|{\bf v}\|^2} =c_1^2+c_2^2
\]
...
${\bf U}$ and ${\bf V}$. Since
\[
z_1'=\frac{\beta\|{\bf u}\|}{\|{\bf v}\|} z_2\quad\text{and}\quad 
z_2'=-\frac{\beta\|{\bf v}\|}{\|{\bf u}\|} z_1,
\]
 the vector from the
...
into coincidence with ${\bf U}$ (\zcref{figure:10.6.1,figure:10.6.2}).
...
\item(1)\label{exer:10.6.1}${\bf y}'=\twobytwo{-1}2{-5}5{\bf y}$
\item(1)\label{exer:10.6.2}${\bf y}'=\twobytwo{-11}4{-26}9{\bf y}$
\item(1)\label{exer:10.6.3}${\bf y}'=\twobytwo12{-4}5{\bf y}$
\item(1)\label{exer:10.6.4}${\bf y}'=\twobytwo5{-6}3{-1}{\bf y}$
\item(1)\label{exer:10.6.5}${\bf y}'=\threebythree3{-3}1022511{\bf y}$
\item(1)\label{exer:10.6.6}${\bf y}'=\threebythree{-3}311{-5}{-3}{-3}73{\bf y}$
\item(1)\label{exer:10.6.7}${\bf y}'=\threebythree21{-1}011101{\bf y}$
\item(1)\label{exer:10.6.8}${\bf y}'=\threebythree{-3}1{-3}4{-1}24{-2}3{\bf y}$
\item(1)\label{exer:10.6.9}${\bf y}'=\twobytwo5{-4}{10}1{\bf y}$
\item(1)\label{exer:10.6.10}${\bf y}'=\dfrac{1}{3}\twobytwo7{-5}25{\bf y}$
\item(1)\label{exer:10.6.11}${\bf y}'=\twobytwo32{-5}1{\bf y}$
\item(1)\label{exer:10.6.12}${\bf y}'=\twobytwo{34}{52}{-20}{-30}{\bf y}$
\item(1)\label{exer:10.6.13}${\bf y}'=\threebythree11210{-1}{-1}{-2}{-1}{\bf y}$
\item(1)\label{exer:10.6.14}${\bf y}'=\threebythree3{-4}{-2}{-5}7{-8}{-10}{13}{-8}{\bf y}$
\item(1)\label{exer:10.6.15}${\bf y}'=\threebythree60{-3}{-3}331{-2}6{\bf y}$
\item(1)\label{exer:10.6.16}${\bf y}'=\threebythree12{-2}02{-1}100{\bf y}$

\exercisetext{In \zcref[range]{exer:10.6.17,exer:10.6.24}
solve the initial value problem.}

\item\label{exer:10.6.17}${\bf y}'=\twobytwo4{-6}3{-2}{\bf y},\quad {\bf
y}(0)=\twocol52$

\item\label{exer:10.6.18}${\bf y}'=\twobytwo7{15}{-3}1{\bf y},\quad {\bf
y}(0)=\twocol51$

\item\label{exer:10.6.19}${\bf y}'=\twobytwo7{-15}3{-5}{\bf y},\quad {\bf
y}(0)=\twocol{17}7$

\item\label{exer:10.6.20}${\bf y}'=\frac{1}{6}\twobytwo4{-2}52{\bf y},\quad {\bf
y}(0)=\twocol1{-1}$

\item\label{exer:10.6.21}${\bf y}'=\threebythree52{-1}{-3}22132{\bf y},\quad {\bf
y}(0)=\threecol406$

\item\label{exer:10.6.22}${\bf y}'=\threebythree4408{10}{-20}23{-2}{\bf y},\quad {\bf
y}(0)=\threecol865$

\item\label{exer:10.6.23}${\bf
y}'=\threebythree1{15}{-15}{-6}{18}{-22}{-3}{11}{-15}{\bf
y},\quad {\bf y}(0)=\threecol{15}{17}{10}$

\item\label{exer:10.6.24}${\bf y}'=\threebythree4{-4}4{-10}3{15}2{-3}1{\bf y},\quad
...
\item\label{exer:10.6.27}Show that if the vectors ${\bf u}$ and ${\bf v}$ are not both ${\bf
...
\item\label{exer:10.6.28}Suppose ${\bf u}=\twocol{u_1}{u_2}$ and ${\bf
v}=\twocol{v_1}{v_2}$ are not orthogonal; that is, $({\bf
u},{\bf v})\ne0$.
\begin{alist}
\item % (a)
...
(a) that ${\bf U}_2={\bf V}_1$ and ${\bf V}_2=-{\bf U}_1$, and
...
\item(1)\label{exer:10.6.29}\CGex\, ${\bf y}'=\twobytwo3{-5}5{-3}{\bf y}$
\item(1)\label{exer:10.6.30}\CGex\,  ${\bf y}'=\twobytwo{-15}{10}{-25}{15}{\bf y}$
\item(1)\label{exer:10.6.31}\CGex\,  ${\bf y}'=\twobytwo{-4}8{-4}4{\bf y}$
\item(1)\label{exer:10.6.32}\CGex\,  ${\bf y}'=\twobytwo{-3}{-15}33{\bf y}$
...
\item(1)\label{exer:10.6.33}\CGex\,  ${\bf y}'=\twobytwo{-5}6{-12}7{\bf y}$
\item(1)\label{exer:10.6.34}\CGex\,  ${\bf y}'=\twobytwo5{-12}6{-7}{\bf y}$
\item(1)\label{exer:10.6.35}\CGex\,  ${\bf y}'=\twobytwo4{-5}9{-2}{\bf y}$
\item(1)\label{exer:10.6.36}\CGex\,  ${\bf y}'=\twobytwo{-4}9{-5}2{\bf y}$
\item(1)\label{exer:10.6.37}\CGex\,  ${\bf y}'=\twobytwo{-1}{10}{-10}{-1}{\bf y}$
\item(1)\label{exer:10.6.38}\CGex\,  ${\bf y}'=\twobytwo{-1}{-5}{20}{-1}{\bf y}$
\item(1)\label{exer:10.6.39}\CGex\,  ${\bf y}'=\twobytwo{-7}{10}{-10}9{\bf y}$
\item(1)\label{exer:10.6.40}\CGex\,  ${\bf y}'=\twobytwo{-7}6{-12}5{\bf y}$
...
where
\[
{\bf y}_1=\begin{bmatrix}y_{11}\\y_{21}\\ \vdots\\y_{n1}\end{bmatrix},\quad
{\bf y}_2=\begin{bmatrix}y_{12}\\y_{22}\\ \vdots\\y_{n2}\end{bmatrix},
\quad \cdots,\quad
{\bf y}_n=\begin{bmatrix}y_{1n}\\y_{2n}\\ \vdots\\y_{nn}\end{bmatrix}
\]
...
{\bf y}'=\twobytwo1221{\bf y}+\begin{bmatrix}2e^{4t}\\e^{4t}\end{bmatrix},
\end{equation}
...
{\bf y}'=\begin{bmatrix}2&2e^{-2t}\\2e^{2t}&4\end{bmatrix}
{\bf y}+\twocol11,
\end{equation}
given that
\[
...
{\bf y}'=-\frac{2}{t^2
}\begin{bmatrix}t&-3t^2\\1&-2t\end{bmatrix}{\bf y}
+t^2\twocol11,
\end{equation}
given that
\[
...
\[
{\bf
u}'=\begin{bmatrix}2t-3t^2\\2t-1\end{bmatrix}.
\]
Integrating  and taking the constants of integration to be zero yields
\[
{\bf u}=\begin{bmatrix}t^2-t^3\\t^2-t\end{bmatrix},
\]
so
\[
{\bf y}_p=Y{\bf u}=
...
y}+\begin{bmatrix}e^{t}\\0\\e^{-t}\end{bmatrix}.
\end{equation}
\item % (b)
...
\[
{\bf
u}=\begin{bmatrix}-e^t-e^{-t}\\\dfrac{e^{-2t}}{2}+t\\t\end{bmatrix},
\]
so
\[
{\bf y}_p=Y{\bf u}=
...
\[
{\bf
u}=\frac{1}{2}\begin{bmatrix}t\\-e^{-t}\\e^{-t}-e^{-2t}\end{bmatrix},
\]
so
\[
{\bf y}_p=Y{\bf u}=
...
\item(1)\label{exer:10.7.1}${\bf y}'=\twobytwo{-1}{-4}{-1}{-1}{\bf
y}+\begin{bmatrix}21e^{4t}\\8e^{-3t}\end{bmatrix}$

\item(1)\label{exer:10.7.2}${\bf y}'
=\dfrac{1}{5}\twobytwo{-4}3{-2}{-11}{\bf y}
+\begin{bmatrix}50e^{3t}\\10e^{-3t}\end{bmatrix}$

\item(1)\label{exer:10.7.3}${\bf y}'=\twobytwo1221{\bf
y}+\begin{bmatrix}1\\t\end{bmatrix}$

\item(1)\label{exer:10.7.4}${\bf y}'=\twobytwo{-4}{-3}65{\bf
y}+\begin{bmatrix}2\\-2e^t\end{bmatrix}$

\item(1)\label{exer:10.7.5}${\bf y}'=\twobytwo{-6}{-3}1{-2}{\bf
y}+\begin{bmatrix}4e^{-3t}\\4e^{-5t}\end{bmatrix}$

\item(1)\label{exer:10.7.6}${\bf y}'=\twobytwo01{-1}0{\bf
y}+\begin{bmatrix}1\\t\end{bmatrix}$

\item(1)\label{exer:10.7.7}${\bf y}'=\threebythree31{-1}351{-6}24{\bf
y}+\begin{bmatrix}3\\6\\3\end{bmatrix}$

\item(1)\label{exer:10.7.8}${\bf y}'
=\threebythree3{-1}{-1}{-2}324{-1}{-2}{\bf y}
+\begin{bmatrix}1\\e^t\\e^t\end{bmatrix}$

\item\label{exer:10.7.9}${\bf y}'=\threebythree{-3}222{-3}222{-3}{\bf
y}+\begin{bmatrix}e^t\\e^{-5t}\\e^t\end{bmatrix}$

\item\label{exer:10.7.10}${\bf
y}'=\dfrac{1}{3}\threebythree11{-3}{-4}{-4}3{-2}10{\bf
...
\item\label{exer:10.7.11}${\bf y}'
=\dfrac{1}{t}\begin{bmatrix}1&t\\-t&1\end{bmatrix}{\bf y}
+t\begin{bmatrix}\cos t\\\sin t\end{bmatrix};  \quad Y
=t\begin{bmatrix}\cos t&\sin t\\-\sin t&\cos t\end{bmatrix}$

\item\label{exer:10.7.12}${\bf y}'
=\dfrac{1}{t}\begin{bmatrix}1&t\\t&1\end{bmatrix}{\bf y}
+\begin{bmatrix}t\\t^2\end{bmatrix};  \quad Y
=t\begin{bmatrix}e^t&e^{-t}\\e^t&-e^{-t}\end{bmatrix}$

\item\label{exer:10.7.13}${\bf y}'
=\dfrac{1}{t^2-1}\begin{bmatrix}t&-1\\-1&t\end{bmatrix}{\bf y}+
t\begin{bmatrix}1\\-1\end{bmatrix};  \quad
Y=\begin{bmatrix}t&1\\1&t\end{bmatrix}$

\item\label{exer:10.7.14}${\bf y}'
=\dfrac{1}{3}\begin{bmatrix}1&-2e^{-t}\\2e^t&-1\end{bmatrix}{\bf y}+
\begin{bmatrix}e^{2t}\\e^{-2t}\end{bmatrix};  \quad
Y=\begin{bmatrix}2&e^{-t}\\e^t&2\end{bmatrix}$

\item\label{exer:10.7.15}${\bf y}'
=\dfrac{1}{2t^4}\begin{bmatrix}3t^3&t^6\\1&-3t^3\end{bmatrix}{\bf y}+
\dfrac{1}{t}\begin{bmatrix}t^2\\1\end{bmatrix};  \quad
Y=\dfrac{1}{t^2}\begin{bmatrix}t^3&t^4\\-1&t\end{bmatrix}$

\item\label{exer:10.7.16}${\bf y}'=
\begin{bmatrix}
...
\item\label{exer:10.7.17}${\bf y}'=\dfrac{1}{t}\threebythree110021{-2}22{\bf y}
+\threecol121
\quad Y=\begin{bmatrix}t^2&t^3&1\\t^2&2t^3&-1\\0&2t^3&2\end{bmatrix}$

\item\label{exer:10.7.18}${\bf y}'=
\begin{bmatrix}
...
\item\label{exer:10.7.19}${\bf y}'
=\frac{1}{t}\begin{bmatrix}1&t&0\\0&1&t\\0&-t&1\end{bmatrix}{\bf y}
+\begin{bmatrix}t\\t \\t\end{bmatrix};  \quad
Y=t\begin{bmatrix}
1&\cos t&\sin t \\0&-\sin t&\cos t\\0&-\cos t&-\sin t
\end{bmatrix}$

\item\label{exer:10.7.20}${\bf y}'=-\frac{1}{t}\begin{bmatrix}
