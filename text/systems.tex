...
\begin{aligned}
 x''&=-\dst\frac{gR^2x}{(x^2+y^2+z^2)^{3/2}}\\
 y''&=-\dst\frac{gR^2y}{(x^2+y^2+z^2)^{3/2}}\\
 z''&=-\dst\frac{gR^2z}{(x^2+y^2+z^2)^{3/2}}.
\end{aligned}
\end{equation}
\end{example}
...
which is row equivalent to
\[
\left[\begin{array}{rrrcr} 1&0&-\frac{1}{7}&\vdots&0\\0&1&
\frac{3}{7}&\vdots&0\\0&0&0&\vdots&0\end{array}\right].
\]
...
\begin{exerciselist}
\item(1)\label{exer:10.4.1}$\dst{{\bf y}'=
\begin{bmatrix} 1&2\\2&1\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.2}$\dst{{\bf y}'=
\frac{1}{4}\begin{bmatrix}-5&3 \\3&-5\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.3}$\dst{{\bf y}'=
\frac{1}{5}\begin{bmatrix}-4&3\\-2&-11\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.4}$\dst{{\bf y}'=
\begin{bmatrix}-1&-4\\-1&-1\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.5}$\dst{{\bf y}'=
\begin{bmatrix}2&-4\\-1&-1\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.6}$\dst{{\bf y}'=
\begin{bmatrix}4&-3\\2&-1\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.7}$\dst{{\bf y}'=
\begin{bmatrix}-6&-3\\1&-2\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.8}$\dst{{\bf y}'=
\begin{bmatrix}1&-1&-2\\1&-2&-3\\-4&1&-1\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.9}$\dst{{\bf y}'=
\begin{bmatrix}-6&-4&-8\\-4&0&-4\\-8&-4&-6\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.10}$\dst{{\bf y}'=
\begin{bmatrix}3&5&8\\1&-1&-2\\-1&-1&-1\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.11}$\dst{{\bf y}'=
\begin{bmatrix}1&-1&2\\12&-4& 10\\-6&1&-7\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.12}$\dst{{\bf y}'=
\begin{bmatrix}4&-1&-4\\4&-3&-2\\1&-1&-1\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.13}$\dst{{\bf y}'=
\begin{bmatrix}-2&2&-6\\2&6&2\\-2&-2&2\end{bmatrix}{\bf y}}$
\item(1)\label{exer:10.4.14}$\dst{{\bf y}'=
...
\item\label{exer:10.4.16}$\dst{{\bf y}'=\twobytwo{-7}4{-6}7{\bf y},\quad{\bf
y}(0)=\twocol2{-4}}$

\item\label{exer:10.4.17}$\dst{{\bf y}'=\frac{1}{6}\twobytwo72{-2}2{\bf y},\quad{\bf
y}(0)=\twocol0{-3}}$

\item\label{exer:10.4.18}$\dst{{\bf y}'=\twobytwo{21}{-12}{24}{-15}{\bf y},\quad{\bf
y}(0)=\twocol53}$

\item\label{exer:10.4.19}$\dst{{\bf y}'=\twobytwo{-7}4{-6}7{\bf y},\quad{\bf
y}(0)=\twocol{-1}7}$

\item\label{exer:10.4.20}$\dst{{\bf y}'=\frac{1}{6}\threebythree1204{-1}0003{\bf y},\quad{\bf
y}(0)=\threecol471}$

\item\label{exer:10.4.21}$\dst{{\bf y}'=\frac{1}{3}\threebythree2{-2}3{-4}43210{\bf
y},\quad{\bf y}(0)=\threecol115}$

\item\label{exer:10.4.22}$\dst{{\bf y}'=\threebythree6{-3}{-8}21{-2}3{-3}{-5}{\bf
y},\quad{\bf y}(0)=\threecol0{-1}{-1}}$

\item\label{exer:10.4.23}$\dst{{\bf y}'=\frac{1}{3}\threebythree24{-7}15{-5}{-4}4{-1}{\bf
...
\item(1)\label{exer:10.4.29}\CGex ${\bf y}'=\dst{\twobytwo111{-1}}{\bf y}$
\item(1)\label{exer:10.4.30}\CGex ${\bf y}'=\dst{\twobytwo{-4}3{-2}{-11}}{\bf
y}$
\item(1)\label{exer:10.4.31}\CGex ${\bf y}'=\dst{\twobytwo9{-3}{-1}{11}}{\bf
y}$
\item(1)\label{exer:10.4.32}\CGex ${\bf y}'=\dst{\twobytwo{-1}{-10}{-5}4}{\bf y}$
\item(1)\label{exer:10.4.33}\CGex ${\bf y}'=\dst{\twobytwo5{-4}1{10}}{\bf y}$
\item(1)\label{exer:10.4.34}\CGex ${\bf y}'=\dst{\twobytwo{-7}13{-5}}{\bf y}$
...
\item(1)\label{exer:10.4.36}\CGex ${\bf y}'=\dst{\twobytwo{-1}11{-1}}{\bf y}$
\item(1)\label{exer:10.4.37}\CGex ${\bf y}'=\dst{\twobytwo{-1}{-3}26}{\bf y}$
\item(1)\label{exer:10.4.38}\CGex ${\bf y}'=\dst{\twobytwo1{-3}{-1}3}{\bf y}$
\item(1)\label{exer:10.4.39}\CGex ${\bf y}'=\dst{\twobytwo1{-2}{-1}2}{\bf y}$
\item(1)\label{exer:10.4.40}\CGex ${\bf y}'=\dst{\twobytwo{-4}{-4}11}{\bf y}$
\item(1)\label{exer:10.4.41}\CGex ${\bf y}'=\dst{\twobytwo3{-1}{-3}1}{\bf y}$
...
which is row equivalent to
\[
\left[\begin{array}{rrcr}1&-\dst\frac{5}{2}&\vdots&0\\[10pt]0&
...
which is row equivalent to
\[
\dst{\left[\begin{array}{rrcr}1&-\frac{5}{2}&\vdots&\frac12\\
...
1&-1&1\\2&1&0\\1&0&\frac12\end{array}\right|=\frac{1}{2},
\]
...
which is row equivalent to
\[
\left[\begin{array}{rrrcr} 1 & 0 &- 1 &\vdots& -\frac{1}{2}\\ 0 & 1 & 0
...
The  augmented matrix  of this system is
\[
\left[\begin{array}{rrrcr} -1 & 1 & 1 &\vdots &-\frac{1}{2}\\
1& 1 & -1 &\vdots & \frac{1}{2}\\ 0 & 2 & 0 &
\vdots & 0\end{array}\right], \]
which is row equivalent to
\[
\left[\begin{array}{rrrcr} 1 & 0 &- 1 &\vdots& \frac{1}{2}\\ 0 & 1 & 0
...
\[
{\bf y}
=\dst{c_1\threecol101e^{2t}
+c_2\left(\threecol{-1}10\frac{e^{2t}}{2}+\threecol101te^{2t}\right)}
+c_3\dst{\left(\threecol100\frac{e^{2t}}{2}+
...
\item(1)\label{exer:10.5.1}$\dst{{\bf y}'=\twobytwo34{-1}7{\bf y}}$%&
\item(1)\label{exer:10.5.2}$\dst{{\bf y}'=\twobytwo0{-1}1{-2}{\bf y}}$
\item(1)\label{exer:10.5.3}$\dst{{\bf y}'=\twobytwo{-7}4{-1}{-11}{\bf y}}$
\item(1)\label{exer:10.5.4}$\dst{{\bf y}'=\twobytwo31{-1}1{\bf y}}$
\item(1)\label{exer:10.5.5}$\dst{{\bf y}'=\twobytwo4{12}{-3}{-8}{\bf y}}$
\item(1)\label{exer:10.5.6}$\dst{{\bf y'}=\twobytwo{-10}9{-4}2{\bf y}}$
\item(1)\label{exer:10.5.7}$\dst{{\bf y'}=\twobytwo{-13}{16}{-9}{11}{\bf y}}$
\item(1)\label{exer:10.5.8}$\dst{{\bf y'}=\threebythree021{-4}61042{\bf y}}$
\item(1)\label{exer:10.5.9}$\dst{{\bf y}' =\frac{1}{3}\threebythree11{-3}{-4}{-4}3{-2}10{\bf y}}$
\item(1)\label{exer:10.5.10}$\dst{{\bf y}'=\threebythree{-1}1{-1}{-2}02{-1}3{-1}{\bf y}}$
\item(1)\label{exer:10.5.11}$\dst{{\bf y}'=\threebythree4{-2}{-2}{-2}3{-1}2{-1}3{\bf y}}$
\item(1)\label{exer:10.5.12}$\dst{{\bf y}'=
...
\item(1)\label{exer:10.5.24}$\dst{{\bf y}'=\threebythree5{-1}1{-1}9{-3}{-2}24{\bf y}}$
\item(1)\label{exer:10.5.25}$\dst{{\bf y}'=\threebythree1{10}{-12}2232{-1}6{\bf y}}$
\item(1)\label{exer:10.5.26}$\dst{{\bf y}'=\threebythree{-6}{-4}{-4}2{-1}1231{\bf y}}$
\item(1)\label{exer:10.5.27}$\dst{{\bf y}'=\threebythree02{-2}{-1}5{-3}111{\bf y}}$
\item(1)\label{exer:10.5.28}$\dst{{\bf y}'=\threebythree{-2}{-12}{10}2{-24}{11}2{-24}8{\bf y}}$
\item(1)\label{exer:10.5.29}$\dst{{\bf y}'=\threebythree{-1}{-12}81{-9}41{-6}1{\bf y}}$
\item(1)\label{exer:10.5.30}$\dst{{\bf y}'=\threebythree{-4}0{-1}{-1}{-3}{-1}10{-2}{\bf y}}$
\item(1)\label{exer:10.5.31}$\dst{{\bf y}'=\threebythree{-3}{-3}445{-8}23{-5}\bf y}$
...
\item(1)\label{exer:10.5.36}\CGex\, ${\bf y}'=\dst{\twobytwo{-3}{-1}41}{\bf
y}$
\item(1)\label{exer:10.5.37}\CGex\,  ${\bf y}'=\dst{\twobytwo2{-1}10}{\bf y}$
\item(1)\label{exer:10.5.38}\CGex\, ${\bf y}'=\dst{\twobytwo{-1}{-3}35}{\bf
y}$
\item(1)\label{exer:10.5.39}\CGex\,  ${\bf y}'=\dst{\twobytwo{-5}3{-3}1}{\bf
y}$
\item(1)\label{exer:10.5.40}\CGex\,  ${\bf y}'=\dst{\twobytwo{-2}{-3}34}{\bf
y}$
\item(1)\label{exer:10.5.41}\CGex\,  ${\bf y}'=\dst{\twobytwo{-4}{-3}32}{\bf
y}$
\item(1)\label{exer:10.5.42}\CGex\,  ${\bf y}'=\dst{\twobytwo0{-1}1{-2}}{\bf
y}$
\item(1)\label{exer:10.5.43}\CGex\,  ${\bf y}'=\dst{\twobytwo01{-1}2}{\bf y}$
\item(1)\label{exer:10.5.44}\CGex\,  ${\bf y}'=\dst{\twobytwo{-2}1{-1}0}{\bf
y}$
\item(1)\label{exer:10.5.45}\CGex\, ${\bf y}'=\dst{\twobytwo0{-4}1{-4}}{\bf
y}$
...
which is row equivalent to
\[
\left[\begin{array}{cccr} 1&-\frac{3+4i}{5}&\vdots&0\\ 0&0&\vdots&0
\end{array}\right].
\]
...
which is row equivalent to
\[
\left[\begin{array}{cccr} 1&\frac{-5+i}{2}&\vdots&0\\ 0&0&\vdots&0
\end{array}\right].
\]
...
\item(1)\label{exer:10.6.1}$\dst{{\bf y}'=\twobytwo{-1}2{-5}5{\bf y}}$
\item(1)\label{exer:10.6.2}$\dst{{\bf y}'=\twobytwo{-11}4{-26}9{\bf y}}$
\item(1)\label{exer:10.6.3}$\dst{{\bf y}'=\twobytwo12{-4}5{\bf y}}$
\item(1)\label{exer:10.6.4}$\dst{{\bf y}'=\twobytwo5{-6}3{-1}{\bf y}}$
\item(1)\label{exer:10.6.5}$\dst{{\bf y}'=\threebythree3{-3}1022511{\bf y}}$
\item(1)\label{exer:10.6.6}$\dst{{\bf y}'=\threebythree{-3}311{-5}{-3}{-3}73{\bf y}}$
\item(1)\label{exer:10.6.7}$\dst{{\bf y}'=\threebythree21{-1}011101{\bf y}}$
\item(1)\label{exer:10.6.8}$\dst{{\bf y}'=\threebythree{-3}1{-3}4{-1}24{-2}3{\bf y}}$
\item(1)\label{exer:10.6.9}$\dst{{\bf y}'=\twobytwo5{-4}{10}1{\bf y}}$
\item(1)\label{exer:10.6.10}$\dst{{\bf y}'=\frac{1}{3}\twobytwo7{-5}25{\bf y}}$
\item(1)\label{exer:10.6.11}$\dst{{\bf y}'=\twobytwo32{-5}1{\bf y}}$
\item(1)\label{exer:10.6.12}$\dst{{\bf y}'=\twobytwo{34}{52}{-20}{-30}{\bf y}}$
\item(1)\label{exer:10.6.13}$\dst{{\bf y}'=\threebythree11210{-1}{-1}{-2}{-1}{\bf y}}$
\item(1)\label{exer:10.6.14}$\dst{{\bf y}'=\threebythree3{-4}{-2}{-5}7{-8}{-10}{13}{-8}{\bf y}}$
\item(1)\label{exer:10.6.15}$\dst{{\bf y}'=\threebythree60{-3}{-3}331{-2}6{\bf y}'}$
\item(1)\label{exer:10.6.16}$\dst{{\bf y}'=\threebythree12{-2}02{-1}100{\bf y}'}$

\exercisetext{In \zcref[range]{exer:10.6.17,exer:10.6.24}
solve the initial value problem.}

\item\label{exer:10.6.17}$\dst{{\bf y}'=\twobytwo4{-6}3{-2}{\bf y},\quad {\bf
y}(0)=\twocol52}$

\item\label{exer:10.6.18}$\dst{{\bf y}'=\twobytwo7{15}{-3}1{\bf y},\quad {\bf
y}(0)=\twocol51}$

\item\label{exer:10.6.19}$\dst{{\bf y}'=\twobytwo7{-15}3{-5}{\bf y},\quad {\bf
y}(0)=\twocol{17}7}$

\item\label{exer:10.6.20}$\dst{{\bf y}'=\frac{1}{6}\twobytwo4{-2}52{\bf y},\quad {\bf
y}(0)=\twocol1{-1}}$

\item\label{exer:10.6.21}$\dst{{\bf y}'=\threebythree52{-1}{-3}22132{\bf y},\quad {\bf
y}(0)=\threecol406}$

\item\label{exer:10.6.22}$\dst{{\bf y}'=\threebythree4408{10}{-20}23{-2}{\bf y},\quad {\bf
y}(0)=\threecol865}$

\item\label{exer:10.6.23}$\dst{{\bf
y}'=\threebythree1{15}{-15}{-6}{18}{-22}{-3}{11}{-15}{\bf
y},\quad {\bf y}(0)=\threecol{15}{17}{10}}$

\item\label{exer:10.6.24}$\dst{{\bf y}'=\threebythree4{-4}4{-10}3{15}2{-3}1{\bf y},\quad
...
\item\label{exer:10.6.28}Suppose ${\bf u}=\dst{\twocol{u_1}{u_2}}$ and ${\bf
...
\item(1)\label{exer:10.6.29}\CGex\, $\dst{{\bf y}'=\twobytwo3{-5}5{-3}{\bf y}}$
\item(1)\label{exer:10.6.30}\CGex\,  $\dst{{\bf y}'=\twobytwo{-15}{10}{-25}{15}{\bf y}}$
\item(1)\label{exer:10.6.31}\CGex\,  $\dst{{\bf y}'=\twobytwo{-4}8{-4}4{\bf y}}$
\item(1)\label{exer:10.6.32}\CGex\,  $\dst{{\bf y}'=\twobytwo{-3}{-15}33{\bf y}}$
...
\item(1)\label{exer:10.6.33}\CGex\,  $\dst{{\bf y}'=\twobytwo{-5}6{-12}7{\bf y}}$
\item(1)\label{exer:10.6.34}\CGex\,  $\dst{{\bf y}'=\twobytwo5{-12}6{-7}{\bf y}}$
\item(1)\label{exer:10.6.35}\CGex\,  $\dst{{\bf y}'=\twobytwo4{-5}9{-2}{\bf y}}$
\item(1)\label{exer:10.6.36}\CGex\,  $\dst{{\bf y}'=\twobytwo{-4}9{-5}2{\bf y}}$
\item(1)\label{exer:10.6.37}\CGex\,  $\dst{{\bf y}'=\twobytwo{-1}{10}{-10}{-1}{\bf y}}$
\item(1)\label{exer:10.6.38}\CGex\,  $\dst{{\bf y}'=\twobytwo{-1}{-5}{20}{-1}{\bf y}}$
\item(1)\label{exer:10.6.39}\CGex\,  $\dst{{\bf y}'=\twobytwo{-7}{10}{-10}9{\bf y}}$
\item(1)\label{exer:10.6.40}\CGex\,  $\dst{{\bf y}'=\twobytwo{-7}6{-12}5{\bf y}}$
...
\[
\begin{array}{ccccccl}
u_1'&=&-\dst\frac{1}{2e^{2t}}
\left|\begin{array}{cr}2e^{4t}&e^{-t}\\e^{4t}&-e^{-t}
\end{array}\right|&=&\dst\frac{3e^{3t}}{2e^{2t}}&=
&\dst\frac{3}{2}e^t,\\[4\jot]
u_2'&=&-\dst\frac{1}{2e^{2t}}
\left|\begin{array}{rr}e^{3t}&2e^{4t}\\e^{3t}&e^{4t}
\end{array}\right|&=&\dst\frac{e^{7t}}{2e^{2t}}&=&\dst\frac{1}{2}e^{5t}.
\end{array}
\]
 Therefore
\[
{\bf
u}'=\frac{1}{2}\left[\begin{array}{c}3e^t\\e^{5t}\end{array}\right].
\]
Integrating and taking the constants of integration to be zero yields
\[
{\bf
u}=\frac{1}{10}\left[\begin{array}{c}15e^t\\e^{5t}\end{array}\right],
\]
so
\[
{\bf y}_p=Y{\bf u}=
\dst\frac{1}{10}\left[\begin{array}{rr}e^{3t}&e^{-t}\\[2\jot]
e^{3t}&-e^{-t}\end{array}\right]
\left[\begin{array}{c}15e^t\\e^{5t}\end{array}\right]
=\phantom{0}
\dst\frac{1}{5}\left[\begin{array}{c}8e^{4t}\\7e^{4t}\end{array}\right]
\]
...
\frac{1}{5}\left[\begin{array}{c}8e^{4t}\\7e^{4t}\end{array}\right]
...
\[
\begin{array}{cccccll}
u_1'&=&\dst\frac{1}{2e^{6t}}\left|\begin{array}{cc}1&-1\\1&e^{2t}
\end{array}\right|&=&\dst\frac{e^{2t}+1}{2e^{6t}}&=&\dst\frac{e^{-4t}+e^{-6t}}{2}
\\[4\jot]
u_2'&=&\dst\frac{1}{2e^{6t}}\left|\begin{array}{cc}e^{4t}&1\\e^{6t}&1
\end{array}\right|&=&\dst\frac{e^{4t}-e^{6t}}{2e^{6t}}&=&\dst\frac{e^{-2t}-1}{2}.
\end{array}
\]
Therefore
\[
{\bf
u}'=\frac{1}{2}\left[\begin{array}{c}e^{-4t}+e^{-6t}\\e^{-2t}-1\end{array}\right].
\]
Integrating  and taking the constants of integration to be zero yields
\[
{\bf
u}=-\frac{1}{24}\left[\begin{array}{c}3e^{-4t}+2e^{-6t}\\6e^{-2t}+12t
\end{array}\right],
\]
so
\[
{\bf y}_p=Y{\bf u}=
-\displaystyle\frac{1}{24}\left[\begin{array}{cc}e^{4t}&-1\\e^{6t}&e^{2t}\end{array}\right]
\left[\begin{array}{c}3e^{-4t}+2e^{-6t}\\6e^{-2t}+12t\end{array}\right]
=\displaystyle\frac{1}{24}\left[\begin{array}{c}4e^{-2t}+12t-3\\-3e^{2t}(4t+1)-8\end{array}\right]
\]
...
\[
\begin{array}{ccccccl}
u_1'&=&\dst\frac{1}{t^2}\left|\begin{array}{cc}t^2&3t^2\\t^2&2t
\end{array}\right|&=&\dst\frac{2t^3-3t^4}{t^2}&=&2t-3t^2,
\\[4\jot]
u_2'&=&\dst\frac{1}{t^2}\left|\begin{array}{cc}2t&t^2\\1&t^2
\end{array}\right|&=&\dst\frac{2t^3-t^2}{t^2}&=&2t-1.
\end{array}
\]
Therefore
\[
...
\[
\begin{array}{cccccll}
u_1'&=&-\dst\frac{1}{e^{2t}}\left|\begin{array}{ccc}e^t&e^t&e^t\\0&e^t&0\\e^{-t}&0&e^t
\end{array}\right|&=&-\dst\frac{e^{3t}-e^t}{
e^{2t}}&=&e^{-t}-e^t\\[6\jot] u_2'&=&-\dst\frac{1}{e^{2t}}\left|\begin{array}{ccc}1&e^t&e^t\\1&0&0\\1&e^{-t}&e^t
\end{array}\right|&=&-\dst\frac{1-e^{2t}}{e^{2t}}&=&1-e^{-2t}\\[6\jot]
u_3'&=&-\dst\frac{1}{e^{2t}}\left|\begin{array}{ccc}1&e^t&e^t\\1&e^t&0\\1&0&e^{-t}
\end{array}\right|&=&\dst\frac{e^{2t}}{e^{2t}}&=&1.
\end{array}
\]
 Therefore
\[
...
\[
{\bf
u}=\left[\begin{array}{c}-e^t-e^{-t}\\\dst\frac{e^{-2t}}{2}+t
\\t\end{array}\right],
\]
so
\[
...
{\bf y}_p=Y{\bf u}&=&
\left[\begin{array}{ccc}1&e^t&e^t\\1&e^t&0\\1&0&e^t\end{array}\right]
\left[\begin{array}{c}-e^t-e^{-t}\\\dst\frac{e^{-2t}}{2}+t\\t\end{array}\right]
&=&\left[\begin{array}{c}e^t(2t-1)-\dst\frac{e^{-t}}{2}\\[5pt]e^t(t-1)-\dst\frac{e^{-t}}{2}\\[5pt]e^t(t-1)-\dst{e^{-t}}
\end{array}\right]
\end{array}
\]
...
\[
{\bf y}={\bf y}_p+Y{\bf c}=
\left[\begin{array}{c}e^t(2t-1)-\dst\frac{e^{-t}}{2}\\[5pt]e^t(t-1)-\dst\frac{e^{-t}}{2}\\[5pt]e^t(t-1)-\dst{e^{-t}} \end{array}\right]+
...
\[
\begin{array}{ccccccl}
u_1'&=&-\dst\frac{1}{2e^{4t}}\left|\begin{array}{ccc}1&0&e^{2t}\\e^t&e^{3t}&e^{3t}
\\e^{-t}&1&0
\end{array}\right|&=&\dst\frac{e^{4t}}{2e^{4t}}&=&\dst\frac{1}{2}
\\[6\jot]
u_2'&=&-\dst\frac{1}{2e^{4t}}\left|\begin{array}{ccc}e^t&1&e^{2t}\\0&e^t&e^{3t}
\\e^{-t}&e^{-t}&0
\end{array}\right|&=&\dst\frac{e^{3t}}{2e^{4t}}&=&\dst\frac{1}{2}e^{-t}\\[6\jot]
u_3'&=&-\dst\frac{1}{2e^{4t}}\left|\begin{array}{ccc}e^t&0&1\\0&e^{3t}&e^t
\\e^{-t}&1&e^{-t}
\end{array}\right|&=&-\dst\frac{e^{3t}-2e^{2t}}{2e^{4t}}&=&\dst\frac{2e^{-2t}-e^{-t}}{2}.
\end{array}
\]
Therefore
\[
{\bf
u}'=\frac{1}{2}\left[\begin{array}{c}1\\e^{-t}\\2e^{-2t}-e^{-t}\end{array}\right].
\]
Integrating  and taking the constants of integration to be zero yields
\[
{\bf
u}=\frac{1}{2}\left[\begin{array}{c}t\\-e^{-t}\\e^{-t}-e^{-2t}
\end{array}\right],
\]
so
\[
{\bf y}_p=Y{\bf u}=
\frac{1}{2}\left[\begin{array}{ccc}e^t&0&e^{2t}\\0&e^{3t}&e^{3t}\\e^{-t}&1&0
\end{array}\right]
\left[\begin{array}{c}t\\-e^{-t}\\e^{-t}-e^{-2t}
\end{array}\right]=\dst\frac{1}{2}\left[\begin{array}{c}e^t(t+1)-1\\
...
\item(1)\label{exer:10.7.1}$\dst{{\bf y}'=\twobytwo{-1}{-4}{-1}{-1}{\bf
y}+\left[\begin{array}{cc}21e^{4t}\\8e^{-3t}\end{array}\right]}$

\item(1)\label{exer:10.7.2}$\dst{{\bf y}'
=\frac{1}{5}\twobytwo{-4}3{-2}{-11}{\bf y}
+\left[\begin{array}{cc}50e^{3t}\\10e^{-3t}\end{array}\right]}$

\item(1)\label{exer:10.7.3}$\dst{{\bf y}'=\twobytwo1221{\bf
y}+\left[\begin{array}{cc}1\\t\end{array}\right]}$

\item(1)\label{exer:10.7.4}$\dst{{\bf y}'=\twobytwo{-4}{-3}65{\bf
y}+\left[\begin{array}{cc}2\\-2e^t\end{array}\right]}$

\item(1)\label{exer:10.7.5}$\dst{{\bf y}'=\twobytwo{-6}{-3}1{-2}{\bf
y}+\left[\begin{array}{cc}4e^{-3t}\\4e^{-5t}\end{array}\right]}$

\item(1)\label{exer:10.7.6}$\dst{{\bf y}'=\twobytwo01{-1}0{\bf
y}+\left[\begin{array}{cc}1\\t\end{array}\right]}$

\item(1)\label{exer:10.7.7}$\dst{{\bf y}'=\threebythree31{-1}351{-6}24{\bf
y}+\left[\begin{array}{cc}3\\6\\3\end{array}\right]}$

\item(1)\label{exer:10.7.8}$\dst{{\bf y}'
=\threebythree3{-1}{-1}{-2}324{-1}{-2}{\bf y}
+\left[\begin{array}{cc}1\\e^t\\e^t\end{array}\right]}$

\item\label{exer:10.7.9}$\dst{{\bf y}'=\threebythree{-3}222{-3}222{-3}{\bf
y}+\left[\begin{array}{cc}e^t\\e^{-5t}\\e^t\end{array}\right]}$

\item\label{exer:10.7.10}$\dst{{\bf
y}'=\frac{1}{3}\threebythree11{-3}{-4}{-4}3{-2}10{\bf
...
\item\label{exer:10.7.11}$\dst{{\bf y}'=\frac{1}{t}\left[\begin{array}{rc}1&t\\-t&1\end{array}\right]{\bf y}
+t\left[\begin{array}{cc}
\cos t\\\sin t\end{array}\right];  \quad Y=t\left[\begin{array}{rc}\cos
t&\sin t\\-\sin t&\cos t
\end{array}\right]}$

\item\label{exer:10.7.12}$\dst{{\bf y}'=\frac{1}{t}\left[\begin{array}{cc}1&t\\t&1\end{array}\right]{\bf y}
+\left[\begin{array}{c}
t\\t^2\end{array}\right];  \quad Y=t\left[\begin{array}{cr}
e^t&e^{-t}\\e^t&-e^{-t}
\end{array}\right]}$

\item\label{exer:10.7.13}$\dst{{\bf y}'=\frac{1}{t^2-1}\left[\begin{array}{rr}t&-1\\-1&t\end{array}\right]{\bf y}+
t\left[\begin{array}{r}
1\\-1\end{array}\right];  \quad Y=\left[\begin{array}{cc}
t&1\\1&t
\end{array}\right]}$

\item\label{exer:10.7.14}$\dst{{\bf y}'=\frac{1}{3}\left[\begin{array}{cc}1&-2e^{-t}\\2e^t&-1\end{array}\right]{\bf y}+
\left[\begin{array}{c}e^{2t}
\\e^{-2t}\end{array}\right];  \quad Y=\left[\begin{array}{cc}
2&e^{-t}\\e^t&2
\end{array}\right]}$

\item\label{exer:10.7.15}$\dst{{\bf y}'=\frac{1}{2t^4}\left[\begin{array}{cc}3t^3&t^6\\1&-3t^3\end{array}\right]{\bf y}+
\frac{1}{t}\left[\begin{array}{c}
t^2\\1\end{array}\right];  \quad Y=\frac{1}{t^2}\left[\begin{array}{rc}
t^3&t^4\\-1&t
\end{array}\right]}$

\item\label{exer:10.7.16}$\dst{{\bf y}'=
\left[\begin{array}{cc}\dst\frac{1}{t-1}
&-\dst\frac{e^{-t}}{t-1}\\[2\jot]\dst\frac{e^t}{t+1}&\dst\frac{1}{t+1}\end{array}\right]{\bf y}+\left[\begin{array}{c}
t^2-1\\t^2-1\end{array}\right];  \quad Y=\left[\begin{array}{cc}
t&e^{-t}\\e^t&t
\end{array}\right]}$

\item\label{exer:10.7.17}$\dst{{\bf y}'=\frac{1}{t}\threebythree110021{-2}22{\bf y}
+\threecol121
\quad Y=\left[\begin{array}{ccr}
t^2&t^3&1\\t^2&2t^3&-1\\0&2t^3&2
\end{array}\right]}$

\item\label{exer:10.7.18}$\dst{{\bf y}'=
...
\item\label{exer:10.7.19}$\dst{{\bf y}'=\frac{1}{t}\left[\begin{array}{crc}1&t&0\\0&1&t\\0&-t&1\end{array}\right]{\bf y}
+\left[\begin{array}{c}
t\\t \\t \end{array}\right];  \quad Y=t\left[\begin{array}{crr}
1&\cos t&\sin t \\0&-\sin t&\cos t\\0&-\cos t&-\sin t
\end{array}\right]}$

\item\label{exer:10.7.20}$\dst{{\bf y}'=-\frac{1}{t}\left[\begin{array}{crr}e^{-t}&-t&1-e^{-t}\\e^{-t}&1&-t-e^{-t}\\e^{-t}&-t
&1-e^{-t}\end{array}\right]{\bf
y}
+\frac{1}{t}\left[\begin{array}{c}
e^t\\0 \\e^t \end{array}\right];  \quad Y=\frac{1}{t}\left[\begin{array}{crc} e^t&e^{-t}&t\\e^t&-e^{-t}&e^{-t}\\e^t&e^{-t}&0
\end{array}\right]}$
