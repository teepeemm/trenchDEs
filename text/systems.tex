...
of ${\bf F}$  is
\[
\|{\bf F}\|=K{\|{\bf X}\|\over\|{\bf X}\|^3}=\frac{K}{\|{\bf X}\|^2}
=\frac{K}{(x^2+y^2+z^2)}.
\]
...
which is row equivalent to
\[
\dst{\left[\begin{array}{rrcr}1&-\frac{5}{2}&\vdots&1\over2\\
...
\[
\left|\begin{array}{rrr}
1&-1&1\\2&1&0\\1&0&1\over2\end{array}\right|=\frac{1}{2},
\]
...
{\bf v}_1={\bf v}-{{\bf u}\over2}=\frac{1}{2}\twocol{-5}{\phantom{-}5},
\]
...
\end{array}\right|&=&\dst{e^{7t}\over2e^{2t}}&=&\dst\frac{1}{2}e^{5t}.
\end{array}
\]
 Therefore
\[
...
\\e^{-t}&1&0
\end{array}\right|&=&\dst{e^{4t}\over2e^{4t}}&=&\dst\frac{1}{2}
\\[6\jot]
u_2'&=&-\dst\frac{1}{2e^{4t}}\left|\begin{array}{ccc}e^t&1&e^{2t}\\0&e^t&e^{3t}
\\e^{-t}&e^{-t}&0
\end{array}\right|&=&\dst{e^{3t}\over2e^{4t}}&=&\dst\frac{1}{2}e^{-t}\\[6\jot]
...
&-\dst{e^{-t}\over t-1}\\[2\jot]\dst\frac{e^t}{t+1}&\dst\frac{1}{t+1}\end{array}\right]{\bf y}+\left[\begin{array}{c}
...
\item
$\dst\int u\ln|u|\; du={u^2\ln|u|\over2}-\frac{u^2}{4}+c$
