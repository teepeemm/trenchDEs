...
\begin{eqnarray*}
Q_1'&=&\dst{5-\frac{2}{25}Q_1+\frac{1}{100}Q_2}\\
Q_2'&=&\dst{8+\frac{1}{50}Q_1-\frac{1}{50}Q_2}. \quad\bbox
\end{eqnarray*}
...
\begin{array}{rcl}
 x''&=&-\dst\frac{gR^2x}{(x^2+y^2+z^2)^{3/2}}\\[2\jot]
 y''&=&-\dst\frac{gR^2y}{(x^2+y^2+z^2)^{3/2}}\\[2\jot]
...
y_1'&=&v_1\\[1\jot]
y_2'&=&v_2\\[1\jot]
v_1'&=&\dst\frac{1}{m_1}\left[-(c_1+c_2)v_1+c_2v_2-(k_1+k_2)y_1+k_2y_2+F_1\right]\\[1\jot]
v_2'&=&\dst\frac{1}{m_2}\left[c_2v_1-c_2v_2+k_2y_1-k_2y_2+F_2\right].
 \end{array}
\end{equation}
...
\item\label{exer:10.1.7}Formulate a version of Euler's method (Section~3.1)
...
\item\label{exer:10.3.2}In Section~5.1 the Wronskian of two
...
\item\label{exer:10.3.3}In Section~9.1 the Wronskian of $n$
...
\item\label{exer:10.3.8}Repeat Exercise~\ref{exer:10.3.7}  with
\[
...
\item\label{exer:10.3.9}Repeat Exercise~\ref{exer:10.3.7}  with
\[
...
\item\label{exer:10.3.10}Repeat Exercise~\ref{exer:10.3.7} with
\[
...
\item\label{exer:10.3.12}Repeat Exercise~\ref{exer:10.3.11} with
\begin{eqnarray*}
...
\item\label{exer:10.3.13}Repeat Exercise~\ref{exer:10.3.11}  with
\begin{eqnarray*}
...
\frac{1}{4}\left[\begin{array}{rr}-5&3 \\3&-5\end{array}\right]{\bf
y}}$
%\end{tabular}

%\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
\item\label{exer:10.4.3}$\dst{{\bf y}'=
\frac{1}{5}\left[\begin{array}{rr}-4&3\\
...
c_2\left(\threecol{-1}10\frac{e^{2t}}{2}+\threecol101te^{2t}\right)}\\[2\jot]
...
\item\label{exer:10.5.33}Under the assumptions of Theorem~\ref{thmtype:10.5.1}, suppose
...
coordinates yields
\begin{eqnarray*}
y_1&=&\frac{8}{5}e^{4t}+c_1e^{3t}+c_2e^{-t}\\[2\jot]
...
y}'=\frac{1}{5}\twobytwo{-4}3{-2}{-11}{\bf
...
\item
$\dst\int u^\alpha\; du=\frac{u^{\alpha+1}}{\alpha+1}+c$, \quad
$\alpha\ne-1$

\item
$\dst\int\frac{du}{u}=\ln|u|+c$
...
\item
$\dst\int\cos^2 u\; du=\frac{u}{2}+\frac{1}{4}\sin2u
+c$


\item
$\dst\int\sin^2 u\; du=\frac{u}{2}-\frac{1}{4}\sin2u
+c$

\item
$\dst\int \frac{du}{1+u^2}\; du=\tan^{-1}u+c$
\item
$\dst\int \frac{du}{\sqrt{1-u^2}}\; du=\sin^{-1}u+c$
\item
$\dst\int \frac{1}{u^2-1}\; du=\frac{1}{2}\ln\left|\frac{u-1}{u+1}\right|+c$
...
\item
$\dst\int e^{\lambda u}\cos\omega u\; du=\frac{e^{\lambda u}(\lambda\cos
\omega u+\omega\sin\omega u)}{\lambda^2+\omega^2}+c$

\item
$\dst\int e^{\lambda u}\sin\omega u\; du=\frac{e^{\lambda u}(\lambda\sin
...
\item
$\dst\int u\ln|u|\; du=\frac{u^2\ln|u|}{2}-\frac{u^2}{4}+c$

\item
$\dst\int\cos\omega_1u\cos\omega_2u\,du=\frac{\sin
...
\item
$\dst\int\sin\omega_1u\cos\omega_2 u\,du=-\frac{\cos
(\omega_1+\omega_2)u}{2(\omega_1+\omega_2)}
