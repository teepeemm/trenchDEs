...
&=&\dst\frac{1}{2}\,\dst{1\over s-b} +\dst\frac{1}{2}\,\dst{1\over
s+b},
\end{array}
\end{equation}
...
\frac{5}{2}{\cal L}^{-1}\left({2\over(s+1)^2+4}\right)\\[10pt]&=&
...
Therefore
\[
F(s)=\frac{17}{2}\,{1\over s}-{10\over s-1}+\frac{7}{2}\,{1\over
s-2}-{1\over s+1}
\]
and
\begin{eqnarray*}
...
L}^{-1}\left({1\over(s+2)^2}\right)+\frac{21}{2}{\cal
...
\[
F(s)={1\over2s}-\frac{7}{2}\,{s+1\over(s+1)^2+1}-
\frac{5}{2}\,{1\over(s+1)^2+1}.
\]
Therefore
\begin{eqnarray*}
{\cal L}^{-1}(F)&=&
...
\[
{1\over(x+1)(x+4)}=\frac{1}{3}\left({1\over x+1}-{1\over x+4}\right)
\]
and then setting $x=s^2$ to obtain
\[
{1\over(s^2+1)(s^2+4)}=\frac{1}{3}\left({1\over s^2+1}-{1\over
s^2+4}\right).
\]
...
\[
Y(s)=-{1\over s-2}+\frac{1}{2}{1\over s-5}+\frac{5}{2}{1\over s-1},
\]
...
Heaviside's method yields the partial fraction expansion
\[
Y(s)=\frac{4}{3}{1\over s+1/2}-{8\over s+1}+\frac{8}{3}{1\over s+2},
\]
...
3(t-\pi/2)+\frac{1}{3}\sin 3\left(t-{\pi\over
2}\right)\right]\\[2\jot]
...
\[
{1\over (x+1)(x+4)}=\frac{1}{3}\left[{1\over x+1}-{1\over
x+4}\right].
\]
Setting $x=s^2$ and substituting the result in  \eqref{eq:8.5.14} yields
\[
H_1(s)=-\frac{2}{3}\left[{1\over s^2+1}-{1\over s^2+4}\right]
\quad\mbox{ and }\quad
H_2(s)=-\frac{1}{3}\left[{s\over s^2+1}-{s\over s^2+4}\right].
\]
...
Since
\begin{eqnarray*}
h_1\left(t-{\pi\over4}\right)&=&-\frac{2}{3}\sin\left(t-{\pi\over
4}\right)+\frac{1}{3}\sin2\left(t-{\pi\over4}\right)\\
...
\[
y=-\frac{1}{3}u\left(t-{\pi\over4}\right)\left(\sqrt{2}(\sin
t-\cos t)+\cos2t\right)
...
y=\left\{\begin{array}{cl}
0,&0\le t<\dst{{\pi\over4}},\\[2\jot]
-\dst{{\sqrt{2}\over3}}(\sin t-\cos t)-\dst{\frac{1}{3}}\cos2t,&\dst{\pi\over4}\le t<\pi,\\[2\jot]
...
Since
\[
{1\over(s^2+4)}\leftrightarrow \frac{1}{2}\sin 2t\mbox{\quad and \quad}
...
\[
y(t)=k_0\cos 2t+{k_1\over 2}\sin 2t+\frac{1}{2}\int_0^tf(t-\tau)\sin
2\tau\,d\tau.
\]
...
&=&\dst{\frac{1}{4}{\cal L}^{-1}\left({1\over s+1}-{1\over s+5}\right)}
&=&\dst{e^{-t}-e^{-5t}\over4},
\end{array}
\]
