...
\begin{eqnarray*}
{\cal L}^{-1}(F)&=&
 \frac{17}{2}{\cal L}^{-1}\left(\frac{1}{s}\right)-10{\cal L}^{-1}\left(1
\over s-1\right)+\frac{7}{2}{\cal L}^{-1}\left(\frac{1}{s-2}\right)-{\cal L}^{-1}\left(\frac{1}{s+1}\right)\\[1\jot]
...
\begin{eqnarray*}
{\cal L}^{-1}(F)&=&
2{\cal L}^{-1}\left(\frac{1}{s+1}\right)-6{\cal L}^{-1}\left(\frac{1}{s+2}\right)-8{\cal L}^{-1}\left(1\over(s+2)^2\right)\\[1\jot]
&=&2e^{-t}-6e^{-2t}-8te^{-2t}.
\end{eqnarray*}
...
and
\[
G_2(s)=\frac{s+1}{s^2+6s+10}={(s+3)-2\over (s+3)^2+1}.
\]
Then
\[
...
e^{-2s}\left[{3(s-3)\over(s+1)(s-2)}-\frac{s+1}{(s-1)(s-2)}\right]}$
