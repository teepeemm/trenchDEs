...
\indexterm{convolution integral}\index{integral!convolution}. The convolution
...
\section{Constant Coefficient Equations with Impulses}\label{sec:laplace_impulse}
