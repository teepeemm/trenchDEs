...
$1\leftrightarrow\dst\frac{1}{s},\quad s>0$ &
 $e^{at}\leftrightarrow\dst\frac{1}{(s-a)},\quad s>a$\\
  $t\leftrightarrow\dst{\frac{1}{s^2}},\quad s>0$ &
$te^{at}\leftrightarrow\dst{\frac{1}{(s-a)^2}},\quad s>a$\\
$\sin\omega t\leftrightarrow\dst{\frac{\omega}{s^2+\omega^2}},\quad s>0$&
$e^{\lambda t}\sin\omega t\leftrightarrow\dst{\frac{\omega}{(s-\lambda)^2+\omega^2}},\,s>\lambda$\\
$\cos\omega t\leftrightarrow\dst{\frac{s}{s^2+\omega^2}},\quad s>0$ &
$e^{\lambda t}\sin\omega t\leftrightarrow\dst{\frac{s-\lambda}{(s-\lambda)^2+\omega^2}},\,s>\lambda$\\\bottomrule
\end{tabular}
\end{center}
...
{
\color{blue}
\remark{In \zcref{sec:unit_step_func} we'll develop a more efficient
...
\item $t\sinh 2t$
\item $\sin t\cos t$
\item $\dst{\sin\left(t+\frac{\pi}{4}\right)}$
\item $\cos 2t -\cos 3t$
\item $\sin 2t +\cos 4t$
\end{alist}
...
\begin{alist}[columns=3]
% TODO was horizontal
\item $\dst{\frac{\sin\omega t}{t}\quad(\omega>0)}$
\item $\dst{\frac{\cos\omega t-1}{t}}\quad (\omega>0)$
\item $\dst{\frac{e^{at}-e^{bt}}{t}}$
\item $\dst{\frac{\cosh t-1}{t}}$
\item $\dst{\frac{\sinh^2 t}{t}}$
\end{alist}
...
\begin{alist}[columns=3]
% TODO was horizontal
\item $\dst\frac{3}{(s-7)^4}$
\item $\dst\frac{2s-4}{s^2-4s+13}$
\item $\dst\frac{1}{s^2+4s+20}$
\item $\dst\frac{2}{s^2+9}$
\item $\dst\frac{s^2-1}{(s^2+1)^2}$
\item $\dst\frac{1}{(s-2)^2-4}$
\item $\dst\frac{12s-24}{(s^2-4s+85)^2}$
\item $\dst\frac{2}{(s-3)^2-9}$
\item $\dst\frac{s^2-4s+3}{(s^2-4s+5)^2}$
\end{alist}
...
\begin{alist}[columns=3]
% TODO was horizontal
\item $\dst\frac{2s+3}{(s-7)^4}$
\item $\dst\frac{s^2-1}{(s-2)^6}$
\item $\dst\frac{s+5}{s^2+6s+18}$
\item $\dst\frac{2s+1}{s^2+9}$
\item $\dst\frac{s}{s^2+2s+1}$
\item $\dst\frac{s+1}{s^2-9}$
\item $\dst\frac{s^3+2s^2-s-3}{(s+1)^4}$
\item $\dst\frac{2s+3}{(s-1)^2+4}$
\item $\dst\frac{1}{s}-\frac{s}{s^2+1}$
\item $\dst\frac{3s+4}{s^2-1}$
\item $\dst\frac{3}{s-1}+\frac{4s+1}{s^2+9}$
...
\begin{alist}[columns=2]
% TODO was horizontal
\item $\dst\frac{3-(s+1)(s-2)}{(s+1)(s+2)(s-2)}$
\item $\dst\frac{7+(s+4)(18-3s)}{(s-3)(s-1)(s+4)}$
\item $\dst\frac{2+(s-2)(3-2s)}{(s-2)(s+2)(s-3)}$
\item $\dst\frac{3-(s-1)(s+1)}{(s+4)(s-2)(s-1)}$
\item $\dst\frac{3+(s-2)(10-2s-s^2)}{(s-2)(s+2)(s-1)(s+3)}$
\item $\dst\frac{3+(s-3)(2s^2+s-21)}{(s-3)(s-1)(s+4)(s-2)}$
\end{alist}

\item\label{exer:8.2.4}Find the inverse Laplace transform.

\begin{alist}[columns=2]
\item $\dst\frac{2+3s}{(s^2+1)(s+2)(s+1)}$
\item $\dst\frac{3s^2+2s+1}{(s^2+1)(s^2+2s+2)}$
\item $\dst\frac{3s+2}{(s-2)(s^2+2s+5)}$
\item $\dst\frac{3s^2+2s+1}{(s-1)^2(s+2)(s+3)}$
\item $\dst\frac{2s^2+s+3}{(s-1)^2(s+2)^2}$
\item $\dst\frac{3s+2}{(s^2+1)(s-1)^2}$
\end{alist}
...
\begin{alist}[columns=3]
% TODO was horizontal
\item $\dst\frac{3s+2}{(s^2+4)(s^2+9)}$
\item $\dst\frac{-4s+1}{(s^2+1)(s^2+16)}$
\item $\dst\frac{5s+3}{(s^2+1)(s^2+4)}$
\item $\dst\frac{-s+1}{(4s^2+1)(s^2+1)}$
\item $\dst\frac{17s-34}{(s^2+16)(16s^2+1)}$
\item $\dst\frac{2s-1}{(4s^2+1)(9s^2+1)}$
\end{alist}
...
\item $\dst\frac{17 s-15}{(s^2-2s+5)(s^2+2s+10)}$
\item $\dst\frac{8s+56}{(s^2-6s+13)(s^2+2s+5)}$
\item $\dst\frac{s+9}{(s^2+4s+5)(s^2-4s+13)}$
\item $\dst\frac{3s-2}{(s^2-4s+5)(s^2-6s+13)}$
\item $\dst\frac{3s-1}{(s^2-2s+2)(s^2+2s+5)}$
\item $\dst\frac{20s+40}{(4s^2-4s+5)(4s^2+4s+5)}$
\end{alist}
...
\begin{alist}[columns=2]
% TODO was horizontal
\item $\dst\frac{1}{s(s^2+1)}$
\item $\dst\frac{1}{(s-1)(s^2-2s+17)}$
\item $\dst\frac{3s+2}{(s-2)(s^2+2s+10)}$
\item $\dst\frac{34-17s}{(2s-1)(s^2-2s+5)}$
\item $\dst\frac{s+2}{(s-3)(s^2+2s+5)}$
\item $\dst\frac{2s-2}{(s-2)(s^2+2s+10)}$
\end{alist}
...
\begin{alist}[columns=2]
% TODO was horizontal
\item $\dst\frac{2s+1}{(s^2+1)(s-1)(s-3)}$
\item $\dst\frac{s+2}{(s^2+2s+2)(s^2-1)}$
\item $\dst\frac{2s-1}{(s^2-2s+2)(s+1)(s-2)}$
\item $\dst\frac{s-6}{(s^2-1)(s^2+4)}$
\item $\dst\frac{2s-3}{s(s-2)(s^2-2s+5)}$
\item $\dst\frac{5s-15}{(s^2-4s+13)(s-2)(s-1)}$
\end{alist}
...
\begin{proof}
We know from Theorem~8.1.6 that $\laplace(f)$ is defined for
$s>s_0$.
...
\captionof{figure}{$y=\dst{\frac{4}{3}e^{-t/2}-8e^{-t}+\frac{8}{3}e^{-2t}}$}
  \label{figure:8.3.1}
\tagstructend
\end{minipage}%
\hfill
...
\captionof{figure}{$y=\dst{\frac{1}{2}-\frac{7}{2}e^{-t}\cos t-\frac{5}{2}e^{-t}\sin t}$}
\label{figure:8.3.2}
\tagstructend
\end{minipage}
...
f(t)=\begin{cases}
\sin t,&0\le t<\dst\frac{\pi}{2},\\
\cos t-3\sin t,&\dst\frac{\pi}{2}\le t<\pi,\\
 3\cos t,&t\ge\pi
\end{cases}
\end{equation}
(\zcref{figure:8.4.4}).
...
\item(1)\label{exer:8.4.19}$\dst{H(s)=\frac{e^{-2s}}{s-2}}$%&
\item(1)\label{exer:8.4.20}$\dst{H(s)=\frac{e^{-s}}{s(s+1)}}$

\item\label{exer:8.4.21}\CGex $\dst{H(s)=\frac{e^{-s}}{s^3}+
\frac{e^{-2s}}{s^2}}$
...
\item\label{exer:8.4.24}$\dst{H(s)=\frac{e^{-\pi s} (1-2s)}{s^2+4s+5}}$

\item\label{exer:8.4.25}\CGex $\dst{H(s)=\left(\frac{1}{s}-\frac{s}{s^2+1}\right)+e^{-\frac{\pi}{2}s}\left(\frac{3s-1}{s^2+1}\right)}$

\item\label{exer:8.4.26}$\dst{H(s)=
e^{-2s}\left[\frac{3(s-3)}{(s+1)(s-2)}-\frac{s+1}{(s-1)(s-2)}\right]}$
...
\item\label{exer:8.4.28}$\dst{H(s)=\frac{1}{s}-\frac{2}{s^3}+e^{-2s}\left(\frac{3}{s}-\frac{1}{s^3}\right) +\frac{e^{-4s}}{s^2}}$
...
&=\dst{e^{bt}\frac{e^{(a-b)\tau}}{a-b}\,\bigg|^t_0}
&&=\dst\frac{e^{bt}\left[e^{(a-b)t}-1\right]}{a-b}\\
...
\begin{alist}[columns=2]
% TODO horizontally
\item $\dst\frac{1}{s^2(s^2+4)}$
\item $\dst\frac{s}{(s+2)(s^2+9)}$
\item $\dst\frac{s}{(s^2+4)(s^2+9)}$
\item $\dst\frac{s}{(s^2+1)^2}$
\item $\dst\frac{1}{s(s-a)}$
\item $\dst\frac{1}{(s+1)(s^2+2s+2)}$
\item $\dst\frac{1}{(s+1)^2(s^2+4s+5)}$
\item $\dst\frac{1}{(s-1)^3(s+2)^2}$
\item $\dst\frac{s-1}{s^2(s^2-2s+2)}$
\item $\dst\frac{s(s+3)}{(s^2+4)(s^2+6s+10)}$
\item $\dst\frac{1}{(s-3)^5s^6}$
\item $\dst\frac{1}{(s-1)^3(s^2+4)}$
\item $\dst\frac{1}{s^2(s-2)^3}$
\item $\dst\frac{1}{s^7(s-2)^6}$
\end{alist}
