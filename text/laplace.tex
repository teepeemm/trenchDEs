...
\[
{\cal L}(t^3e^{4t})=\frac{3!}{(s-4)^4}=\frac{6}{(s-4)^4}.\bbox
\]
...
Since
\[
\int_0^1e^{-st}\,dt=\left\{\begin{array}{cl}\dst{\frac{1-e^{-s}}{s}},&\quad s\ne0,\\[2\jot] 1,&\quad s=0,\end{array}\right.
\]
 and
\[
...
it follows that
\[
F(s)=\left\{\begin{array}{rl}\dst{\frac{1-e^{-s}}{s}-3\frac{e^{-(s+1)}}{s+1}},&s>-1,\,s\ne0,\\\hfill\dst{1-\frac{3}{e}}\hfill,&
s=0.\end{array}\right.
\]
...
\item\label{exer:8.1.8}Use the known Laplace transform ${\cal L}(1)=1/s$ and the result of
Exercise~\ref{exer:8.1.6} to show that
\[
{\cal L}(t^n)=\frac{n!}{s^{n+1}},\quad n=\mbox{ integer}.
\]
...
\item\label{exer:8.1.18}Use the formula given in Exercise~\ref{exer:8.1.17}\part{b} to find
the
...
\begin{eqnarray*}
{\cal L}^{-1}(F)&=&
 \frac{17}{2}{\cal L}^{-1}\left(\frac{1}{s}\right)-10{\cal L}^{-1}\left(\frac{1
}{s-1}\right)+\frac{7}{2}{\cal L}^{-1}\left(\frac{1}{s-2}\right)-{\cal L}^{-1}\left(\frac{1}{s+1}\right)\\[1\jot]
...
\begin{eqnarray*}
{\cal L}^{-1}(F)&=&
2{\cal L}^{-1}\left(\frac{1}{s+1}\right)-6{\cal L}^{-1}\left(\frac{1}{s+2}\right)-8{\cal L}^{-1}\left(\frac{1}{(s+2)^2}\right)\\[1\jot]
&=&2e^{-t}-6e^{-2t}-8te^{-2t}.
\end{eqnarray*}
...
L}^{-1}\left(\frac{s+1}{(s+1)^2+1}\right)-\frac{5}{2} {\cal L}^{-1}\left(\frac{1}{(s+1)^2+1}\right)\\[1\jot]
...
\item\label{exer:8.2.2}Use Theorem~\ref{thmtype:8.2.1} and the table of Laplace transforms
...
\item\label{exer:8.2.5}Use the method of Example~\ref{example:8.2.9}  to find the inverse Laplace transform.
...
\tagstructbegin{tag=Sect}
  \includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig080301}
...
\hfill
  \begin{minipage}{0.49\linewidth}
\tagstructbegin{tag=Sect}
  \includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig080302}
...
\[
y_1={\cal L}^{-1}\left(\frac{as+b}{as^2+bs+c}\right)\quad\text{and}\quad 
...
\tagstructbegin{tag=Sect}
  \includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig080401}
...
\hfill
  \begin{minipage}[t]{0.5\linewidth}
\tagstructbegin{tag=Sect}
  \includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig080402}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080403}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080404}
...
\begin{figure}[H]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080405}
...
\item\label{exer:8.4.19}$\dst{H(s)=\frac{e^{-2s}}{s-2}}$%&
\item\label{exer:8.4.20}$\dst{H(s)=\frac{e^{-s}}{s(s+1)}}$
%\end{tabular}
...
\item\label{exer:8.4.31}In addition to the assumptions of Exercise~\ref{exer:8.4.30},
assume that
\[
...
\begin{enumext}[label=\arabic*,wrap-label*={Step #1.},font=\bfseries]
...
(Figure:8.5.1).
                    ...
                    \begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080501}
...
H_1(s)=-\frac{2}{(s^2+1)(s^2+4)}\quad\mbox{ and }\quad H_2(s)=-\frac{s}{
(s^2+1)(s^2+4)}.
\end{equation}
...
-\dst{ \frac{\sqrt{2}}{3}}\sin t+
\dst{\frac{1+\sqrt{2}}{3}}\cos t ,&t\ge\pi.
\end{array}\right.
\end{equation}
We leave it to you to verify that $y$ and $y'$ are continuous and
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080502}
...
t<\dst\frac{\pi }{2},\\[2\jot]\pi,&t\ge\dst{ \frac{\pi}{2}},
\end{array}\right.\quad y(0)=0,\quad y'(0)=0}$

\item\label{exer:8.5.10}$\dst{y''+y=\left\{\begin{array}{cl}\phantom{-}t,&0\le t<\pi,
...
\item\label{exer:8.5.16}$\dst{y''+2y'+y=\left\{\begin{array}{cl}
...
to show that
\[
\lim_{t\to t_0-}\frac{g(t)-g(t_0)}{t-t_0}=A\quad\mbox{ and }\quad
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080601}
  \caption{}
  \label{figure:8.6.1}
\end{figure}
...
\dst\frac{e^{bt}\left[e^{(a-b)t}-1\right]}{a-b}\\[2\jot]
...
Therefore
\begin{eqnarray*}
Y(s)&=&\frac{1}{(s-1)^2}F(s)+\frac{k_1+k_0s-2k_0}{(s-1)^2}\\[2\jot]
...
Therefore
\begin{eqnarray*}
Y(s)&=&\frac{1}{(s+1)^2+1}F(s)+\frac{k_1+k_0s+2k_0}{(s+1)^2+1}\\[2\jot]
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080701}
\caption{  $y=f_h(t)$}
  \label{figure:8.7.1}
\end{figure}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080702}
...
\begin{figure}[tbp]
  \centering\color{blue}
  \includegraphics[bb=-78 148 689 643,width=5.67in,height=3.3in,keepaspectratio]{fig080703}
\caption{
$y=u(t-t_0)(t-t_0)e^{-(t-t_0)}$}
  \label{figure:8.7.3}
\end{figure}
...
\begin{minipage}{0.49\linewidth}
\tagstructbegin{tag=Sect}
  \includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig080704}
...
\hfill
  \begin{minipage}{0.49\linewidth}
    \centering
\tagstructbegin{tag=Sect}
  \includegraphics[width=\linewidth,height=2.44in,keepaspectratio]{fig080705}
...
\item\label{exer:8.7.29}Recall from Section~6.2 that the displacement of
an
