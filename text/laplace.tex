...
\emph{\color{blue}diverges} or \emph{\color{blue}does not exist}. Here's the definition of
...
\item\label{exer:8.1.16}The \emph{\color{blue}gamma function} is defined by
\[
...
\personHref{Heaviside}{Heaviside's method}.
...
\item\label{exer:8.2.3}Use Heaviside's method to find the inverse Laplace transform.
...
\item\label{exer:8.2.10}\begin{alist}[above=-\baselineskip]
\item  % (a)
...
\begin{theorem}[Second Shifting Theorem]\label{thmtype:8.4.2} If
...
\item(1)\label{exer:8.4.1}$f(t)=\begin{cases}
1,&0 \le t<4,\\
t,&t\ge4.\end{cases}$
\item(1)\label{exer:8.4.2}$f(t)=\begin{cases}
t,&0 \le t<1,\\
1,&t\ge1.\end{cases}$
\item(1)\label{exer:8.4.3}\CGex $f(t)=\begin{cases}
2t-1,& 0\le t<2,\\
t,&t\ge2.\end{cases}$
\item(1)\label{exer:8.4.4}\CGex $f(t)=\begin{cases}
1, &0\le t<1,\\
t+2,&t\ge1.\end{cases}$
\item(1)\label{exer:8.4.5}$f(t)=\begin{cases}
t-1,& 0\le t<2,\\
4,&t\ge2.\end{cases}$
\item(1)\label{exer:8.4.6}$f(t)=\begin{cases}
t^2,& 0\le t<1,\\
0,&t\ge1.\end{cases}$


\exercisetext{In \zcref[range]{exer:8.4.7,exer:8.4.18} express the
given function $f$ in terms of unit step functions
 and use \zcref{thmtype:8.4.1} to find $\laplace(f)$.
Where indicated by \CGex, graph $f$.}

\item(1)\label{exer:8.4.7}$f(t)=\begin{cases}
0, &0\le t<2,\\
t^2+3t,&t\ge2.\end{cases}$
\item(1)\label{exer:8.4.8}$f(t)=\begin{cases}
t^2+2, &0\le t<1,\\
t,&t\ge1.\end{cases}$
\item(1)\label{exer:8.4.9}$f(t)=\begin{cases}
te^t,& 0\le t<1,\\
e^t,&t\ge1.\end{cases}$
\item(1)\label{exer:8.4.10}$f(t)=\begin{cases}
e^{\phantom{2}-t}, &0\le t<1,\\
e^{-2t},&t\ge1.\end{cases}$
\item(1)\label{exer:8.4.11}$f(t)=\begin{cases}
-t,&0 \le t<2,\\
t-4,&2\le t<3,\\
1,&t\ge3.
\end{cases}$
\item(1)\label{exer:8.4.12}$f(t)=\begin{cases}
0,&0 \le t<1,\\
t,&1\le t<2,\\
0,&t\ge2.\end{cases}$
\item(1)\label{exer:8.4.13}$f(t)=\begin{cases}
t,&0 \le t<1,\\
t^2,&1\le t<2,\\
0,&t\ge2.\end{cases}$
\item(1)\label{exer:8.4.14}$f(t)=\begin{cases}
t,&0\le t<1,\\
2-t,&1\le t<2,\\
6,&t > 2.\end{cases}$

\item(1)\label{exer:8.4.15}\CGex $f(t)=\begin{cases}
\phantom{2}\sin t,&0\le t<\dfrac{\pi}{2},\\
2\sin t,&\dfrac{\pi}{2}\le t<\pi,\\
\phantom{2}\cos t,&t\ge\pi.\end{cases}$

\item(1)\label{exer:8.4.16}\CGex
$f(t)=\begin{cases}
\phantom{-} 2,&0\le t<1,\\
-2t+2,&1\le t<3,\\
...
\item(1)\label{exer:8.4.17}\CGex
$f(t)=\begin{cases}
3,&0\le t<2,\\
3t+2,&2\le t<4,\\
4t,&t\ge 4.\end{cases}$

\item(1)\label{exer:8.4.18}\CGex
$f(t)=\begin{cases}
(t+1)^2,&0\le t<1,\\
(t+2)^2,&t\ge1.\end{cases}$


\exercisetext{In \zcref[range]{exer:8.4.19,exer:8.4.28} use
...
\item(1)\label{exer:8.4.19}$H(s)=\dfrac{e^{-2s}}{s-2}$%&
\item(1)\label{exer:8.4.20}$H(s)=\dfrac{e^{-s}}{s(s+1)}$

\item\label{exer:8.4.21}\CGex $H(s)=\dfrac{e^{-s}}{s^3}+
\dfrac{e^{-2s}}{s^2}$

\item\label{exer:8.4.22}\CGex $H(s)=\left(\dfrac{2}{s}+\dfrac{1}{s^2}\right)
+e^{-s}\left(\dfrac{3}{s}-\dfrac{1}{s^2}\right)+e^{-3s}\left(\dfrac{1}{s}+\dfrac{1}{s^2}\right)$

\item\label{exer:8.4.23}$H(s)=\left(\dfrac{5}{s}-\dfrac{1}{s^2}\right)
+e^{-3s}\left(\dfrac{6}{s}+\dfrac{7}{s^2}\right)+\dfrac{3e^{-6s}}{s^3}$

\item\label{exer:8.4.24}$H(s)=\dfrac{e^{-\pi s} (1-2s)}{s^2+4s+5}$

\item\label{exer:8.4.25}\CGex $H(s)=\left(\dfrac{1}{s}-\dfrac{s}{s^2+1}\right)+e^{-\dfrac{\pi}{2}s}\left(\dfrac{3s-1}{s^2+1}\right)$

\item\label{exer:8.4.26}$H(s)=
e^{-2s}\left[\dfrac{3(s-3)}{(s+1)(s-2)}-\dfrac{s+1}{(s-1)(s-2)}\right]$

\item\label{exer:8.4.27}$H(s)=\dfrac{1}{s}+\dfrac{1}{s^2}+e^{-s}\left(\dfrac{3}{s}+\dfrac{2}{s^2}\right) +e^{-3s}\left(\dfrac{4}{s}+\dfrac{3}{s^2}\right)$

\item\label{exer:8.4.28}$H(s)=\dfrac{1}{s}-\dfrac{2}{s^3}+e^{-2s}\left(\dfrac{3}{s}-\dfrac{1}{s^3}\right) +\dfrac{e^{-4s}}{s^2}$
...
\item\label{exer:8.5.24}\begin{alist}[above=-\baselineskip]
\item % (a)
...
The \emph{\color{blue}convolution} $f*g$ of two functions $f$
and $g$ is defined by
\[
...
\personHref{Dirac}{Dirac $\delta$ function}.) It must be understood, however, that
...
\emph{\color{blue}theory of distributions} where the definition can be made
