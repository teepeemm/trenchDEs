...
\begin{figure}[tbp]
  ...
  width=5.67in,height=3.66in,keepaspectratio]{fig080101}
...
\begin{tabular}[t]{@{}p{112pt}@{}p{112pt}@{}p{112pt}}
\part{a} $\dst{\frac{\sin\omega t}{t}\quad(\omega>0)}$ &
\part{b} $\dst{\frac{\cos\omega t-1}{t}}\quad (\omega>0)$ &
\part{c} $\dst{\frac{e^{at}-e^{bt}}{t}}$\\[2\jot]
\part{d} $\dst{\frac{\cosh t-1}{t}}$ &
\part{e} $\dst{\frac{\sinh^2 t}{t}}$
\end{tabular}
...
\part{b} $\dst\frac{2s-4}{s^2-4s+13}$ &
\part{c} $\dst\frac{1}{s^2+4s+20}$\\[10pt]
\part{d} $\dst\frac{2}{s^2+9}$ &
\part{e} $\dst\frac{s^2-1}{(s^2+1)^2}$ &
\part{f} $\dst\frac{1}{(s-2)^2-4}$\\[10pt]
\part{g} $\dst\frac{12s-24}{(s^2-4s+85)^2}$ &
\part{h} $\dst\frac{2}{(s-3)^2-9}$ &
\part{i} $\dst\frac{s^2-4s+3}{(s^2-4s+5)^2}$
\end{tabular}
...
\begin{tabular}[t]{@{}p{112pt}@{}p{112pt}@{}p{112pt}}
\part{a}  $\dst\frac{2s+3}{(s-7)^4}$ &
\part{b}  $\dst\frac{s^2-1}{(s-2)^6}$ &
\part{c}  $\dst\frac{s+5}{s^2+6s+18}$\\[10pt]
\part{d}  $\dst\frac{2s+1}{s^2+9}$ &
\part{e}  $\dst\frac{s}{s^2+2s+1}$ &
\part{f}  $\dst\frac{s+1}{s^2-9}$\\[10pt]
\part{g}  $\dst\frac{s^3+2s^2-s-3}{(s+1)^4}$ &
\part{h}  $\dst\frac{2s+3}{(s-1)^2+4}$ &
\part{i}  $\dst\frac{1}{s}-\frac{s}{s^2+1}$\\[10pt]
\part{j}  $\dst\frac{3s+4}{s^2-1}$ &
\part{k}  $\dst\frac{3}{s-1}+\frac{4s+1}{s^2+9}$ &
...
\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
\part{a}  $\dst\frac{3-(s+1)(s-2)}{(s+1)(s+2)(s-2)}$&
\part{b}  $\dst\frac{7+(s+4)(18-3s)}{(s-3)(s-1)(s+4)}$\\[10pt]
\part{c}  $\dst\frac{2+(s-2)(3-2s)}{(s-2)(s+2)(s-3)}$ &
\part{d}  $\dst\frac{3-(s-1)(s+1)}{(s+4)(s-2)(s-1)}$\\[10pt]
\part{e}  $\dst\frac{3+(s-2)(10-2s-s^2)}{(s-2)(s+2)(s-1)(s+3)}$ &
\part{f}  $\dst\frac{3+(s-3)(2s^2+s-21)}{(s-3)(s-1)(s+4)(s-2)}$
\end{tabular}

\item\label{exer:8.2.4}Find the inverse Laplace transform.

\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
\part{a}  $\dst\frac{2+3s}{(s^2+1)(s+2)(s+1)}$&
\part{b}  $\dst\frac{3s^2+2s+1}{(s^2+1)(s^2+2s+2)}$\\[10pt]
\part{c}  $\dst\frac{3s+2}{(s-2)(s^2+2s+5)}$ &
\part{d}  $\dst\frac{3s^2+2s+1}{(s-1)^2(s+2)(s+3)}$\\[10pt]
\part{e}  $\dst\frac{2s^2+s+3}{(s-1)^2(s+2)^2}$ &
\part{f}  $\dst\frac{3s+2}{(s^2+1)(s-1)^2}$
\end{tabular}

\item\label{exer:8.2.5}Use the method of Example~\ref{example:8.2.9}  to find the
inverse Laplace transform.

\begin{tabular}[t]{@{}p{112pt}@{}p{112pt}@{}p{112pt}}
\part{a} $\dst\frac{3s+2}{(s^2+4)(s^2+9)}$ &
\part{b} $\dst\frac{-4s+1}{(s^2+1)(s^2+16)}$ &
\part{c} $\dst\frac{5s+3}{(s^2+1)(s^2+4)}$\\[10pt]
\part{d} $\dst\frac{-s+1}{(4s^2+1)(s^2+1)}$ &
\part{e} $\dst\frac{17s-34}{(s^2+16)(16s^2+1)}$ &
\part{f} $\dst\frac{2s-1}{(4s^2+1)(9s^2+1)}$
\end{tabular}
...
\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
\part{a} $\dst\frac{17 s-15}{(s^2-2s+5)(s^2+2s+10)}$ &
\part{b} $\dst\frac{8s+56}{(s^2-6s+13)(s^2+2s+5)}$\\[10pt]
\part{c} $\dst\frac{s+9}{(s^2+4s+5)(s^2-4s+13)}$ &
\part{d} $\dst\frac{3s-2}{(s^2-4s+5)(s^2-6s+13)}$\\[10pt]
\part{e} $\dst\frac{3s-1}{(s^2-2s+2)(s^2+2s+5)}$ &
\part{f} $\dst\frac{20s+40}{(4s^2-4s+5)(4s^2+4s+5)}$
\end{tabular}
...
\part{c} $\dst\frac{3s+2}{(s-2)(s^2+2s+10)}$ &
\part{d} $\dst\frac{34-17s}{(2s-1)(s^2-2s+5)}$\\[10pt]
\part{e} $\dst\frac{s+2}{(s-3)(s^2+2s+5)}$ &
\part{f} $\dst\frac{2s-2}{(s-2)(s^2+2s+10)}$
\end{tabular}

\item\label{exer:8.2.8}Find the inverse Laplace transform.

\begin{tabular}[t]{@{}p{168pt}@{}p{168pt}}
\part{a} $\dst\frac{2s+1}{(s^2+1)(s-1)(s-3)}$ &
\part{b} $\dst\frac{s+2}{(s^2+2s+2)(s^2-1)}$\\[10pt]
\part{c} $\dst\frac{2s-1}{(s^2-2s+2)(s+1)(s-2)}$ &
\part{d} $\dst\frac{s-6}{(s^2-1)(s^2+4)}$\\[10pt]
\part{e} $\dst\frac{2s-3}{s(s-2)(s^2-2s+5)}$ &
\part{f} $\dst\frac{5s-15}{(s^2-4s+13)(s-2)(s-1)}$\\[10pt]
\end{tabular}
...
\begin{center}
\begin{tabular}{ccc}
 {$f(t)$}  &  {$F(s)$}  &  {}  \\[15pt]\midrule
  1  &  $\displaystyle{\frac{1}{s}}$
& $(s > 0)$ \\[15pt]
  $t^n$  &  $\displaystyle{\frac{n!}{s^{n+1}}}$  & $(s > 0, n \text{ a positive integer})$ \\[15pt]
  $t^p,\;  p > -1$  &
$\displaystyle{\frac{\Gamma (p+1)}{s^{(p+1)}}}$ & $(s>0)$ \\[15pt]
  $e^{at}$  &  $\displaystyle{\frac{1 }{s-a}}$  & $(s > a)$ \\[15pt]
  $t^ne^{at}$  &  $\displaystyle{\frac{n! }{(s-a)^{n+1}}}$  & $(s > 0, n \text{ a positive integer})$ \\[15pt]
  $\cos \omega t$  &
$\displaystyle{\frac{s }{s^2+\omega^2}}$  & $(s > 0)$ \\[15pt]
 $\sin \omega t$  &
$\displaystyle{\frac{\omega }{s^2+\omega^2}}$  & $(s > 0)$ \\[15pt]
  $e^{\lambda t} \cos \omega t$  &
$\displaystyle{\frac{s - \lambda }{(s-\lambda)^2+\omega^2}}$  & $(s >
\lambda)$ \\[15pt]
 $e^{\lambda t} \sin \omega t$  &
$\displaystyle{\frac{\omega }{(s-\lambda)^2+\omega^2}}$  & $(s >
\lambda)$ \\[15pt]
